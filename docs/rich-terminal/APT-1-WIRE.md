...
rules. DROP is exact `<QQQ>`. RETAINED-1 Section 9.1 and the
MegaPad-owned `SEMANTIC-CONTENT-1` addendum define the canonical menu, text,
grid, and tab graph, content, replacement, and state rules.
