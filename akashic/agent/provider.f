...
112 CONSTANT _AP-FREE-XT         \ ( provider -- )
120 CONSTANT AGENT-PROVIDER-SIZE
...
: APROV-FACTORY!  ( xt -- ) _APROV-FACTORY-XT ! ;
: APROV-FACTORY@  ( -- xt ) _APROV-FACTORY-XT @ ;

: APROV-NEW  ( -- provider ior )
    _APROV-FACTORY-XT @ ?DUP 0= IF 0 -1 EXIT THEN EXECUTE ;
