...
: _SCRIPTED-START  ( prompt-a prompt-u run-id queue context -- ior )
    _SPS-C ! _SPS-Q ! _SPS-RUN ! _SPS-U ! _SPS-A !
...
: SCRIPTED-PROVIDER-USE  ( -- )
    ['] SCRIPTED-PROVIDER-NEW APROV-FACTORY! ;
