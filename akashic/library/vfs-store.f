...
: _LIBAUTH-COMPUTE-CRC  ( store -- crc )
    ...
    DUP LIBRARY-VFS-STORE.GENERATION 8 CRC32-ADD
    DUP LIBRARY-VFS-STORE.HEAD LIB-HEAD-FACT-SIZE CRC32-ADD
    DUP LIBRARY-VFS-STORE.ARENA LIB-ARENA-FACT-SIZE CRC32-ADD
    LIBRARY-VFS-STORE.BANK LIB-BANK-FACT-SIZE CRC32-ADD
    _LIBVP-CATALOG-FACTS LIB-CATALOG-MAX _LIBVCF-SIZE * CRC32-ADD
    _LIBVP-COLLECTION-FACTS
        LIB-COLLECTION-MAX _LIBVCCF-SIZE * CRC32-ADD
    _LIBAUTH-CATALOG-RECORD-SHA
        LIB-CATALOG-MAX LIB-DIGEST-SIZE * CRC32-ADD
    _LIBAUTH-COLLECTION-RECORD-SHA
        LIB-COLLECTION-MAX LIB-DIGEST-SIZE * CRC32-ADD
    _LIBLOC-TABLE _LIBLOC-BYTES CRC32-ADD
    CRC32-END ;
...
: _LIBIX-VALID?  ( store -- flag )
    ...
    DUP _LIBAUTH-VALID? 0= IF DROP 0 EXIT THEN
