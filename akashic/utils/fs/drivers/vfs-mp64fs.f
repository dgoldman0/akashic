...
: _VMP-RANGES-ALIAS-OR-INVALID?  ( start1 count1 start2 count2 -- flag )
...
: _VMP-DIRENTS-OVERLAP?  ( de-a de-b -- flag )
    ...
    _VMP-RANGES-ALIAS-OR-INVALID? IF TRUE EXIT THEN
    _VMOV-A @ _VMP-DE.SEC _VMOV-A @ _VMP-DE.COUNT
...
: _VMP-DIRENT-VALID?  ( de ctx -- flag )
    ...
    _VMEV-DE @ _VMP-DE.EXT1C IF
        ...
        _VMP-RANGES-ALIAS-OR-INVALID? IF FALSE EXIT THEN
    THEN
...
: _VMRR-FULL  ( -- )
    ...
    BEGIN _VMRR-FULL-LEFT @ 0> WHILE
        _VMRR-FULL-LEFT @ 255 MIN _VMRR-RUN-SECS MIN _VMRR-BATCH !
...
: _VMRW-FULL  ( -- )
    ...
    BEGIN _VMRW-FULL-LEFT @ 0> WHILE
        _VMRW-FULL-LEFT @ 255 MIN _VMRW-RUN-SECS MIN _VMRW-BATCH !
