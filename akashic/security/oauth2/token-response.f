...
\    sub           optional, nonempty decoded JSON string
\
...
4096 CONSTANT OAUTH2-TOKEN-VIEW-SUBJECT-CAPACITY
...
40 CONSTANT _O2TRV-SUBJECT-U
48 CONSTANT _O2TRV-EXPIRES-IN
56 CONSTANT _O2TRV-HEADER-SIZE
...
_O2TRV-SCOPE-OFF OAUTH2-TOKEN-VIEW-SCOPE-CAPACITY +
    CONSTANT _O2TRV-SUBJECT-OFF
_O2TRV-SUBJECT-OFF OAUTH2-TOKEN-VIEW-SUBJECT-CAPACITY +
...
: _O2TRV.SUBJECT-U   ( view -- address ) _O2TRV-SUBJECT-U + ;
...
: _O2TRV.SUBJECT  ( view -- address ) _O2TRV-SUBJECT-OFF + ;
...
: OAUTH2-TOKEN-VIEW-SUBJECT@
  ( view -- address length status )
    DUP _O2TR-VIEW-VALID? 0= IF
        DROP 0 0 OAUTH2-TOKEN-RESPONSE-S-INVALID EXIT
    THEN
    DUP _O2TRV.SUBJECT-U @ 0= IF
        DROP 0 0 OAUTH2-TOKEN-RESPONSE-S-MISSING EXIT
    THEN
    _O2TRV-SUBJECT-U _O2TRV-SUBJECT-OFF _O2TR-VIEW-TEXT@
    OAUTH2-TOKEN-RESPONSE-S-OK ;
...
: _O2TR-PROCESS-MEMBER  ( index workspace -- status )
    ...
    S" sub" R@ _O2TR-NAME= IF
        R@ _O2TRW.VIEW _O2TRV.SUBJECT
        R@ _O2TRW.VIEW _O2TRV.SUBJECT-U
        OAUTH2-TOKEN-VIEW-SUBJECT-CAPACITY
        R@ _O2TR-COPY-MEMBER-STRING
        DUP IF R> DROP EXIT THEN DROP
        _O2TR-P-SUBJECT
...
OAUTH2-TOKEN-RESPONSE-WORKSPACE-SIZE 35080 <> [IF]
    _O2TR-GEOMETRY-ABORT
[THEN]
