...
: _UTUI-MC-RELATION-VALID?  ( relation -- flag )
    ...
    _UTUI-MC-V-WIDGET @ DUP _UTUI-MC-GENUINE-TEXTAREA? 0= IF
        DROP 0 EXIT
    THEN
    _TXTA-O-INSTANCE + @ _UTUI-MC-V-INSTANCE @ <> IF 0 EXIT THEN
...
: _UTUI-MC-RELATION-DISTINCT?  ( relation -- flag )
    ...
    BEGIN _UTUI-MC-V-INNER @ DUP WHILE
        ...
        DUP _UTUI-MCR-INSTANCE@
            _UTUI-MC-V-OUTER @ _UTUI-MCR-INSTANCE@ = IF DROP 0 EXIT THEN
...
: _UTUI-MOUNTED-COLLECTION-CAPTURE-PREFLIGHTED
    ...
    _UTUI-MI-BUILDER @ _UTUI-MI-WIDGET @ TXTA-TEXT-AREA-CAPTURE ;
...
: _UTUI-CS-RELATIONS  ( -- disjoint status )
    ...
    BEGIN _UTUI-CS-REL @ DUP WHILE
        ...
        _UTUI-CS-SPAN-A @ _UTUI-CS-SPAN-U @
            TXTA-STORAGE-DISJOINT? 0= IF DROP 0 USCOL-S-OK EXIT THEN
