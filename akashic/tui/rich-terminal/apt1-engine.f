...
200 CONSTANT RTAPT-HYBRID-ADMISSION-SIZE
...
: _RTAPT-HA.CONTROL-BYTES   ( s -- a )  96 + ;
: _RTAPT-HA.CONTROL-ALIGNED ( s -- a ) 104 + ;
: _RTAPT-HA.CONTROL-MAX     ( s -- a ) 112 + ;
: _RTAPT-HA.CONTROL-LAST    ( s -- a ) 120 + ;
: _RTAPT-HA.CONTROL-COLLECTIONS ( s -- a ) 128 + ;
: _RTAPT-HA.CONTROL-ITEMS   ( s -- a ) 136 + ;
: _RTAPT-HA.CONTROL-UTF8    ( s -- a ) 144 + ;
: _RTAPT-HA.GLYPH-COUNT     ( s -- a ) 152 + ;
: _RTAPT-HA.GLYPH-TEXT      ( s -- a ) 160 + ;
: _RTAPT-HA.GLYPH-ALIGNED   ( s -- a ) 168 + ;
: _RTAPT-HA.GLYPH-MAX       ( s -- a ) 176 + ;
: _RTAPT-HA.GLYPH-LAST      ( s -- a ) 184 + ;
: _RTAPT-HA.RESERVED        ( s -- a ) 192 + ;
...
\ and exact copied variable bytes.  Geometry has already been normalized to
\ PT-ready UNORM32 bounds.  DEFINE and REPLACE therefore share one 144-byte
...
\        region-cols region-rows region-z region-flags control-count
...
: _RTAPT-CONTROL-SCRUB  ( -- )
    ...
    0 _RTAPT-CD-LEFT ! 0 _RTAPT-CD-TOP !
...
: _RTAPT-CONTROL-COPY-ROOT-BOUNDS?  ( -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.RIGHT @ U<
    _RTAPT-PF-COPY @ _RTAPT-CD.TOP @
    _RTAPT-PF-COPY @ _RTAPT-CD.BOTTOM @ U< AND ;
...
: _RTAPT-CONTROL-COPY-DESCENDANT?  ( -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.BOTTOM @ OR 0= AND ;
