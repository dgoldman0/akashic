...
: _RTAPT-CONTROL-SHAPE?  ( -- flag )
    ...
    _RTAPT-CD-KIND @ RTAPT-CONTROL-TEXT-AREA = IF
...
: _RTAPT-CONTROL-PARENT-PRIOR?  ( -- flag )
    _RTAPT-CD-PARENT @ 0= IF
        ...
        SWAP RTAPT-CONTROL-TEXT-AREA = OR EXIT
    THEN
...
: _RTAPT-CONTROL-COPY-SHAPE?  ( copy copy-u -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.STATE @
        ...
        THEN
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-TEXT-AREA = IF
...
: _RTAPT-CONTROL-KIND>PT  ( provider-kind -- pt-kind flag )
    ...
    THEN
    RTAPT-CONTROL-TEXT-AREA = IF
        PT-CONTROL-TEXT-AREA -1 EXIT
    THEN
    0 0 ;
