...
: _RTAPT-O.A-CSELECTED-MENU ( o -- a ) 400 + ;
...
: _RTAPT-CONTROL-PARENT-PRIOR?  ( -- flag )
    _RTAPT-CD-PARENT @ 0= IF
        _RTAPT-CD-KIND @ DUP RTAPT-CONTROL-MENUBAR =
        SWAP _RTAPT-CONTROL-COLLECTION-KIND? OR EXIT
    THEN
...
: _RTAPT-CONTROL-COPY-SHAPE?  ( copy copy-u -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @
        _RTAPT-CONTROL-COLLECTION-KIND? IF
...
: _RTAPT-PF-CONTROL-DEFINE-GRAPH?  ( -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @
        ...
        _RTAPT-PF-CONTROL-PHASE-COLLECTION _RTAPT-PF-CPHASE !
        -1 EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-MENUBAR = IF
...
: _RTAPT-CONTROL-KIND>PT  ( provider-kind -- pt-kind flag )
    ...
    THEN
    RTAPT-CONTROL-TEXT-GRID = IF
        PT-CONTROL-TEXT-GRID -1 EXIT
    THEN
    0 0 ;
