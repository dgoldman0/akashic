...
0xFF CONSTANT _RTAPT-FEATURE-MASK
...
\ Renderer-neutral CONTROL vocabulary.  These provider-local values are
\ mapped explicitly by the sole RTE bridge even though APT-1 currently
\ assigns the same compact scalar values.
...
5 CONSTANT RTAPT-CONTROL-TEXT-AREA
6 CONSTANT RTAPT-CONTROL-TEXT-GRID
...
2 CONSTANT RTAPT-READOUT-PERCENT

0 CONSTANT RTAPT-METER-HORIZONTAL
1 CONSTANT RTAPT-METER-VERTICAL
1 CONSTANT RTAPT-METER-SHOW-VALUE

0 CONSTANT RTAPT-STATUS-CIRCLE
1 CONSTANT RTAPT-STATUS-SQUARE
2 CONSTANT RTAPT-STATUS-DIAMOND
...
_RTAPT-REGION-F-VISIBLE _RTAPT-REGION-F-CLIPPED OR
    CONSTANT _RTAPT-REGION-F-MASK
...
4 CONSTANT _RTAPT-PF-CONTROL-PHASE-COLLECTION
5 CONSTANT _RTAPT-PF-CONTROL-PHASE-TABSET
6 CONSTANT _RTAPT-PF-CONTROL-PHASE-TAB
104 CONSTANT _RTAPT-REGION-DEFINE-COPY-SIZE
...
144 CONSTANT _RTAPT-READOUT-FRAME-FIXED
...
: _RTAPT-INSTRUMENT-OP?  ( kind -- flag )
    DUP _RTAPT-OP-INSTRUMENT-DEFINE =
    SWAP _RTAPT-OP-INSTRUMENT-REPLACE = OR ;
...
: RTAPT-CONTROL-LEDGER-BYTES  ( -- bytes )
    RTAPT-CONTROL-LEDGER-SIZE ;
...
: RTAPT-INSTRUMENT-BYTES  ( -- bytes )  RTAPT-INSTRUMENT-SIZE ;
...
\ at least one owner slot, one typed-operation slot, one byte in its copy
\ bank, and one control-ledger slot; their upper bounds come only from
\ the caller's nonempty spans.
...
: _RTAPT-C.CONTROL-LEDGER-A ( c -- a ) 64 + ;
: _RTAPT-C.CONTROL-LEDGER-U ( c -- a ) 72 + ;
...
: _RTAPT-LP.CLIP-X       ( p -- a )  72 + ;
: _RTAPT-LP.CLIP-Y       ( p -- a )  80 + ;
: _RTAPT-LP.CLIP-COLS    ( p -- a )  88 + ;
: _RTAPT-LP.CLIP-ROWS    ( p -- a )  96 + ;
: _RTAPT-LP.REGION-Z     ( p -- a ) 104 + ;
: _RTAPT-LP.REGION-FLAGS ( p -- a ) 112 + ;
: _RTAPT-LP.ITEMS-A      ( p -- a ) 120 + ;
: _RTAPT-LP.ITEMS-U      ( p -- a ) 128 + ;
: _RTAPT-LP.RESERVED     ( p -- a ) 136 + ;
...
: _RTAPT-HA.CLIP-X          ( s -- a )  72 + ;
: _RTAPT-HA.CLIP-Y          ( s -- a )  80 + ;
: _RTAPT-HA.CLIP-COLS       ( s -- a )  88 + ;
: _RTAPT-HA.CLIP-ROWS       ( s -- a )  96 + ;
: _RTAPT-HA.REGION-Z        ( s -- a ) 104 + ;
: _RTAPT-HA.REGION-FLAGS    ( s -- a ) 112 + ;
: _RTAPT-HA.CONTROL-COUNT   ( s -- a ) 120 + ;
: _RTAPT-HA.CONTROL-BYTES   ( s -- a ) 128 + ;
: _RTAPT-HA.CONTROL-ALIGNED ( s -- a ) 136 + ;
: _RTAPT-HA.CONTROL-MAX     ( s -- a ) 144 + ;
: _RTAPT-HA.CONTROL-LAST    ( s -- a ) 152 + ;
: _RTAPT-HA.CONTROL-COLLECTIONS ( s -- a ) 160 + ;
: _RTAPT-HA.CONTROL-ITEMS   ( s -- a ) 168 + ;
: _RTAPT-HA.CONTROL-UTF8    ( s -- a ) 176 + ;
: _RTAPT-HA.GLYPH-COUNT     ( s -- a ) 184 + ;
: _RTAPT-HA.GLYPH-TEXT      ( s -- a ) 192 + ;
: _RTAPT-HA.GLYPH-ALIGNED   ( s -- a ) 200 + ;
: _RTAPT-HA.GLYPH-MAX       ( s -- a ) 208 + ;
: _RTAPT-HA.GLYPH-LAST      ( s -- a ) 216 + ;
: _RTAPT-HA.INSTRUMENT-REGION-COUNT ( s -- a ) 224 + ;
: _RTAPT-HA.INSTRUMENT-COUNT ( s -- a ) 232 + ;
: _RTAPT-HA.READOUT-COUNT   ( s -- a ) 240 + ;
: _RTAPT-HA.METER-COUNT     ( s -- a ) 248 + ;
: _RTAPT-HA.STATUS-COUNT    ( s -- a ) 256 + ;
: _RTAPT-HA.INSTRUMENT-UNIT-BYTES ( s -- a ) 264 + ;
: _RTAPT-HA.INSTRUMENT-UNIT-ALIGNED ( s -- a ) 272 + ;
: _RTAPT-HA.INSTRUMENT-UNIT-MAX ( s -- a ) 280 + ;
: _RTAPT-HA.INSTRUMENT-FORMATTED-BYTES ( s -- a ) 288 + ;
: _RTAPT-HA.INSTRUMENT-FORMATTED-MAX ( s -- a ) 296 + ;
: _RTAPT-HA.INSTRUMENT-LAST ( s -- a ) 304 + ;
: _RTAPT-HA.RESERVED        ( s -- a ) 312 + ;

\ Call-borrowed semantic INSTRUMENT descriptor.  This provider-local shape is
\ deliberately offset-identical to the neutral RTE record so the sole bridge
...
: _RTAPT-INSTRUMENT.KIND        ( i -- a )   24 + ;
: _RTAPT-INSTRUMENT.VISIBLE     ( i -- a )   32 + ;
: _RTAPT-INSTRUMENT.Z           ( i -- a )   40 + ;
: _RTAPT-INSTRUMENT.REGION      ( i -- a )   48 + ;
: _RTAPT-INSTRUMENT.PARENT      ( i -- a )   56 + ;
: _RTAPT-INSTRUMENT.ROW         ( i -- a )   64 + ;
: _RTAPT-INSTRUMENT.COL         ( i -- a )   72 + ;
: _RTAPT-INSTRUMENT.HEIGHT      ( i -- a )   80 + ;
: _RTAPT-INSTRUMENT.WIDTH       ( i -- a )   88 + ;
: _RTAPT-INSTRUMENT.ROOT-HEIGHT ( i -- a )   96 + ;
: _RTAPT-INSTRUMENT.ROOT-WIDTH  ( i -- a )  104 + ;
: _RTAPT-INSTRUMENT.COLOR-A     ( i -- a )  112 + ;
: _RTAPT-INSTRUMENT.COLOR-B     ( i -- a )  120 + ;
: _RTAPT-INSTRUMENT.MODE        ( i -- a )  128 + ;
: _RTAPT-INSTRUMENT.OPTIONS     ( i -- a )  136 + ;
: _RTAPT-INSTRUMENT.MINIMUM     ( i -- a )  144 + ;
: _RTAPT-INSTRUMENT.MAXIMUM     ( i -- a )  152 + ;
: _RTAPT-INSTRUMENT.VALUE       ( i -- a )  160 + ;
: _RTAPT-INSTRUMENT.SCALE       ( i -- a )  168 + ;
: _RTAPT-INSTRUMENT.UNIT-A      ( i -- a )  176 + ;
...
: RTAPT-INSTRUMENT-GENERATION@  ( i -- u )
    _RTAPT-INSTRUMENT.GENERATION @ ;
: RTAPT-INSTRUMENT-ID@          ( i -- u )
    _RTAPT-INSTRUMENT.ID @ ;
: RTAPT-INSTRUMENT-KIND@        ( i -- u )
    _RTAPT-INSTRUMENT.KIND @ ;
: RTAPT-INSTRUMENT-VISIBLE@     ( i -- flag )
    _RTAPT-INSTRUMENT.VISIBLE @ ;
: RTAPT-INSTRUMENT-Z@           ( i -- n )
    _RTAPT-INSTRUMENT.Z @ ;
: RTAPT-INSTRUMENT-REGION@      ( i -- u )
    _RTAPT-INSTRUMENT.REGION @ ;
: RTAPT-INSTRUMENT-PARENT@      ( i -- u )
    _RTAPT-INSTRUMENT.PARENT @ ;
: RTAPT-INSTRUMENT-ROW@         ( i -- n )
    _RTAPT-INSTRUMENT.ROW @ ;
: RTAPT-INSTRUMENT-COL@         ( i -- n )
    _RTAPT-INSTRUMENT.COL @ ;
: RTAPT-INSTRUMENT-HEIGHT@      ( i -- u )
    _RTAPT-INSTRUMENT.HEIGHT @ ;
: RTAPT-INSTRUMENT-WIDTH@       ( i -- u )
    _RTAPT-INSTRUMENT.WIDTH @ ;
: RTAPT-INSTRUMENT-ROOT-HEIGHT@ ( i -- u )
    _RTAPT-INSTRUMENT.ROOT-HEIGHT @ ;
: RTAPT-INSTRUMENT-ROOT-WIDTH@  ( i -- u )
    _RTAPT-INSTRUMENT.ROOT-WIDTH @ ;
: RTAPT-INSTRUMENT-COLOR-A@     ( i -- rgba )
    _RTAPT-INSTRUMENT.COLOR-A @ ;
: RTAPT-INSTRUMENT-COLOR-B@     ( i -- rgba )
    _RTAPT-INSTRUMENT.COLOR-B @ ;
: RTAPT-INSTRUMENT-MODE@        ( i -- u )
    _RTAPT-INSTRUMENT.MODE @ ;
: RTAPT-INSTRUMENT-OPTIONS@     ( i -- u )
    _RTAPT-INSTRUMENT.OPTIONS @ ;
: RTAPT-INSTRUMENT-MINIMUM@     ( i -- n )
    _RTAPT-INSTRUMENT.MINIMUM @ ;
: RTAPT-INSTRUMENT-MAXIMUM@     ( i -- n )
    _RTAPT-INSTRUMENT.MAXIMUM @ ;
: RTAPT-INSTRUMENT-VALUE@       ( i -- n )
    _RTAPT-INSTRUMENT.VALUE @ ;
: RTAPT-INSTRUMENT-SCALE@       ( i -- n )
    _RTAPT-INSTRUMENT.SCALE @ ;
: RTAPT-INSTRUMENT-UNIT@        ( i -- a u )
    DUP _RTAPT-INSTRUMENT.UNIT-A @
    SWAP _RTAPT-INSTRUMENT.UNIT-U @ ;
: RTAPT-INSTRUMENT-FORMATTED-BYTES@  ( i -- u )
    _RTAPT-INSTRUMENT.FORMATTED-U @ ;
: RTAPT-INSTRUMENT-RESERVED@    ( i -- u )
    _RTAPT-INSTRUMENT.RESERVED @ ;

\ Private pointer-free retry address for the copied unit.  Geometry remains in
\ the ordinary descriptor slots with its original renderer-neutral meaning.
: _RTAPT-IDC.UNIT    ( i -- a )  _RTAPT-INSTRUMENT-COPY-FIXED + ;
...
\ Semantic STX1 items consume shared object quota without becoming glyph
\ definitions or acquiring glyph-object IDs.  Keep their selected-target
\ ledgers separate so operation counts and identity high-water remain exact.
: _RTAPT-O.ACTIVE-CONTENT-ITEMS ( o -- a ) 248 + ;
: _RTAPT-O.HIDDEN-CONTENT-ITEMS ( o -- a ) 256 + ;
: _RTAPT-O.PENDING-CONTENT-ITEMS ( o -- a ) 264 + ;

272 CONSTANT _RTAPT-OWNER-AUDIT-OFF
152 CONSTANT _RTAPT-OWNER-AUDIT-SIZE
: _RTAPT-O.A-RCOUNT    ( o -- a ) 272 + ;
: _RTAPT-O.A-RHIGH     ( o -- a ) 280 + ;
: _RTAPT-O.A-OCOUNT    ( o -- a ) 288 + ;
: _RTAPT-O.A-OHIGH     ( o -- a ) 296 + ;
: _RTAPT-O.A-UTF8      ( o -- a ) 304 + ;
: _RTAPT-O.A-CCOUNT    ( o -- a ) 312 + ;
: _RTAPT-O.A-CHIGH     ( o -- a ) 320 + ;
: _RTAPT-O.A-CONTENT-ITEMS ( o -- a ) 328 + ;
: _RTAPT-O.A-CPHASE    ( o -- a ) 336 + ;
: _RTAPT-O.A-CBAR-COUNT ( o -- a ) 344 + ;
: _RTAPT-O.A-CROOT-ID  ( o -- a ) 352 + ;
: _RTAPT-O.A-CMENU-FIRST ( o -- a ) 360 + ;
: _RTAPT-O.A-CMENU-LAST ( o -- a ) 368 + ;
: _RTAPT-O.A-CPARENT   ( o -- a ) 376 + ;
: _RTAPT-O.A-CORDER    ( o -- a ) 384 + ;
: _RTAPT-O.A-COPEN-MENU ( o -- a ) 392 + ;
: _RTAPT-O.A-CSELECTED-ROOT-CHILD ( o -- a ) 400 + ;
: _RTAPT-O.A-CSELECTED-ITEM-PARENT ( o -- a ) 408 + ;
: _RTAPT-O.A-OPS       ( o -- a ) 416 + ;

\ Mutable-control replacements do not add identities.  These fields hold the
\ checked post-candidate target totals and the number of controls contributing
\ to them.  Zero replacements requires both target fields to be zero.
...
\ REGION_DEFINE is copied as thirteen native cells.  The PT typed writer performs
...
: _RTAPT-RD.CLIP-X     ( r -- a )  56 + ;
: _RTAPT-RD.CLIP-Y     ( r -- a )  64 + ;
: _RTAPT-RD.CLIP-COLS  ( r -- a )  72 + ;
: _RTAPT-RD.CLIP-ROWS  ( r -- a )  80 + ;
: _RTAPT-RD.Z          ( r -- a )  88 + ;
: _RTAPT-RD.FLAGS      ( r -- a )  96 + ;

\ GLYPH_RUN retry authority stores renderer-neutral CELL_RECT32 geometry,
\ foreground
...
: _RTAPT-LD.X          ( l -- a )  40 + ;
: _RTAPT-LD.Y          ( l -- a )  48 + ;
: _RTAPT-LD.COLS       ( l -- a )  56 + ;
: _RTAPT-LD.ROWS       ( l -- a )  64 + ;
: _RTAPT-LD.Z          ( l -- a )  72 + ;
...
: _RTAPT-CD.X          ( c -- a )  72 + ;
: _RTAPT-CD.Y          ( c -- a )  80 + ;
: _RTAPT-CD.COLS       ( c -- a )  88 + ;
: _RTAPT-CD.ROWS       ( c -- a )  96 + ;
...
\ caller-owned owner bank.  META contains the kind and active/hidden presence
\ flags.  Entries occupy a sorted used prefix, so uniqueness is auditable in
\ one linear pass without a product-sized hash table.
: _RTAPT-CL.OWNER-SLOT    ( l -- a )       ;
: _RTAPT-CL.GENERATION    ( l -- a )   8 + ;
: _RTAPT-CL.CONTROL       ( l -- a )  16 + ;
: _RTAPT-CL.META          ( l -- a )  24 + ;
: _RTAPT-CL.ACTIVE-ITEMS  ( l -- a )  32 + ;
: _RTAPT-CL.ACTIVE-UTF8   ( l -- a )  40 + ;
: _RTAPT-CL.HIDDEN-ITEMS  ( l -- a )  48 + ;
: _RTAPT-CL.HIDDEN-UTF8   ( l -- a )  56 + ;
...
VARIABLE _RTAPT-CI-LA
VARIABLE _RTAPT-CI-LU
...
: _RTAPT-CONFIG-RANGES?  ( -- flag )
    ...
    _RTAPT-CI-LA @ _RTAPT-CI-LU @ _RTAPT-SPAN? 0= IF 0 EXIT THEN
    _RTAPT-CI-OU @ RTAPT-OWNER-SIZE MOD IF 0 EXIT THEN
    _RTAPT-CI-PU @ RTAPT-OP-SIZE MOD IF 0 EXIT THEN
    _RTAPT-CI-LU @ RTAPT-CONTROL-LEDGER-SIZE MOD IF 0 EXIT THEN
    ...
    _RTAPT-CI-CA @ _RTAPT-CI-CU @ _RTAPT-CI-S @
        PT-STORAGE-DISJOINT? 0= IF 0 EXIT THEN
    _RTAPT-CI-LA @ _RTAPT-CI-LU @ _RTAPT-CI-S @
        PT-STORAGE-DISJOINT? 0= IF 0 EXIT THEN
    ...
    _RTAPT-CI-C @ RTAPT-CONFIG-SIZE _RTAPT-CI-CA @ _RTAPT-CI-CU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-C @ RTAPT-CONFIG-SIZE _RTAPT-CI-LA @ _RTAPT-CI-LU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    ...
    _RTAPT-CI-S @ PT-SESSION-SIZE _RTAPT-CI-CA @ _RTAPT-CI-CU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-S @ PT-SESSION-SIZE _RTAPT-CI-LA @ _RTAPT-CI-LU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-OA @ _RTAPT-CI-OU @ _RTAPT-CI-PA @ _RTAPT-CI-PU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-OA @ _RTAPT-CI-OU @ _RTAPT-CI-CA @ _RTAPT-CI-CU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-OA @ _RTAPT-CI-OU @ _RTAPT-CI-LA @ _RTAPT-CI-LU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-PA @ _RTAPT-CI-PU @ _RTAPT-CI-CA @ _RTAPT-CI-CU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-PA @ _RTAPT-CI-PU @ _RTAPT-CI-LA @ _RTAPT-CI-LU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-CI-CA @ _RTAPT-CI-CU @ _RTAPT-CI-LA @ _RTAPT-CI-LU @
        MSPAN-OVERLAP? 0= ;

: RTAPT-CONFIG-INIT  ( session owners-a owners-u ops-a ops-u copy-a copy-u ledger-a ledger-u config -- status )
    _RTAPT-CI-C ! _RTAPT-CI-LU ! _RTAPT-CI-LA !
    _RTAPT-CI-CU ! _RTAPT-CI-CA !
    ...
    _RTAPT-CI-LA @ _RTAPT-CI-C @ _RTAPT-C.CONTROL-LEDGER-A !
    _RTAPT-CI-LU @ _RTAPT-CI-C @ _RTAPT-C.CONTROL-LEDGER-U !
    RTAPT-S-OK ;
...
: _RTAPT-CONFIG-VALID?  ( c -- flag )
    ...
    DUP _RTAPT-C.CONTROL-LEDGER-A @ _RTAPT-CI-LA !
    DUP _RTAPT-C.CONTROL-LEDGER-U @ _RTAPT-CI-LU !
...
: _RTAPT-ENGINE-DISJOINT?  ( -- flag )
    ...
    _RTAPT-I-E @ RTAPT-ENGINE-SIZE _RTAPT-CI-CA @ _RTAPT-CI-CU @
        MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-I-E @ RTAPT-ENGINE-SIZE _RTAPT-CI-LA @ _RTAPT-CI-LU @
        MSPAN-OVERLAP? 0= ;
...
: _RTAPT-CONTROL-KIND-SCALAR?  ( kind -- flag )
    ...
    RTAPT-CONTROL-TAB U> 0= ;

: _RTAPT-CONTROL-TEXT-KIND-SCALAR?  ( kind -- flag )
    DUP RTAPT-CONTROL-TEXT-AREA =
    SWAP RTAPT-CONTROL-TEXT-GRID = OR ;

: _RTAPT-CL-KIND@  ( ledger-entry -- kind )
    _RTAPT-CL.META @ _RTAPT-CL-KIND-MASK AND ;

: _RTAPT-CONTROL-LEDGER-NTH  ( index engine -- ledger-entry )
    _RTAPT-E.CONTROL-LEDGER-A @ SWAP
    RTAPT-CONTROL-LEDGER-SIZE * + ;

VARIABLE _RTAPT-CLV-E
VARIABLE _RTAPT-CLV-ENTRY
VARIABLE _RTAPT-CLV-META
VARIABLE _RTAPT-CLV-OWNER
VARIABLE _RTAPT-CLV-CONTROL
VARIABLE _RTAPT-CLV-PRIOR-OWNER
VARIABLE _RTAPT-CLV-PRIOR-CONTROL

: _RTAPT-CONTROL-LEDGER-VALID?  ( engine -- flag )
    _RTAPT-CLV-E !
    0 _RTAPT-CLV-PRIOR-OWNER ! 0 _RTAPT-CLV-PRIOR-CONTROL !
    _RTAPT-CLV-E @ _RTAPT-E.CONTROL-LEDGER-USED @ 0 ?DO
        I _RTAPT-CLV-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLV-ENTRY !
        _RTAPT-CL.OWNER-SLOT @ DUP _RTAPT-CLV-OWNER !
            _RTAPT-CLV-E @ _RTAPT-OWNER-POINTER? 0= IF
            0 UNLOOP EXIT
        THEN
        _RTAPT-CLV-OWNER @ _RTAPT-O.STATE @
            DUP RTAPT-OWNER-ST-FREE =
            SWAP RTAPT-OWNER-ST-TOMBSTONE = OR IF 0 UNLOOP EXIT THEN
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.GENERATION @
            _RTAPT-CLV-OWNER @ _RTAPT-O.GENERATION @ <> IF
            0 UNLOOP EXIT
        THEN
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.CONTROL @
            DUP _RTAPT-CLV-CONTROL ! 0= IF 0 UNLOOP EXIT THEN
        _RTAPT-CLV-CONTROL @ _RTAPT-CLV-OWNER @
            _RTAPT-O.CONTROL-HIGH @ U> IF 0 UNLOOP EXIT THEN
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.META @
            DUP _RTAPT-CLV-META ! DUP _RTAPT-CL-META-MASK INVERT AND IF
            DROP 0 UNLOOP EXIT
        THEN
        DUP _RTAPT-CL-KIND-MASK AND
            _RTAPT-CONTROL-KIND-SCALAR? 0= IF DROP 0 UNLOOP EXIT THEN
        _RTAPT-CL-ACTIVE _RTAPT-CL-HIDDEN OR AND 0= IF
            0 UNLOOP EXIT
        THEN
        _RTAPT-CLV-META @ _RTAPT-CL-ACTIVE AND 0= IF
            _RTAPT-CLV-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS @
            _RTAPT-CLV-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 @ OR IF
                0 UNLOOP EXIT
            THEN
        THEN
        _RTAPT-CLV-META @ _RTAPT-CL-HIDDEN AND 0= IF
            _RTAPT-CLV-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS @
            _RTAPT-CLV-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 @ OR IF
                0 UNLOOP EXIT
            THEN
        THEN
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS @ _RTAPT-U32? 0=
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS @ _RTAPT-U32? 0= OR IF
            0 UNLOOP EXIT
        THEN
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 @ _RTAPT-U32? 0=
        _RTAPT-CLV-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 @ _RTAPT-U32? 0= OR IF
            0 UNLOOP EXIT
        THEN
        _RTAPT-CLV-ENTRY @ _RTAPT-CL-KIND@
            _RTAPT-CONTROL-TEXT-KIND-SCALAR? 0= IF
            _RTAPT-CLV-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS @
            _RTAPT-CLV-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS @ OR IF
                0 UNLOOP EXIT
            THEN
        THEN
        I IF
            _RTAPT-CLV-OWNER @ _RTAPT-CLV-PRIOR-OWNER @ U< IF
                0 UNLOOP EXIT
            THEN
            _RTAPT-CLV-OWNER @ _RTAPT-CLV-PRIOR-OWNER @ = IF
                _RTAPT-CLV-CONTROL @
                    _RTAPT-CLV-PRIOR-CONTROL @ U> 0= IF
                    0 UNLOOP EXIT
                THEN
            THEN
        THEN
        _RTAPT-CLV-OWNER @ _RTAPT-CLV-PRIOR-OWNER !
        _RTAPT-CLV-CONTROL @ _RTAPT-CLV-PRIOR-CONTROL !
    LOOP
    0 _RTAPT-CLV-E ! 0 _RTAPT-CLV-ENTRY ! 0 _RTAPT-CLV-META !
    0 _RTAPT-CLV-OWNER ! 0 _RTAPT-CLV-CONTROL !
    0 _RTAPT-CLV-PRIOR-OWNER ! 0 _RTAPT-CLV-PRIOR-CONTROL ! -1 ;

VARIABLE _RTAPT-CLQ-E
VARIABLE _RTAPT-CLQ-PLANNED
VARIABLE _RTAPT-CLQ-ACTIVE

\ REPLACE_START retires an older hidden target only after acknowledgement,
\ while its complete active target remains retained until reveal.  Admission
\ therefore reserves the active identity count plus the exact planned target.
: _RTAPT-CONTROL-LEDGER-TARGET-CAPACITY?  ( planned-controls engine -- flag )
    _RTAPT-CLQ-E ! _RTAPT-CLQ-PLANNED !
    0 _RTAPT-CLQ-ACTIVE !
    _RTAPT-CLQ-E @ _RTAPT-E.CONTROL-LEDGER-USED @ 0 ?DO
        I _RTAPT-CLQ-E @ _RTAPT-CONTROL-LEDGER-NTH _RTAPT-CL.META @
            _RTAPT-CL-ACTIVE AND IF
            _RTAPT-CLQ-ACTIVE @ 1 _RTAPT-UADD?
                0= IF DROP 0 UNLOOP EXIT THEN _RTAPT-CLQ-ACTIVE !
        THEN
    LOOP
    _RTAPT-CLQ-ACTIVE @ _RTAPT-CLQ-PLANNED @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CLQ-E @ _RTAPT-E.CONTROL-LEDGER-CAP @ U> 0= ;

VARIABLE _RTAPT-CLF-E
VARIABLE _RTAPT-CLF-OWNER
VARIABLE _RTAPT-CLF-GEN
VARIABLE _RTAPT-CLF-CONTROL
VARIABLE _RTAPT-CLF-ENTRY

: _RTAPT-CONTROL-LEDGER-FIND
  ( owner-record generation control engine -- ledger-entry|0 )
    _RTAPT-CLF-E ! _RTAPT-CLF-CONTROL !
    _RTAPT-CLF-GEN ! _RTAPT-CLF-OWNER !
    _RTAPT-CLF-E @ _RTAPT-E.CONTROL-LEDGER-USED @ 0 ?DO
        I _RTAPT-CLF-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLF-ENTRY !
        DUP _RTAPT-CL.OWNER-SLOT @ _RTAPT-CLF-OWNER @ U> IF
            DROP 0 UNLOOP EXIT
        THEN
        _RTAPT-CLF-ENTRY @ _RTAPT-CL.OWNER-SLOT @
            _RTAPT-CLF-OWNER @ = IF
            _RTAPT-CLF-ENTRY @ _RTAPT-CL.CONTROL @
                _RTAPT-CLF-CONTROL @ U> IF DROP 0 UNLOOP EXIT THEN
            _RTAPT-CLF-ENTRY @ _RTAPT-CL.CONTROL @
...
VARIABLE _RTAPT-CLO-E
VARIABLE _RTAPT-CLO-O
VARIABLE _RTAPT-CLO-ENTRY
VARIABLE _RTAPT-CLO-ACTIVE-CONTROLS
VARIABLE _RTAPT-CLO-HIDDEN-CONTROLS
VARIABLE _RTAPT-CLO-ACTIVE-ITEMS
VARIABLE _RTAPT-CLO-HIDDEN-ITEMS
VARIABLE _RTAPT-CLO-ACTIVE-UTF8
VARIABLE _RTAPT-CLO-HIDDEN-UTF8

: _RTAPT-CONTROL-LEDGER-OWNER?  ( owner-record engine -- flag )
    _RTAPT-CLO-E ! _RTAPT-CLO-O !
    0 _RTAPT-CLO-ACTIVE-CONTROLS ! 0 _RTAPT-CLO-HIDDEN-CONTROLS !
    0 _RTAPT-CLO-ACTIVE-ITEMS ! 0 _RTAPT-CLO-HIDDEN-ITEMS !
    0 _RTAPT-CLO-ACTIVE-UTF8 ! 0 _RTAPT-CLO-HIDDEN-UTF8 !
    _RTAPT-CLO-E @ _RTAPT-E.CONTROL-LEDGER-USED @ 0 ?DO
        I _RTAPT-CLO-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLO-ENTRY !
        _RTAPT-CL.OWNER-SLOT @ DUP _RTAPT-CLO-O @ U> IF
            DROP LEAVE
        THEN
        _RTAPT-CLO-O @ <> IF
            \ Sorted owner keys make nonmatching earlier entries irrelevant.
        ELSE
            _RTAPT-CLO-ENTRY @ _RTAPT-CL.META @ _RTAPT-CL-ACTIVE AND IF
                _RTAPT-CLO-ACTIVE-CONTROLS @ 1 _RTAPT-UADD?
                    0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-CLO-ACTIVE-CONTROLS !
                _RTAPT-CLO-ACTIVE-ITEMS @
                _RTAPT-CLO-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS @
                    _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-CLO-ACTIVE-ITEMS !
                _RTAPT-CLO-ACTIVE-UTF8 @
                _RTAPT-CLO-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 @
                    _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-CLO-ACTIVE-UTF8 !
            THEN
            _RTAPT-CLO-ENTRY @ _RTAPT-CL.META @ _RTAPT-CL-HIDDEN AND IF
                _RTAPT-CLO-HIDDEN-CONTROLS @ 1 _RTAPT-UADD?
                    0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-CLO-HIDDEN-CONTROLS !
                _RTAPT-CLO-HIDDEN-ITEMS @
                _RTAPT-CLO-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS @
                    _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-CLO-HIDDEN-ITEMS !
                _RTAPT-CLO-HIDDEN-UTF8 @
                _RTAPT-CLO-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 @
                    _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-CLO-HIDDEN-UTF8 !
            THEN
        THEN
    LOOP
    _RTAPT-CLO-ACTIVE-CONTROLS @
        _RTAPT-CLO-O @ _RTAPT-O.ACTIVE-CONTROLS @ <> IF 0 EXIT THEN
    _RTAPT-CLO-HIDDEN-CONTROLS @
        _RTAPT-CLO-O @ _RTAPT-O.HIDDEN-CONTROLS @ <> IF 0 EXIT THEN
    _RTAPT-CLO-ACTIVE-ITEMS @
        _RTAPT-CLO-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @ <> IF 0 EXIT THEN
    _RTAPT-CLO-HIDDEN-ITEMS @
        _RTAPT-CLO-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS @ <> IF 0 EXIT THEN
    _RTAPT-CLO-ACTIVE-UTF8 @
        _RTAPT-CLO-O @ _RTAPT-O.ACTIVE-CONTROL-UTF8 @ <> IF 0 EXIT THEN
    _RTAPT-CLO-HIDDEN-UTF8 @
        _RTAPT-CLO-O @ _RTAPT-O.HIDDEN-CONTROL-UTF8 @ <> IF 0 EXIT THEN
    _RTAPT-CLO-ACTIVE-UTF8 @
        _RTAPT-CLO-O @ _RTAPT-O.ACTIVE-UTF8 @ U> IF 0 EXIT THEN
    _RTAPT-CLO-HIDDEN-UTF8 @
        _RTAPT-CLO-O @ _RTAPT-O.HIDDEN-UTF8 @ U> IF 0 EXIT THEN
    0 _RTAPT-CLO-E ! 0 _RTAPT-CLO-O ! 0 _RTAPT-CLO-ENTRY ! -1 ;
...
: _RTAPT-BYTE-LE32@  ( a -- u )
    DUP _RTAPT-BYTE-LE16@
    SWAP 2 + _RTAPT-BYTE-LE16@ 16 LSHIFT OR ;

: _RTAPT-STX1-HEADER?  ( a u items -- flag )
    >R
    DUP 72 U< IF 2DROP R> DROP 0 EXIT THEN
    OVER _RTAPT-BYTE-LE32@ _RTAPT-STX1-TAG <> IF
        2DROP R> DROP 0 EXIT
    THEN
    OVER 4 + _RTAPT-BYTE-LE16@ _RTAPT-STX1-VERSION <> IF
        2DROP R> DROP 0 EXIT
    THEN
    OVER 6 + _RTAPT-BYTE-LE16@ IF 2DROP R> DROP 0 EXIT THEN
    OVER 40 + _RTAPT-BYTE-LE32@ R> = >R 2DROP R> ;
...
: _RTAPT-CONTROL-COPY-CONTENT-HEADER?  ( control-copy -- flag )
    DUP _RTAPT-CD.CONTENT-U @ DUP 0= IF 2DROP -1 EXIT THEN >R
    DUP _RTAPT-CONTROL-COPY-CONTENT-A
    SWAP _RTAPT-CD.CONTENT-ITEMS @ R> SWAP _RTAPT-STX1-HEADER? ;

: _RTAPT-CONTROL-CONTENT-META?  ( control-copy -- flag )
...
VARIABLE _RTAPT-DRO-P
VARIABLE _RTAPT-DRO-I
VARIABLE _RTAPT-DRO-E

: _RTAPT-DEFINITION-REGION-OP-FINISH  ( flag -- flag )
    0 _RTAPT-DRO-P ! 0 _RTAPT-DRO-I ! 0 _RTAPT-DRO-E ! ;
...
: _RTAPT-DEFINITION-REGION-OP?  ( op index engine -- flag )
    ...
    SWAP _RTAPT-OP-INSTRUMENT-DEFINE = OR IF
        ...
        THEN
        _RTAPT-DRO-P @ _RTAPT-P.KIND @ _RTAPT-OP-GLYPH-RUN-DEFINE =
        _RTAPT-DRO-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA = AND
            _RTAPT-DEFINITION-REGION-OP-FINISH EXIT
    THEN
    _RTAPT-DRO-P @ _RTAPT-P.REGION-OP @ 0=
        _RTAPT-DEFINITION-REGION-OP-FINISH ;
...
: _RTAPT-CAPTURED-BANKS?  ( engine -- flag )
    ...
    _RTAPT-BV-E @ _RTAPT-E.OP-COUNT @ 0 ?DO
        ...
        _RTAPT-BV-P @ _RTAPT-P.OWNER-SLOT @
            ...
            0 UNLOOP EXIT
        THEN
        _RTAPT-BV-P @ I _RTAPT-BV-E @
            _RTAPT-DEFINITION-REGION-OP? 0= IF
            0 UNLOOP EXIT
        THEN
        ...
        ELSE
            ...
            ELSE
                _RTAPT-BV-P @ _RTAPT-P.KIND @
                    ...
                    _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-U @ _RTAPT-U32? 0=
                    _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-ITEMS @
                        _RTAPT-U32? 0= OR
                    _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-UTF8 @
                        _RTAPT-U32? 0= OR IF 0 UNLOOP EXIT THEN
                    _RTAPT-BV-COPY @ _RTAPT-CONTROL-CONTENT-META? 0= IF
                        0 UNLOOP EXIT
                    THEN
                    _RTAPT-BV-COPY @ _RTAPT-CD.LABEL-U @
                    _RTAPT-BV-COPY @ _RTAPT-CD.SHORTCUT-U @
                        _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-U @
                        _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    ...
                    _RTAPT-BV-COPY-U @ _RTAPT-BV-RAW-U @ -
                        _RTAPT-ZERO-SPAN? 0= IF 0 UNLOOP EXIT THEN
                    _RTAPT-BV-COPY @
                        _RTAPT-CONTROL-COPY-CONTENT-HEADER? 0= IF
                        0 UNLOOP EXIT
                    THEN
                ...
                ELSE
                    _RTAPT-BV-P @ _RTAPT-P.KIND @
                        _RTAPT-INSTRUMENT-OP? IF
                        _RTAPT-BV-COPY-U @ _RTAPT-INSTRUMENT-COPY-FIXED U<
                            IF 0 UNLOOP EXIT THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.UNIT-A @ IF
                            0 UNLOOP EXIT
                        THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.UNIT-U @
                            _RTAPT-U32? 0= IF 0 UNLOOP EXIT THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.FORMATTED-U @
                            _RTAPT-U32? 0= IF 0 UNLOOP EXIT THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.RESERVED @ IF
                            0 UNLOOP EXIT
                        THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.ROOT-HEIGHT @
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.ROOT-WIDTH @ OR IF
                            0 UNLOOP EXIT
                        THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.UNIT-U @
                            _RTAPT-INSTRUMENT-COPY-FIXED _RTAPT-UADD? 0= IF
                            DROP 0 UNLOOP EXIT
                        THEN DUP _RTAPT-BV-RAW-U !
                        _RTAPT-ALIGN8? 0= IF DROP 0 UNLOOP EXIT THEN
                        _RTAPT-BV-COPY-U @ <> IF 0 UNLOOP EXIT THEN
                        _RTAPT-BV-COPY @ _RTAPT-BV-RAW-U @ +
                        _RTAPT-BV-COPY-U @ _RTAPT-BV-RAW-U @ -
                            _RTAPT-ZERO-SPAN? 0= IF 0 UNLOOP EXIT THEN
                        _RTAPT-BV-COPY @ _RTAPT-INSTRUMENT.KIND @ DUP
                            RTAPT-INSTRUMENT-READOUT = IF
                            DROP _RTAPT-BV-COPY @
                                _RTAPT-INSTRUMENT.UNIT-U @
                                _RTAPT-READOUT-FRAME-FIXED _RTAPT-UADD? 0= IF
                                DROP 0 UNLOOP EXIT
                            THEN _RTAPT-BV-FRAME !
                        ELSE DUP RTAPT-INSTRUMENT-METER = IF
                            DROP _RTAPT-BV-COPY @
                                _RTAPT-INSTRUMENT.UNIT-U @
                            _RTAPT-BV-COPY @
...
: _RTAPT-OWNER-AUDIT-MATCH?  ( -- flag )
    ...
    THEN
    _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ IF
        _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8-TARGET @
        _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8 @ _RTAPT-UADD?
            0= IF DROP 0 EXIT THEN
        _RTAPT-LV-O @ _RTAPT-O.A-UTF8 @ <> IF 0 EXIT THEN
        _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-TARGET @
        _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @ _RTAPT-UADD?
            0= IF DROP 0 EXIT THEN
        _RTAPT-LV-O @ _RTAPT-O.A-CONTENT-ITEMS @ <> IF 0 EXIT THEN
    ELSE
        _RTAPT-LV-O @ _RTAPT-O.A-UTF8 @
            _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8 @ <> IF 0 EXIT THEN
        _RTAPT-LV-O @ _RTAPT-O.A-CONTENT-ITEMS @
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @ <>
            IF 0 EXIT THEN
    THEN
    ...
    _RTAPT-LV-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA = IF
        ...
        THEN
        _RTAPT-LV-O @ _RTAPT-O.A-CBAR-COUNT @
        _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ <>
            IF 0 EXIT THEN
    ...
    ELSE
        _RTAPT-LV-O @ _RTAPT-O.A-CCOUNT @ IF
            ...
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-HIGH @ <>
                IF 0 EXIT THEN
            _RTAPT-LV-O @ _RTAPT-O.A-CBAR-COUNT @ IF
                _RTAPT-LV-O @ _RTAPT-O.A-CPHASE @
...
: _RTAPT-OWNER-LEDGERS-FROM?  ( nondefinition-ops audit? engine -- flag )
    ...
    _RTAPT-LV-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        ...
        DUP _RTAPT-LV-O ! _RTAPT-O.STATE @ RTAPT-OWNER-ST-FREE = IF
            ...
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-HIGH @ OR
            _RTAPT-LV-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @ OR
            _RTAPT-LV-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS @ OR
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @ OR
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ OR
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-TARGET @ OR
            _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8-TARGET @ OR IF
                0 UNLOOP EXIT
            THEN
        ...
        ELSE
            ...
            _RTAPT-LV-O @ _RTAPT-O.ACTIVE-CONTROLS @ _RTAPT-UADD? 0= IF
                DROP 0 UNLOOP EXIT
            THEN
            _RTAPT-LV-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @
                _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
            ...
            _RTAPT-LV-O @ _RTAPT-O.HIDDEN-CONTROLS @ _RTAPT-UADD? 0= IF
                DROP 0 UNLOOP EXIT
            THEN
            _RTAPT-LV-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS @
                _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
            ...
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ IF
                _RTAPT-LV-ACTIVE-SHARED @
                    _RTAPT-LV-O @ _RTAPT-O.OBJECTS @ U>
                _RTAPT-LV-HIDDEN-SHARED @
                    _RTAPT-LV-O @ _RTAPT-O.OBJECTS @ U> OR
                _RTAPT-LV-PENDING-SHARED @
                    _RTAPT-LV-O @ _RTAPT-O.OBJECTS @ U> OR IF
                    0 UNLOOP EXIT
                THEN
            ELSE
                _RTAPT-LV-ACTIVE-SHARED @
            ...
            _RTAPT-LV-O @ _RTAPT-O.ACTIVE-CONTROLS @ 0=
            _RTAPT-LV-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @ 0<> AND
                IF 0 UNLOOP EXIT THEN
            _RTAPT-LV-O @ _RTAPT-O.HIDDEN-CONTROLS @ 0=
            _RTAPT-LV-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS @ 0<> AND
                IF 0 UNLOOP EXIT THEN
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROLS @ 0=
            ...
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ IF
                _RTAPT-LV-O @ _RTAPT-O.ACTIVE-UTF8 @
                    _RTAPT-LV-O @ _RTAPT-O.UTF8-BYTES @ U>
                _RTAPT-LV-O @ _RTAPT-O.HIDDEN-UTF8 @
                    _RTAPT-LV-O @ _RTAPT-O.UTF8-BYTES @ U> OR
                _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8 @
                    _RTAPT-LV-O @ _RTAPT-O.UTF8-BYTES @ U> OR IF
                    0 UNLOOP EXIT
                THEN
            ELSE
                _RTAPT-LV-O @ _RTAPT-O.ACTIVE-UTF8 @
            ...
            \ Mutable replacements stage exact resulting DELTA-target totals,
            \ never unsigned additions.  Validate those totals independently
            \ from the ordinary definition ledgers above.
            _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @
                DUP _RTAPT-U32? 0= IF DROP 0 UNLOOP EXIT THEN
            DUP 0= IF
                DROP
                _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-TARGET @
                _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8-TARGET @ OR IF
                ...
                THEN
            ELSE
                _RTAPT-LV-O @ _RTAPT-O.ACTIVE-CONTROLS @ U> IF
                    0 UNLOOP EXIT
                THEN
                ...
                _RTAPT-LV-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @
                    _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                _RTAPT-LV-O @ _RTAPT-O.OBJECTS @ U> IF
                    0 UNLOOP EXIT
                THEN
                _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8-TARGET @
                _RTAPT-LV-O @ _RTAPT-O.PENDING-UTF8 @
                    _RTAPT-UADD? 0= IF DROP 0 UNLOOP EXIT THEN
                    _RTAPT-LV-O @ _RTAPT-O.UTF8-BYTES @ U> IF
                    0 UNLOOP EXIT
                THEN
            THEN
...
: _RTAPT-OWNER-LEDGERS?  ( engine -- flag )
    ...
    \ remain cross-checked against their per-owner pending ledgers.
...
: _RTAPT-ENGINE-VALID?  ( e -- flag )
    ...
    DUP _RTAPT-CONTROL-LEDGER-VALID? 0= IF DROP 0 EXIT THEN
...
: RTAPT-INIT  ( config engine -- status )
    ...
    _RTAPT-CI-LA @ _RTAPT-CI-LU @ 0 FILL
    ...
    _RTAPT-CI-LA @ _RTAPT-I-E @ _RTAPT-E.CONTROL-LEDGER-A !
    _RTAPT-CI-LU @ _RTAPT-I-E @ _RTAPT-E.CONTROL-LEDGER-U !
    _RTAPT-CI-LU @ RTAPT-CONTROL-LEDGER-SIZE /
        _RTAPT-I-E @ _RTAPT-E.CONTROL-LEDGER-CAP !
...
: _RTAPT-QUARANTINE-ALL  ( status engine -- status )
    ...
    _RTAPT-QA-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        ...
        DUP _RTAPT-QA-O ! _RTAPT-O.STATE @ RTAPT-OWNER-ST-FREE <> IF
            ...
            0 _RTAPT-QA-O @ _RTAPT-O.PENDING-CONTENT-ITEMS !
            0 _RTAPT-QA-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS !
            0 _RTAPT-QA-O @ _RTAPT-O.PENDING-CONTENT-TARGET !
            0 _RTAPT-QA-O @ _RTAPT-O.PENDING-UTF8-TARGET !
        THEN
    LOOP
...
: _RTAPT-LIMITS-VALID-BODY  ( limits -- flag )
    ...
    DUP RTAPT-F-SERIES AND SWAP RTAPT-F-INSTRUMENT AND 0= AND IF
        0 EXIT
    THEN
    _RTAPT-LV-FEATURES @ RTAPT-F-CONTROL-COLLECTIONS AND
    ...
    _RTAPT-LV-L @ _RTAPT-L.UPDATE-BYTES @ 264 U< OR IF 0 EXIT THEN
    ...
    ELSE
        ...
        _RTAPT-LV-FEATURES @ RTAPT-F-CONTROLS AND
    ...
    _RTAPT-LV-FEATURES @ RTAPT-F-CADENCE AND 0<>
        _RTAPT-POSITIVE-EXACT? 0= IF 0 EXIT THEN
    _RTAPT-LV-L @ _RTAPT-L.OUTBOUND-PAYLOAD @ 64 U< IF 0 EXIT THEN
    ...
    THEN
    _RTAPT-LV-FEATURES @ RTAPT-F-CONTROL-COLLECTIONS AND IF
        _RTAPT-LV-L @ _RTAPT-L.OUTBOUND-PAYLOAD @ 152 U< IF 0 EXIT THEN
        352 _RTAPT-LV-L @ _RTAPT-LIMIT-FLOOR? 0= IF 0 EXIT THEN
    THEN
...
: _RTAPT-LIMITS-COPY  ( -- limits )
    ...
    _RTAPT-LS-CAPS-A @ 8 + _RTAPT-LE64@ DUP 0x3F AND SWAP
    DUP _RTAPT-PT-F-CONTROLS AND IF
        SWAP RTAPT-F-CONTROLS OR SWAP
    THEN
    _RTAPT-PT-F-CONTROL-COLLECTIONS AND IF
        RTAPT-F-CONTROL-COLLECTIONS OR
    THEN
...
: _RTAPT-PENDING-CLEAR  ( engine -- )
    ...
    _RTAPT-BC-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        ...
        DUP _RTAPT-O.PENDING-CONTENT-ITEMS OFF
        DUP _RTAPT-O.PENDING-UTF8 OFF
        DUP _RTAPT-O.PENDING-CONTROL-REPLACEMENTS OFF
        DUP _RTAPT-O.PENDING-CONTENT-TARGET OFF
        _RTAPT-O.PENDING-UTF8-TARGET OFF
    LOOP DROP ;
...
: RTAPT-STORAGE-DISJOINT?  ( a u engine -- flag )
    ...
    2DUP R@ _RTAPT-E.COPY-A @ R@ _RTAPT-E.COPY-U @
        MSPAN-OVERLAP? IF 2DROP R> DROP 0 EXIT THEN
    2DUP R@ _RTAPT-E.CONTROL-LEDGER-A @
        R@ _RTAPT-E.CONTROL-LEDGER-U @
        MSPAN-OVERLAP? IF 2DROP R> DROP 0 EXIT THEN
    2DROP R> DROP -1 ;
...
: _RTAPT-BYTE-SPAN-DISJOINT?  ( a u engine -- flag )
    ...
    _RTAPT-BSD-A @ _RTAPT-BSD-U @
        ...
        _RTAPT-BSD-E @ _RTAPT-E.COPY-U @ MSPAN-OVERLAP? IF 0 EXIT THEN
    _RTAPT-BSD-A @ _RTAPT-BSD-U @
        _RTAPT-BSD-E @ _RTAPT-E.CONTROL-LEDGER-A @
        _RTAPT-BSD-E @ _RTAPT-E.CONTROL-LEDGER-U @ MSPAN-OVERLAP? 0= ;
...
VARIABLE _RTAPT-LPF-CLIP-X
VARIABLE _RTAPT-LPF-CLIP-Y
VARIABLE _RTAPT-LPF-CLIP-COLS
...
\ Shared CELL_RECT32 REGION validation.  Every scalar is copied into private
\ scratch so callers may invoke this from capture/publication DO loops without
\ borrowing the return stack that owns the loop counter.
VARIABLE _RTAPT-RGV-X
VARIABLE _RTAPT-RGV-Y
VARIABLE _RTAPT-RGV-COLS
VARIABLE _RTAPT-RGV-ROWS
VARIABLE _RTAPT-RGV-CLIP-X
VARIABLE _RTAPT-RGV-CLIP-Y
VARIABLE _RTAPT-RGV-CLIP-COLS
VARIABLE _RTAPT-RGV-CLIP-ROWS
VARIABLE _RTAPT-RGV-FLAGS
VARIABLE _RTAPT-RGV-SURFACE-COLS
VARIABLE _RTAPT-RGV-SURFACE-ROWS
VARIABLE _RTAPT-RGV-X-END
VARIABLE _RTAPT-RGV-Y-END
VARIABLE _RTAPT-RGV-CLIP-X-END
VARIABLE _RTAPT-RGV-CLIP-Y-END

: _RTAPT-RGV-FINISH  ( flag -- flag )
    0 _RTAPT-RGV-X ! 0 _RTAPT-RGV-Y !
    0 _RTAPT-RGV-COLS ! 0 _RTAPT-RGV-ROWS !
    0 _RTAPT-RGV-CLIP-X ! 0 _RTAPT-RGV-CLIP-Y !
    0 _RTAPT-RGV-CLIP-COLS ! 0 _RTAPT-RGV-CLIP-ROWS !
    0 _RTAPT-RGV-FLAGS !
    0 _RTAPT-RGV-SURFACE-COLS ! 0 _RTAPT-RGV-SURFACE-ROWS !
    0 _RTAPT-RGV-X-END ! 0 _RTAPT-RGV-Y-END !
    0 _RTAPT-RGV-CLIP-X-END ! 0 _RTAPT-RGV-CLIP-Y-END ! ;

: _RTAPT-REGION-INTRINSIC-BODY?  ( -- flag )
    _RTAPT-RGV-X @ _RTAPT-I32? 0=
    _RTAPT-RGV-Y @ _RTAPT-I32? 0= OR IF 0 EXIT THEN
    _RTAPT-RGV-COLS @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-RGV-ROWS @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-RGV-CLIP-X @ _RTAPT-U32? 0=
    _RTAPT-RGV-CLIP-Y @ _RTAPT-U32? 0= OR
    _RTAPT-RGV-CLIP-COLS @ _RTAPT-U32? 0= OR
    _RTAPT-RGV-CLIP-ROWS @ _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-RGV-FLAGS @ _RTAPT-REGION-F-MASK INVERT AND IF 0 EXIT THEN

    _RTAPT-RGV-X @ _RTAPT-RGV-COLS @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-RGV-X-END !
    _RTAPT-RGV-Y @ _RTAPT-RGV-ROWS @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-RGV-Y-END !

    _RTAPT-RGV-FLAGS @ _RTAPT-REGION-F-CLIPPED AND 0= IF
        _RTAPT-RGV-CLIP-X @ _RTAPT-RGV-CLIP-Y @ OR
        _RTAPT-RGV-CLIP-COLS @ OR _RTAPT-RGV-CLIP-ROWS @ OR 0= EXIT
    THEN
    _RTAPT-RGV-CLIP-X @ _RTAPT-RGV-CLIP-Y @ OR
    _RTAPT-RGV-CLIP-COLS @ OR _RTAPT-RGV-CLIP-ROWS @ OR 0= IF -1 EXIT THEN
    _RTAPT-RGV-CLIP-COLS @ 0= _RTAPT-RGV-CLIP-ROWS @ 0= OR IF 0 EXIT THEN
    _RTAPT-RGV-CLIP-X @ _RTAPT-RGV-CLIP-COLS @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN DUP 0xFFFFFFFF U> IF DROP 0 EXIT THEN _RTAPT-RGV-CLIP-X-END !
    _RTAPT-RGV-CLIP-Y @ _RTAPT-RGV-CLIP-ROWS @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN DUP 0xFFFFFFFF U> IF DROP 0 EXIT THEN _RTAPT-RGV-CLIP-Y-END !
    _RTAPT-RGV-CLIP-X @ _RTAPT-RGV-X @ < IF 0 EXIT THEN
    _RTAPT-RGV-CLIP-X-END @ _RTAPT-RGV-X-END @ > IF 0 EXIT THEN
    _RTAPT-RGV-CLIP-Y @ _RTAPT-RGV-Y @ < IF 0 EXIT THEN
    _RTAPT-RGV-CLIP-Y-END @ _RTAPT-RGV-Y-END @ > IF 0 EXIT THEN
    -1 ;

: _RTAPT-REGION-GEOMETRY-BODY?  ( -- flag )
    _RTAPT-RGV-SURFACE-COLS @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-RGV-SURFACE-ROWS @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF
        0 EXIT
    THEN
    _RTAPT-REGION-INTRINSIC-BODY? 0= IF 0 EXIT THEN
    _RTAPT-RGV-FLAGS @ _RTAPT-REGION-F-CLIPPED AND 0= IF -1 EXIT THEN
    _RTAPT-RGV-CLIP-X @ _RTAPT-RGV-CLIP-Y @ OR
    _RTAPT-RGV-CLIP-COLS @ OR _RTAPT-RGV-CLIP-ROWS @ OR 0= IF -1 EXIT THEN
    _RTAPT-RGV-CLIP-X-END @ _RTAPT-RGV-SURFACE-COLS @ U> IF 0 EXIT THEN
    _RTAPT-RGV-CLIP-Y-END @ _RTAPT-RGV-SURFACE-ROWS @ U> 0= ;

: _RTAPT-REGION-INTRINSIC?
  ( x y cols rows clip-x clip-y clip-cols clip-rows flags -- flag )
    _RTAPT-RGV-FLAGS ! _RTAPT-RGV-CLIP-ROWS ! _RTAPT-RGV-CLIP-COLS !
    _RTAPT-RGV-CLIP-Y ! _RTAPT-RGV-CLIP-X !
    _RTAPT-RGV-ROWS ! _RTAPT-RGV-COLS ! _RTAPT-RGV-Y ! _RTAPT-RGV-X !
    _RTAPT-REGION-INTRINSIC-BODY? _RTAPT-RGV-FINISH ;

: _RTAPT-REGION-GEOMETRY?
  ( x y cols rows clip-x clip-y clip-cols clip-rows flags surface-cols surface-rows -- flag )
    _RTAPT-RGV-SURFACE-ROWS ! _RTAPT-RGV-SURFACE-COLS !
    _RTAPT-RGV-FLAGS ! _RTAPT-RGV-CLIP-ROWS ! _RTAPT-RGV-CLIP-COLS !
    _RTAPT-RGV-CLIP-Y ! _RTAPT-RGV-CLIP-X !
    _RTAPT-RGV-ROWS ! _RTAPT-RGV-COLS ! _RTAPT-RGV-Y ! _RTAPT-RGV-X !
    _RTAPT-REGION-GEOMETRY-BODY? _RTAPT-RGV-FINISH ;
...
: _RTAPT-LPF-HEADER?  ( -- flag )
    ...
    _RTAPT-LPF-PLAN @ _RTAPT-LP.CLIP-X @ _RTAPT-LPF-CLIP-X !
    _RTAPT-LPF-PLAN @ _RTAPT-LP.CLIP-Y @ _RTAPT-LPF-CLIP-Y !
    _RTAPT-LPF-PLAN @ _RTAPT-LP.CLIP-COLS @ _RTAPT-LPF-CLIP-COLS !
    _RTAPT-LPF-PLAN @ _RTAPT-LP.CLIP-ROWS @ _RTAPT-LPF-CLIP-ROWS !
    ...
    _RTAPT-LPF-REGION-X @ _RTAPT-LPF-REGION-Y @
    _RTAPT-LPF-REGION-COLS @ _RTAPT-LPF-REGION-ROWS @
    _RTAPT-LPF-CLIP-X @ _RTAPT-LPF-CLIP-Y @
    _RTAPT-LPF-CLIP-COLS @ _RTAPT-LPF-CLIP-ROWS @
    _RTAPT-LPF-REGION-FLAGS @
    _RTAPT-LPF-SURFACE-COLS @ _RTAPT-LPF-SURFACE-ROWS @
        _RTAPT-REGION-GEOMETRY? 0= IF 0 EXIT THEN
...
: _RTAPT-LPF-ITEM?  ( item -- flag )
    ...
    _RTAPT-LPF-ITEM @ _RTAPT-LPI.HEIGHT @ DUP 0=
        SWAP _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-LPF-ITEM @ _RTAPT-LPI.WIDTH @ DUP 0=
        SWAP _RTAPT-U32? 0= OR IF 0 EXIT THEN
...
: _RTAPT-LPF-OWNER-ADMISSION  ( -- status )
    ...
    _RTAPT-LPF-LIMITS @ _RTAPT-L.LIVE-OWNERS @ U> IF
        RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-LPF-AGG-REGIONS @ _RTAPT-LPF-REQUESTED-REGIONS @
        _RTAPT-UADD? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN
...
: _RTAPT-GLYPH-RUN-PREFLIGHT-BODY  ( -- status )
    ...
    1 _RTAPT-LPF-REQUESTED-REGIONS !
...
VARIABLE _RTAPT-CPF-CLIP-X
VARIABLE _RTAPT-CPF-CLIP-Y
VARIABLE _RTAPT-CPF-CLIP-COLS
VARIABLE _RTAPT-CPF-CLIP-ROWS
...
: _RTAPT-CONTROL-PREFLIGHT-SCRUB  ( -- )
    ...
    0 _RTAPT-CPF-REGION-ROWS !
    0 _RTAPT-CPF-CLIP-X ! 0 _RTAPT-CPF-CLIP-Y !
    0 _RTAPT-CPF-CLIP-COLS ! 0 _RTAPT-CPF-CLIP-ROWS !
    0 _RTAPT-CPF-REGION-Z !
    ...
    0 _RTAPT-CPF-COLLECTIONS ! 0 _RTAPT-CPF-CONTENT-ITEMS !
...
: _RTAPT-CONTROL-PREFLIGHT-FIELDS?  ( -- flag )
    ...
    _RTAPT-CPF-REGION-X @ _RTAPT-CPF-REGION-Y @
    _RTAPT-CPF-REGION-COLS @ _RTAPT-CPF-REGION-ROWS @
    _RTAPT-CPF-CLIP-X @ _RTAPT-CPF-CLIP-Y @
    _RTAPT-CPF-CLIP-COLS @ _RTAPT-CPF-CLIP-ROWS @
    _RTAPT-CPF-REGION-FLAGS @
    _RTAPT-CPF-SURFACE-COLS @ _RTAPT-CPF-SURFACE-ROWS @
        _RTAPT-REGION-GEOMETRY? 0= IF 0 EXIT THEN
    ...
    _RTAPT-CPF-UTF8 @ DUP 0< IF DROP 0 EXIT THEN
    _RTAPT-CPF-TEXT @ U> IF 0 EXIT THEN
    _RTAPT-CPF-COLLECTIONS @ DUP 0< IF DROP 0 EXIT THEN
...
: _RTAPT-CONTROL-PREFLIGHT-ARITHMETIC?  ( -- flag )
    _RTAPT-CPF-COUNT @ _RTAPT-CPF-CONTENT-ITEMS @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    DUP _RTAPT-U32? 0= IF DROP 0 EXIT THEN _RTAPT-CPF-SHARED !
...
: _RTAPT-CONTROL-PREFLIGHT-BODY  ( -- status )
    ...
    _RTAPT-CPF-COPY @ _RTAPT-CPF-E @ _RTAPT-E.COPY-U @ U> IF
        RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-CPF-COUNT @ _RTAPT-CPF-E @
        _RTAPT-CONTROL-LEDGER-TARGET-CAPACITY? 0= IF
        RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-CPF-TX @ _RTAPT-LPF-LIMITS @ _RTAPT-L.UPDATE-BYTES @ U> IF
        RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-CPF-UTF8 @ _RTAPT-LPF-LIMITS @ _RTAPT-L.UTF8-BYTES @ U> IF
        RTAPT-S-CAPACITY EXIT
    THEN
    ...
    _RTAPT-CPF-SHARED @ _RTAPT-LPF-COUNT !
    _RTAPT-CPF-UTF8 @ _RTAPT-LPF-UTF8 !
    _RTAPT-CPF-E @ _RTAPT-LPF-E !
    1 _RTAPT-LPF-REQUESTED-REGIONS !
    _RTAPT-LPF-OWNER-ADMISSION ;

\ Stack: owner generation surface-cols surface-rows region-id region-x region-y
\        region-cols region-rows clip-x clip-y clip-cols clip-rows
...
: RTAPT-CONTROL-PREFLIGHT  ( aggregate scalars engine -- status )
    ...
    _RTAPT-CPF-CLIP-ROWS ! _RTAPT-CPF-CLIP-COLS !
    _RTAPT-CPF-CLIP-Y ! _RTAPT-CPF-CLIP-X !
...
VARIABLE _RTAPT-HAF-CLIP-X
VARIABLE _RTAPT-HAF-CLIP-Y
VARIABLE _RTAPT-HAF-CLIP-COLS
VARIABLE _RTAPT-HAF-CLIP-ROWS
VARIABLE _RTAPT-HAF-REGION-Z
VARIABLE _RTAPT-HAF-REGION-FLAGS
VARIABLE _RTAPT-HAF-BASE-PRESENT
VARIABLE _RTAPT-HAF-CONTROL-COUNT
VARIABLE _RTAPT-HAF-CONTROL-BYTES
...
VARIABLE _RTAPT-HAF-INSTRUMENT-REGION-COUNT
VARIABLE _RTAPT-HAF-INSTRUMENT-COUNT
VARIABLE _RTAPT-HAF-READOUT-COUNT
VARIABLE _RTAPT-HAF-METER-COUNT
VARIABLE _RTAPT-HAF-STATUS-COUNT
VARIABLE _RTAPT-HAF-INSTRUMENT-UNIT-BYTES
VARIABLE _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED
VARIABLE _RTAPT-HAF-INSTRUMENT-UNIT-MAX
...
VARIABLE _RTAPT-HAF-OBJECTS
VARIABLE _RTAPT-HAF-REGIONS
VARIABLE _RTAPT-HAF-UTF8
VARIABLE _RTAPT-HAF-COPY
VARIABLE _RTAPT-HAF-OPS
VARIABLE _RTAPT-HAF-TX

\ INSTRUMENT define/canonical-format scratch lives inside the same owned range
\ used by the provider's call-borrowed authority gates.  No descriptor or unit
\ source may alias this mutable state.
VARIABLE _RTAPT-ID-I
VARIABLE _RTAPT-ID-E
VARIABLE _RTAPT-ID-O
VARIABLE _RTAPT-ID-P
VARIABLE _RTAPT-ID-COPY
VARIABLE _RTAPT-ID-DIRTY-P
VARIABLE _RTAPT-ID-DIRTY-COPY
VARIABLE _RTAPT-ID-DIRTY-COPY-U
VARIABLE _RTAPT-ID-OWNER
VARIABLE _RTAPT-ID-GEN
VARIABLE _RTAPT-ID-OBJECT
VARIABLE _RTAPT-ID-KIND
VARIABLE _RTAPT-ID-VISIBLE
VARIABLE _RTAPT-ID-Z
VARIABLE _RTAPT-ID-REGION
VARIABLE _RTAPT-ID-PARENT
VARIABLE _RTAPT-ID-ROW
VARIABLE _RTAPT-ID-COL
VARIABLE _RTAPT-ID-HEIGHT
VARIABLE _RTAPT-ID-WIDTH
VARIABLE _RTAPT-ID-ROOT-H
VARIABLE _RTAPT-ID-ROOT-W
VARIABLE _RTAPT-ID-COLOR-A
VARIABLE _RTAPT-ID-COLOR-B
VARIABLE _RTAPT-ID-MODE
VARIABLE _RTAPT-ID-OPTIONS
VARIABLE _RTAPT-ID-MINIMUM
VARIABLE _RTAPT-ID-MAXIMUM
VARIABLE _RTAPT-ID-VALUE
VARIABLE _RTAPT-ID-SCALE
...
VARIABLE _RTAPT-ID-NEXT-COPY
VARIABLE _RTAPT-ID-NEXT-RET
VARIABLE _RTAPT-ID-NEXT-OBJECTS
VARIABLE _RTAPT-ID-NEXT-UTF8
VARIABLE _RTAPT-ID-QUOTA-UTF8
VARIABLE _RTAPT-ID-REGION-OP
VARIABLE _RTAPT-ID-FRAME-U
VARIABLE _RTAPT-ID-PAYLOAD-U
VARIABLE _RTAPT-ID-SCAN-P
VARIABLE _RTAPT-ID-SCAN-OFF
VARIABLE _RTAPT-ID-SCAN-NEXT
VARIABLE _RTAPT-ID-U8-I
VARIABLE _RTAPT-ID-U8-B0
VARIABLE _RTAPT-ID-U8-B1

VARIABLE _RTAPT-IRF-SCALE
VARIABLE _RTAPT-IRF-REM
VARIABLE _RTAPT-IRF-QUOT
VARIABLE _RTAPT-IRF-FORMAT
VARIABLE _RTAPT-IRF-DECIMALS
VARIABLE _RTAPT-IRF-VALUE
VARIABLE _RTAPT-IRF-UNIT-U
VARIABLE _RTAPT-IRF-PROD-LO
VARIABLE _RTAPT-IRF-PROD-HI
VARIABLE _RTAPT-IRF-EXTRA
VARIABLE _RTAPT-IRF-Q-LO
VARIABLE _RTAPT-IRF-Q-HI
VARIABLE _RTAPT-IRF-POW10
VARIABLE _RTAPT-IRF-T-LO
...
: _RTAPT-HAF-COPY-SUMMARY  ( -- )
    ...
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CLIP-X @ _RTAPT-HAF-CLIP-X !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CLIP-Y @ _RTAPT-HAF-CLIP-Y !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CLIP-COLS @ _RTAPT-HAF-CLIP-COLS !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CLIP-ROWS @ _RTAPT-HAF-CLIP-ROWS !
    ...
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CONTROL-BYTES @
        _RTAPT-HAF-CONTROL-BYTES !
    ...
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CONTROL-COLLECTIONS @
        _RTAPT-HAF-CONTROL-COLLECTIONS !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CONTROL-ITEMS @
        _RTAPT-HAF-CONTROL-ITEMS !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.CONTROL-UTF8 @
        _RTAPT-HAF-CONTROL-UTF8 !
    ...
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.INSTRUMENT-REGION-COUNT @
        _RTAPT-HAF-INSTRUMENT-REGION-COUNT !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.INSTRUMENT-COUNT @
        _RTAPT-HAF-INSTRUMENT-COUNT !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.READOUT-COUNT @
        _RTAPT-HAF-READOUT-COUNT !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.METER-COUNT @
        _RTAPT-HAF-METER-COUNT !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.STATUS-COUNT @
        _RTAPT-HAF-STATUS-COUNT !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.INSTRUMENT-UNIT-BYTES @
        _RTAPT-HAF-INSTRUMENT-UNIT-BYTES !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.INSTRUMENT-UNIT-ALIGNED @
        _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.INSTRUMENT-UNIT-MAX @
        _RTAPT-HAF-INSTRUMENT-UNIT-MAX !
    _RTAPT-HAF-SUMMARY @ _RTAPT-HA.INSTRUMENT-FORMATTED-BYTES @
        _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES !
...
: _RTAPT-HAF-HEADER?  ( -- flag )
    ...
    _RTAPT-HAF-OWNER @ 0= _RTAPT-HAF-GEN @ 0= OR IF 0 EXIT THEN
    _RTAPT-HAF-SURFACE-COLS @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-HAF-SURFACE-ROWS @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF
        0 EXIT
    THEN
    _RTAPT-HAF-REGION-ID @ 0= IF
        _RTAPT-HAF-REGION-X @ _RTAPT-HAF-REGION-Y @ OR
        _RTAPT-HAF-REGION-COLS @ OR _RTAPT-HAF-REGION-ROWS @ OR
        _RTAPT-HAF-CLIP-X @ OR _RTAPT-HAF-CLIP-Y @ OR
        _RTAPT-HAF-CLIP-COLS @ OR _RTAPT-HAF-CLIP-ROWS @ OR
        _RTAPT-HAF-REGION-Z @ OR _RTAPT-HAF-REGION-FLAGS @ OR 0= EXIT
    THEN
    -1 _RTAPT-HAF-BASE-PRESENT !
    _RTAPT-HAF-REGION-Z @ _RTAPT-I32? 0= IF 0 EXIT THEN
    _RTAPT-HAF-REGION-X @ _RTAPT-HAF-REGION-Y @
    _RTAPT-HAF-REGION-COLS @ _RTAPT-HAF-REGION-ROWS @
    _RTAPT-HAF-CLIP-X @ _RTAPT-HAF-CLIP-Y @
    _RTAPT-HAF-CLIP-COLS @ _RTAPT-HAF-CLIP-ROWS @
    _RTAPT-HAF-REGION-FLAGS @
    _RTAPT-HAF-SURFACE-COLS @ _RTAPT-HAF-SURFACE-ROWS @
        _RTAPT-REGION-GEOMETRY? ;
...
: _RTAPT-HAF-INSTRUMENT?  ( -- flag )
    _RTAPT-HAF-INSTRUMENT-COUNT @ 0= IF
        ...
        _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES @ OR
        _RTAPT-HAF-INSTRUMENT-FORMATTED-MAX @ OR
        _RTAPT-HAF-INSTRUMENT-LAST @ OR 0= EXIT
    THEN
    _RTAPT-HAF-INSTRUMENT-COUNT @ _RTAPT-U32? 0= IF 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-REGION-COUNT @ DUP 0=
        SWAP _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-REGION-COUNT @
    ...
    _RTAPT-HAF-INSTRUMENT-UNIT-MAX @ _RTAPT-U32? 0= OR
    _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES @ _RTAPT-U32? 0= OR
    _RTAPT-HAF-INSTRUMENT-FORMATTED-MAX @ _RTAPT-U32? 0= OR IF
        0 EXIT
    THEN
    _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED @ 7 AND IF 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-UNIT-BYTES @
        _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED @ U> IF 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-UNIT-MAX @
        _RTAPT-HAF-INSTRUMENT-UNIT-BYTES @ U> IF 0 EXIT THEN
    _RTAPT-HAF-READOUT-COUNT @ 7 _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED @
        _RTAPT-HAF-INSTRUMENT-UNIT-BYTES @ - SWAP U> IF 0 EXIT THEN
    _RTAPT-HAF-READOUT-COUNT @ 0= IF
        _RTAPT-HAF-INSTRUMENT-UNIT-BYTES @
        _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED @ OR
        _RTAPT-HAF-INSTRUMENT-UNIT-MAX @ OR
        _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES @ OR
        _RTAPT-HAF-INSTRUMENT-FORMATTED-MAX @ OR IF 0 EXIT THEN
    ELSE
        _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES @
            _RTAPT-HAF-READOUT-COUNT @ U< IF 0 EXIT THEN
        _RTAPT-HAF-INSTRUMENT-FORMATTED-MAX @ DUP 0= IF
            DROP 0 EXIT
        THEN
        _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES @ U> IF 0 EXIT THEN
    THEN
...
: _RTAPT-HAF-ARITHMETIC?  ( -- flag )
    ...
    _RTAPT-HAF-INSTRUMENT-COUNT @ _RTAPT-INSTRUMENT-COPY-FIXED
        _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED @
        _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    ...
    _RTAPT-HAF-CONTROL-COUNT @ _RTAPT-CONTROL-FRAME-FIXED
        _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-CONTROL-BYTES @ _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-GLYPH-COUNT @ _RTAPT-GLYPH-RUN-DEFINE-FRAME-FIXED
        _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-GLYPH-TEXT @ _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-READOUT-COUNT @ _RTAPT-READOUT-FRAME-FIXED
        _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-INSTRUMENT-UNIT-BYTES @
        _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-METER-COUNT @ _RTAPT-METER-FRAME-BYTES
        _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-HAF-STATUS-COUNT @ _RTAPT-STATUS-FRAME-BYTES
        _RTAPT-UMUL? 0= IF DROP 0 EXIT THEN
    _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
...
: _RTAPT-HAF-EXISTING-ADMISSION  ( owner-record -- status )
    DUP _RTAPT-O.STATE @ RTAPT-OWNER-ST-OPEN <> IF
        DROP RTAPT-S-BUSY EXIT
    THEN
    DUP _RTAPT-O.REGIONS @ _RTAPT-HAF-REGIONS @ U< IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN
    DUP _RTAPT-O.OBJECTS @ _RTAPT-HAF-OBJECTS @ U< IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN
...
: _RTAPT-HYBRID-PREFLIGHT-BODY  ( -- status )
    ...
    THEN
    _RTAPT-HAF-CONTROL-COLLECTIONS @ IF
        _RTAPT-HAF-LIMITS @ _RTAPT-L.FEATURES @
            RTAPT-F-CONTROL-COLLECTIONS AND 0= IF
            RTAPT-S-UNSUPPORTED EXIT
        THEN
    ...
    _RTAPT-HAF-GLYPH-COUNT @ IF
        ...
        THEN
    THEN
    _RTAPT-HAF-INSTRUMENT-COUNT @ IF
        _RTAPT-HAF-LIMITS @ _RTAPT-L.FEATURES @
    ...
    _RTAPT-HAF-GLYPH-COUNT @ IF
        ...
        THEN
    THEN
    _RTAPT-HAF-READOUT-COUNT @ IF
        _RTAPT-HAF-INSTRUMENT-UNIT-MAX @ 104 _RTAPT-UADD? 0= IF
            DROP RTAPT-S-CAPACITY EXIT
        THEN
        _RTAPT-HAF-LIMITS @ _RTAPT-L.OUTBOUND-PAYLOAD @ U> IF
            RTAPT-S-CAPACITY EXIT
        ...
        THEN
    THEN
    _RTAPT-HAF-METER-COUNT @ IF
        _RTAPT-HAF-LIMITS @ _RTAPT-L.OUTBOUND-PAYLOAD @ 112 U< IF
            RTAPT-S-CAPACITY EXIT
        THEN
    THEN
    _RTAPT-HAF-STATUS-COUNT @ IF
        _RTAPT-HAF-LIMITS @ _RTAPT-L.OUTBOUND-PAYLOAD @ 96 U< IF
            RTAPT-S-CAPACITY EXIT
        THEN
    THEN
    ...
    _RTAPT-HAF-COPY @ _RTAPT-HAF-E @ _RTAPT-E.COPY-U @ U> IF
        RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-HAF-CONTROL-COUNT @ _RTAPT-HAF-E @
        _RTAPT-CONTROL-LEDGER-TARGET-CAPACITY? 0= IF
        RTAPT-S-CAPACITY EXIT
    THEN
    ...
    _RTAPT-HAF-OBJECTS @ _RTAPT-LPF-COUNT !
...
: _RTAPT-HAF-SCRUB  ( status -- status )
    ...
    0 _RTAPT-HAF-REGION-ROWS !
    0 _RTAPT-HAF-CLIP-X ! 0 _RTAPT-HAF-CLIP-Y !
    0 _RTAPT-HAF-CLIP-COLS ! 0 _RTAPT-HAF-CLIP-ROWS !
    0 _RTAPT-HAF-REGION-Z ! 0 _RTAPT-HAF-REGION-FLAGS !
    0 _RTAPT-HAF-BASE-PRESENT !
    0 _RTAPT-HAF-CONTROL-COUNT ! 0 _RTAPT-HAF-CONTROL-BYTES !
    0 _RTAPT-HAF-CONTROL-ALIGNED ! 0 _RTAPT-HAF-CONTROL-MAX !
    0 _RTAPT-HAF-CONTROL-LAST !
    0 _RTAPT-HAF-CONTROL-COLLECTIONS !
    ...
    0 _RTAPT-HAF-INSTRUMENT-REGION-COUNT !
    0 _RTAPT-HAF-INSTRUMENT-COUNT !
    0 _RTAPT-HAF-READOUT-COUNT ! 0 _RTAPT-HAF-METER-COUNT !
    0 _RTAPT-HAF-STATUS-COUNT !
    0 _RTAPT-HAF-INSTRUMENT-UNIT-BYTES !
    0 _RTAPT-HAF-INSTRUMENT-UNIT-ALIGNED !
    0 _RTAPT-HAF-INSTRUMENT-UNIT-MAX !
    0 _RTAPT-HAF-INSTRUMENT-FORMATTED-BYTES !
    0 _RTAPT-HAF-INSTRUMENT-FORMATTED-MAX !
    0 _RTAPT-HAF-INSTRUMENT-LAST !
    0 _RTAPT-HAF-FAMILY-COUNT ! 0 _RTAPT-HAF-FAMILY-TEXT !
    0 _RTAPT-HAF-FAMILY-ALIGNED ! 0 _RTAPT-HAF-FAMILY-MAX !
    0 _RTAPT-HAF-FAMILY-LAST ! 0 _RTAPT-HAF-OBJECTS !
    0 _RTAPT-HAF-REGIONS !
...
VARIABLE _RTAPT-RD-CLIP-X
VARIABLE _RTAPT-RD-CLIP-Y
VARIABLE _RTAPT-RD-CLIP-COLS
VARIABLE _RTAPT-RD-CLIP-ROWS
...
: RTAPT-REGION-DEFINE  ( owner generation region x y cols rows clip-x clip-y clip-cols clip-rows z flags engine -- status )
    _RTAPT-RD-E ! _RTAPT-RD-FLAGS ! _RTAPT-RD-Z !
    _RTAPT-RD-CLIP-ROWS ! _RTAPT-RD-CLIP-COLS !
    _RTAPT-RD-CLIP-Y ! _RTAPT-RD-CLIP-X ! _RTAPT-RD-ROWS !
    ...
    _RTAPT-RD-X @ _RTAPT-RD-Y @ _RTAPT-RD-COLS @ _RTAPT-RD-ROWS @
    _RTAPT-RD-CLIP-X @ _RTAPT-RD-CLIP-Y @
    _RTAPT-RD-CLIP-COLS @ _RTAPT-RD-CLIP-ROWS @ _RTAPT-RD-FLAGS @
        _RTAPT-REGION-INTRINSIC? 0= IF RTAPT-S-INVALID EXIT THEN
    ...
    _RTAPT-RD-CLIP-X @ _RTAPT-RD-COPY @ _RTAPT-RD.CLIP-X !
    _RTAPT-RD-CLIP-Y @ _RTAPT-RD-COPY @ _RTAPT-RD.CLIP-Y !
    _RTAPT-RD-CLIP-COLS @ _RTAPT-RD-COPY @ _RTAPT-RD.CLIP-COLS !
    _RTAPT-RD-CLIP-ROWS @ _RTAPT-RD-COPY @ _RTAPT-RD.CLIP-ROWS !
...
: _RTAPT-GLYPH-RUN-GEOMETRY?  ( -- flag )
    ...
    _RTAPT-LD-HEIGHT @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-LD-WIDTH @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-LD-ROOT-H @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-LD-ROOT-W @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-LD-ROW @ _RTAPT-LD-HEIGHT @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-LD-ROW-END !
    _RTAPT-LD-COL @ _RTAPT-LD-WIDTH @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-LD-COL-END !
    _RTAPT-LD-VISIBLE @ IF
        _RTAPT-LD-ROW @ _RTAPT-LD-ROOT-H @ < 0=
...
VARIABLE _RTAPT-SOB-O
VARIABLE _RTAPT-SOB-E
VARIABLE _RTAPT-SOB-ACTIVE
VARIABLE _RTAPT-SOB-HIDDEN

: _RTAPT-SHARED-OBJECT-BASE?  ( owner-record engine -- count flag )
    _RTAPT-SOB-E ! _RTAPT-SOB-O !
    _RTAPT-SOB-O @ _RTAPT-O.ACTIVE-OBJECTS @
    _RTAPT-SOB-O @ _RTAPT-O.ACTIVE-CONTROLS @ _RTAPT-UADD? 0= IF
        DROP 0 0 EXIT
    THEN
    _RTAPT-SOB-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA =
    _RTAPT-SOB-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ 0<> AND IF
        _RTAPT-SOB-O @ _RTAPT-O.PENDING-CONTENT-TARGET @
    ELSE
        _RTAPT-SOB-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @
    THEN _RTAPT-UADD? 0= IF DROP 0 0 EXIT THEN _RTAPT-SOB-ACTIVE !
    _RTAPT-SOB-O @ _RTAPT-O.HIDDEN-OBJECTS @
    _RTAPT-SOB-O @ _RTAPT-O.HIDDEN-CONTROLS @ _RTAPT-UADD? 0= IF
        DROP 0 0 EXIT
    THEN
    _RTAPT-SOB-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS @ _RTAPT-UADD? 0= IF
        DROP 0 0 EXIT
    THEN _RTAPT-SOB-HIDDEN !
    _RTAPT-SOB-ACTIVE @ _RTAPT-SOB-HIDDEN @ _RTAPT-SOB-E @
        _RTAPT-TARGET-BASE -1 ;

: _RTAPT-UTF8-BASE  ( owner-record engine -- bytes )
    _RTAPT-SOB-E ! _RTAPT-SOB-O !
    _RTAPT-SOB-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA =
    _RTAPT-SOB-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ 0<> AND IF
        _RTAPT-SOB-O @ _RTAPT-O.PENDING-UTF8-TARGET @
    ELSE
        _RTAPT-SOB-O @ _RTAPT-O.ACTIVE-UTF8 @
    THEN
    _RTAPT-SOB-O @ _RTAPT-O.HIDDEN-UTF8 @ _RTAPT-SOB-E @
        _RTAPT-TARGET-BASE ;
...
\ Like replacement and CONTROL DELTA admission, this aggregate proof does
\ not invent an exact sparse region ledger.  The retained model validates
\ the named region in the acknowledged owner at atomic commit.
: _RTAPT-GLYPH-RUN-ACTIVE-REGION?  ( region owner-record -- flag )
    DUP _RTAPT-O.ACTIVE-REGIONS @ 0= IF 2DROP 0 EXIT THEN
    _RTAPT-O.REGION-HIGH @ U> 0= ;

: _RTAPT-GLYPH-RUN-DEFINE-REGION?  ( -- flag )
    _RTAPT-GLYPH-RUN-REGION-OP DUP _RTAPT-LD-REGION-OP ! IF
        -1 EXIT
    THEN
    _RTAPT-LD-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA <> IF 0 EXIT THEN
    _RTAPT-LD-REGION @ _RTAPT-LD-O @ _RTAPT-GLYPH-RUN-ACTIVE-REGION? ;
...
: _RTAPT-GLYPH-RUN-DEFINE-BODY  ( -- status )
    ...
    DUP _RTAPT-LD-O ! _RTAPT-O.STATE @ RTAPT-OWNER-ST-OPEN <>
        IF RTAPT-S-BUSY EXIT THEN
    _RTAPT-GLYPH-RUN-DEFINE-REGION? 0= IF RTAPT-S-INVALID EXIT THEN
    ...
    _RTAPT-LD-O @ _RTAPT-O.PENDING-CONTROLS @ _RTAPT-UADD? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-LD-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @
        _RTAPT-UADD? 0= IF DROP RTAPT-S-CAPACITY EXIT THEN
    1 _RTAPT-UADD? 0= IF DROP RTAPT-S-CAPACITY EXIT THEN
...
VARIABLE _RTAPT-CD-NEXT-CONTENT-ITEMS
VARIABLE _RTAPT-CD-NEXT-UTF8
VARIABLE _RTAPT-CD-LEDGER
VARIABLE _RTAPT-CD-NEXT-REPLACEMENTS
VARIABLE _RTAPT-CD-NEXT-CONTENT-TARGET
VARIABLE _RTAPT-CD-NEXT-UTF8-TARGET
VARIABLE _RTAPT-CD-BASE-CONTENT
VARIABLE _RTAPT-CD-BASE-UTF8
...
: _RTAPT-CONTROL-TEXT-SPANS?  ( -- flag )
    ...
    _RTAPT-CD-CONTENT-A @ _RTAPT-CD-CONTENT-U @
        _RTAPT-CONTROL-ONE-TEXT-SPAN? 0= IF 0 EXIT THEN
    _RTAPT-CD-LABEL-U @ _RTAPT-CD-SHORTCUT-U @ AND IF
        _RTAPT-CD-LABEL-A @ _RTAPT-CD-LABEL-U @
        _RTAPT-CD-SHORTCUT-A @ _RTAPT-CD-SHORTCUT-U @
            MSPAN-OVERLAP? IF 0 EXIT THEN
    THEN
    _RTAPT-CD-LABEL-U @ _RTAPT-CD-CONTENT-U @ AND IF
        _RTAPT-CD-LABEL-A @ _RTAPT-CD-LABEL-U @
        _RTAPT-CD-CONTENT-A @ _RTAPT-CD-CONTENT-U @
            MSPAN-OVERLAP? IF 0 EXIT THEN
    THEN
    _RTAPT-CD-SHORTCUT-U @ _RTAPT-CD-CONTENT-U @ AND IF
        _RTAPT-CD-SHORTCUT-A @ _RTAPT-CD-SHORTCUT-U @
        _RTAPT-CD-CONTENT-A @ _RTAPT-CD-CONTENT-U @
            MSPAN-OVERLAP? IF 0 EXIT THEN
    THEN
...
: _RTAPT-CONTROL-TEXT-COLLECTION-KIND?  ( kind -- flag )
    DUP RTAPT-CONTROL-TEXT-AREA =
    SWAP RTAPT-CONTROL-TEXT-GRID = OR ;

: _RTAPT-CONTROL-COLLECTION-KIND?  ( kind -- flag )
    DUP _RTAPT-CONTROL-TEXT-COLLECTION-KIND? IF DROP -1 EXIT THEN
    DUP RTAPT-CONTROL-TABSET =
    SWAP RTAPT-CONTROL-TAB = OR ;
...
: _RTAPT-CONTROL-KIND?  ( kind -- flag )
    ...
    DUP RTAPT-CONTROL-SEPARATOR = IF DROP -1 EXIT THEN
    _RTAPT-CONTROL-COLLECTION-KIND? ;
...
: _RTAPT-CONTROL-CONTENT-HEADER?  ( -- flag )
    ...
    _RTAPT-CD-CONTENT-A @ _RTAPT-CD-CONTENT-U @
    _RTAPT-CD-CONTENT-ITEMS @ _RTAPT-STX1-HEADER? ;

: _RTAPT-CONTROL-ROOT-GEOMETRY?  ( -- flag )
    _RTAPT-CD-ROW @ _RTAPT-I32? 0=
    _RTAPT-CD-COL @ _RTAPT-I32? 0= OR IF 0 EXIT THEN
    ...
    _RTAPT-CD-ROW @ _RTAPT-CD-HEIGHT @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-CD-ROW-END !
    _RTAPT-CD-COL @ _RTAPT-CD-WIDTH @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-CD-COL-END !
    _RTAPT-CD-STATE @ RTAPT-CONTROL-F-VISIBLE AND IF
        _RTAPT-CD-ROW @ _RTAPT-CD-ROOT-H @ < 0=
        _RTAPT-CD-ROW-END @ 0> 0= OR
        _RTAPT-CD-COL @ _RTAPT-CD-ROOT-W @ < 0= OR
        _RTAPT-CD-COL-END @ 0> 0= OR IF 0 EXIT THEN
    THEN
    -1 ;
...
: _RTAPT-CONTROL-SHAPE?  ( -- flag )
    ...
    THEN
    _RTAPT-CD-KIND @ RTAPT-CONTROL-TAB = IF
        _RTAPT-CD-LABEL-U @ 0= IF 0 EXIT THEN
        _RTAPT-CD-STATE @ 0x0B INVERT AND 0= EXIT
    THEN
...
: _RTAPT-CONTROL-LIMITS  ( -- status )
    ...
    DUP _RTAPT-L.FEATURES @ RTAPT-F-CONTROLS AND 0= IF
        DROP RTAPT-S-UNSUPPORTED EXIT
    THEN
    _RTAPT-CD-KIND @ _RTAPT-CONTROL-COLLECTION-KIND? IF
        DUP _RTAPT-L.FEATURES @ RTAPT-F-CONTROL-COLLECTIONS AND 0= IF
            DROP RTAPT-S-UNSUPPORTED EXIT
        THEN
    THEN
...
: _RTAPT-CONTROL-PARENT-PRIOR?  ( -- flag )
    _RTAPT-CD-PARENT @ 0= IF
        _RTAPT-CD-KIND @ _RTAPT-CONTROL-ROOT-KIND? EXIT
    THEN
    _RTAPT-CD-KIND @ _RTAPT-CONTROL-ROOT-KIND? IF 0 EXIT THEN
...
: _RTAPT-CONTROL-SHARED-QUOTA?  ( addition -- flag )
    >R
    _RTAPT-CD-O @ _RTAPT-CD-E @ _RTAPT-SHARED-OBJECT-BASE? 0= IF
        DROP R> DROP 0 EXIT
    THEN
    ...
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTROLS @ _RTAPT-UADD? 0= IF
        DROP R> DROP 0 EXIT
    THEN
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @
        _RTAPT-UADD? 0= IF DROP R> DROP 0 EXIT THEN
    R> _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-CD-O @ _RTAPT-O.OBJECTS @ U> 0= ;

: _RTAPT-CONTROL-UTF8-QUOTA?  ( include-new-text? -- flag )
    >R
    _RTAPT-CD-O @ _RTAPT-CD-E @ _RTAPT-UTF8-BASE
    _RTAPT-CD-O @ _RTAPT-O.PENDING-UTF8 @ _RTAPT-UADD? 0= IF
        DROP R> DROP 0 EXIT
    THEN
    R> IF
        _RTAPT-CD-QUOTA-UTF8 @ _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    THEN
...
: _RTAPT-CONTROL-CAPTURE  ( op-kind -- status )
    ...
    _RTAPT-CD-CONTENT-U @ _RTAPT-CD-COPY @ _RTAPT-CD.CONTENT-U !
    _RTAPT-CD-CONTENT-ITEMS @
    ...
    THEN
    _RTAPT-CD-CONTENT-U @ IF
        _RTAPT-CD-CONTENT-A @
        _RTAPT-CD-COPY @ _RTAPT-CD.TEXT _RTAPT-CD-LABEL-U @ +
            _RTAPT-CD-SHORTCUT-U @ +
        _RTAPT-CD-CONTENT-U @ MOVE
    THEN
    _RTAPT-CD-COPY @ _RTAPT-CONTROL-COPY-CONTENT-HEADER? 0= IF
...
: _RTAPT-CONTROL-COMMON?  ( -- status|0 )
    ...
    _RTAPT-CD-LABEL-U @ _RTAPT-CD-SHORTCUT-U @
        _RTAPT-UADD? 0= IF DROP RTAPT-S-CAPACITY EXIT THEN
    _RTAPT-CD-CONTENT-U @ _RTAPT-UADD? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN
        _RTAPT-CD-TEXT-U !
    _RTAPT-CD-LABEL-U @ _RTAPT-CD-SHORTCUT-U @
        _RTAPT-UADD? 0= IF DROP RTAPT-S-CAPACITY EXIT THEN
    _RTAPT-CD-CONTENT-UTF8 @ _RTAPT-UADD? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN _RTAPT-CD-QUOTA-UTF8 !
    _RTAPT-CD-QUOTA-UTF8 @ _RTAPT-U32? 0= IF
        RTAPT-S-CAPACITY EXIT
    THEN
...
VARIABLE _RTAPT-CLC-PENDING

: _RTAPT-CONTROL-LEDGER-DEFINE-CAPACITY?  ( -- flag )
    0 _RTAPT-CLC-PENDING !
    _RTAPT-CD-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        I _RTAPT-CD-E @ _RTAPT-OWNER-NTH _RTAPT-O.PENDING-CONTROLS @
        _RTAPT-CLC-PENDING @ SWAP _RTAPT-UADD?
            0= IF DROP 0 UNLOOP EXIT THEN _RTAPT-CLC-PENDING !
    LOOP
    _RTAPT-CLC-PENDING @ 1 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-CD-E @ _RTAPT-CONTROL-LEDGER-TARGET-CAPACITY? ;

VARIABLE _RTAPT-CRP-E
VARIABLE _RTAPT-CRP-O-SLOT
VARIABLE _RTAPT-CRP-CONTROL
VARIABLE _RTAPT-CRP-P
VARIABLE _RTAPT-CRP-OFF

: _RTAPT-CONTROL-REPLACE-PRIOR?  ( -- flag )
    _RTAPT-CD-E @ _RTAPT-CRP-E !
    _RTAPT-CD-O @ _RTAPT-CD-E @ _RTAPT-OWNER-SLOT _RTAPT-CRP-O-SLOT !
    _RTAPT-CD-ID @ _RTAPT-CRP-CONTROL !
    _RTAPT-CRP-E @ _RTAPT-E.OP-COUNT @ 0 ?DO
        I _RTAPT-CRP-E @ _RTAPT-OP-NTH DUP _RTAPT-CRP-P !
        DUP _RTAPT-P.KIND @ _RTAPT-OP-CONTROL-REPLACE =
        SWAP _RTAPT-P.OWNER-SLOT @ _RTAPT-CRP-O-SLOT @ = AND IF
            _RTAPT-CRP-P @ _RTAPT-P.COPY-U @
                _RTAPT-CONTROL-COPY-FIXED U< IF 0 UNLOOP EXIT THEN
            _RTAPT-CRP-P @ _RTAPT-P.COPY-OFF @ DUP _RTAPT-CRP-OFF !
                7 AND IF 0 UNLOOP EXIT THEN
            _RTAPT-CRP-OFF @ _RTAPT-CONTROL-COPY-FIXED _RTAPT-UADD?
                0= IF DROP 0 UNLOOP EXIT THEN
            _RTAPT-CRP-E @ _RTAPT-E.COPY-USED @ U> IF 0 UNLOOP EXIT THEN
            _RTAPT-CRP-E @ _RTAPT-E.COPY-A @ _RTAPT-CRP-OFF @ +
                _RTAPT-CD.CONTROL @ _RTAPT-CRP-CONTROL @ = IF
                -1 UNLOOP EXIT
            THEN
        THEN
    LOOP 0 ;

: _RTAPT-CONTROL-REPLACE-TARGETS?  ( -- flag )
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ DUP IF
        DROP
        _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTENT-TARGET @
            _RTAPT-CD-BASE-CONTENT !
        _RTAPT-CD-O @ _RTAPT-O.PENDING-UTF8-TARGET @
            _RTAPT-CD-BASE-UTF8 !
    ELSE
        DROP
        _RTAPT-CD-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @
            _RTAPT-CD-BASE-CONTENT !
        _RTAPT-CD-O @ _RTAPT-O.ACTIVE-UTF8 @
            _RTAPT-CD-BASE-UTF8 !
    THEN
    _RTAPT-CD-LEDGER @ _RTAPT-CL.ACTIVE-UTF8 @
        _RTAPT-CD-BASE-UTF8 @ U> IF 0 EXIT THEN
    _RTAPT-CD-BASE-UTF8 @
    _RTAPT-CD-LEDGER @ _RTAPT-CL.ACTIVE-UTF8 @ -
    _RTAPT-CD-QUOTA-UTF8 @ _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
        _RTAPT-CD-NEXT-UTF8-TARGET !
    _RTAPT-CD-LEDGER @ _RTAPT-CL.ACTIVE-ITEMS @
        _RTAPT-CD-BASE-CONTENT @ U> IF 0 EXIT THEN
    _RTAPT-CD-BASE-CONTENT @
    _RTAPT-CD-LEDGER @ _RTAPT-CL.ACTIVE-ITEMS @ -
    _RTAPT-CD-CONTENT-ITEMS @ _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
        _RTAPT-CD-NEXT-CONTENT-TARGET !
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @
        1 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
        DUP _RTAPT-CD-O @ _RTAPT-O.ACTIVE-CONTROLS @ U> IF DROP 0 EXIT THEN
        _RTAPT-CD-NEXT-REPLACEMENTS !
    -1 ;

: _RTAPT-CONTROL-REPLACE-QUOTA?  ( -- flag )
    _RTAPT-CD-O @ _RTAPT-O.ACTIVE-OBJECTS @
    _RTAPT-CD-O @ _RTAPT-O.ACTIVE-CONTROLS @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CD-O @ _RTAPT-O.PENDING-OBJECTS @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTROLS @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CD-NEXT-CONTENT-TARGET @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CD-O @ _RTAPT-O.OBJECTS @ U> IF 0 EXIT THEN
    _RTAPT-CD-NEXT-UTF8-TARGET @
    _RTAPT-CD-O @ _RTAPT-O.PENDING-UTF8 @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CD-O @ _RTAPT-O.UTF8-BYTES @ U> 0= ;
...
: _RTAPT-CONTROL-DEFINE-BODY  ( -- status )
    ...
    _RTAPT-CONTROL-LEDGER-DEFINE-CAPACITY? 0= IF
        RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-CD-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA <>
        _RTAPT-CONTROL-REGION? 0= IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-CD-ID @ _RTAPT-CD-O @ _RTAPT-O.CONTROL-HIGH @ U> 0=
        IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-CD-ID @ _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTROL-HIGH @ U> 0=
        IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-CD-CONTENT-ITEMS @ 1 _RTAPT-UADD? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN DUP _RTAPT-CONTROL-SHARED-QUOTA? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN DROP
    ...
    _RTAPT-CD-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @
    _RTAPT-CD-CONTENT-ITEMS @ _RTAPT-UADD? 0= IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN _RTAPT-CD-NEXT-CONTENT-ITEMS !
    _RTAPT-CD-O @ _RTAPT-O.PENDING-UTF8 @ _RTAPT-CD-QUOTA-UTF8 @
        _RTAPT-UADD? 0= IF DROP RTAPT-S-CAPACITY EXIT THEN
        _RTAPT-CD-NEXT-UTF8 !
...
: _RTAPT-CONTROL-REPLACE-BODY  ( -- status )
    ...
    _RTAPT-CD-O @ _RTAPT-CD-GEN @ _RTAPT-CD-ID @ _RTAPT-CD-E @
        _RTAPT-CONTROL-LEDGER-FIND DUP 0= IF
        DROP RTAPT-S-INVALID EXIT
    THEN DUP _RTAPT-CD-LEDGER ! _RTAPT-CL.META @
        DUP _RTAPT-CL-ACTIVE AND 0= IF DROP RTAPT-S-INVALID EXIT THEN
        _RTAPT-CL-KIND-MASK AND _RTAPT-CD-KIND @ <> IF
        RTAPT-S-INVALID EXIT
    THEN
    _RTAPT-CONTROL-REPLACE-PRIOR? IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-CD-KIND @ _RTAPT-MUTABLE-CONTROL-KIND? 0= IF
        _RTAPT-CD-LEDGER @ _RTAPT-CL.ACTIVE-ITEMS @
            _RTAPT-CD-CONTENT-ITEMS @ <>
        _RTAPT-CD-LEDGER @ _RTAPT-CL.ACTIVE-UTF8 @
            _RTAPT-CD-QUOTA-UTF8 @ <> OR IF
            \ Menu and TABSET replacements remain state-only.  PT is the
            \ exact retained tuple authority; this local equality prevents a
            \ caller from fabricating quota recovery before that verdict.
            RTAPT-S-UNSUPPORTED EXIT
        THEN
    THEN
    _RTAPT-CONTROL-REPLACE-TARGETS? 0= IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-CONTROL-REPLACE-QUOTA? 0= IF RTAPT-S-CAPACITY EXIT THEN
...
: _RTAPT-CONTROL-SCRUB  ( -- )
    ...
    0 _RTAPT-CD-NEXT-CONTENT-ITEMS !
    0 _RTAPT-CD-NEXT-UTF8 ! 0 _RTAPT-CD-LEDGER !
    0 _RTAPT-CD-NEXT-REPLACEMENTS !
    0 _RTAPT-CD-NEXT-CONTENT-TARGET !
    0 _RTAPT-CD-NEXT-UTF8-TARGET !
    0 _RTAPT-CD-BASE-CONTENT ! 0 _RTAPT-CD-BASE-UTF8 !
    0 _RTAPT-CD-DIRTY-P !
...
\ CONTROL_REPLACE is deliberately DELTA-only in this rung; replacement/layout
\ construction accepts CONTROL_DEFINE records only.  Per-control DROP remains
\ unsupported until it can update the same exact identity and quota ledger
\ atomically.  Owner DROP already removes that owner's complete ledger.
...
: _RTAPT-CONTROL-DROP-SCRUB  ( -- )
    0 _RTAPT-CX-E ! 0 _RTAPT-CX-OWNER ! 0 _RTAPT-CX-GEN !
    0 _RTAPT-CX-ID ! ;
...
\ =====================================================================
\  Neutral semantic INSTRUMENT capture
\ =====================================================================

\ This gate is stack-only: it runs before writing provider scratch, so a
\ hostile descriptor cannot alias the very variables used to inspect it.
: _RTAPT-INSTRUMENT-AUTHORITY?  ( instrument engine -- flag )
    OVER RTAPT-INSTRUMENT-SIZE _RTAPT-SPAN? 0= IF 2DROP 0 EXIT THEN
    OVER RTAPT-INSTRUMENT-SIZE _RTAPT-HAF-OWNED-DISJOINT? 0= IF
        2DROP 0 EXIT
    THEN
    _RTAPT-HAF-OWNED-START
        _RTAPT-HAF-OWNED-END _RTAPT-HAF-OWNED-START -
        2 PICK RTAPT-STORAGE-DISJOINT? 0= IF 2DROP 0 EXIT THEN
    OVER RTAPT-INSTRUMENT-SIZE 2 PICK
        RTAPT-STORAGE-DISJOINT? 0= IF 2DROP 0 EXIT THEN
    2DROP -1 ;

: _RTAPT-INSTRUMENT-LOAD  ( -- )
    _RTAPT-ID-I @ DUP _RTAPT-INSTRUMENT.OWNER @ _RTAPT-ID-OWNER !
    DUP _RTAPT-INSTRUMENT.GENERATION @ _RTAPT-ID-GEN !
    DUP _RTAPT-INSTRUMENT.ID @ _RTAPT-ID-OBJECT !
    DUP _RTAPT-INSTRUMENT.KIND @ _RTAPT-ID-KIND !
    DUP _RTAPT-INSTRUMENT.VISIBLE @ _RTAPT-ID-VISIBLE !
    DUP _RTAPT-INSTRUMENT.Z @ _RTAPT-ID-Z !
    DUP _RTAPT-INSTRUMENT.REGION @ _RTAPT-ID-REGION !
    DUP _RTAPT-INSTRUMENT.PARENT @ _RTAPT-ID-PARENT !
    DUP _RTAPT-INSTRUMENT.ROW @ _RTAPT-ID-ROW !
    DUP _RTAPT-INSTRUMENT.COL @ _RTAPT-ID-COL !
    DUP _RTAPT-INSTRUMENT.HEIGHT @ _RTAPT-ID-HEIGHT !
    DUP _RTAPT-INSTRUMENT.WIDTH @ _RTAPT-ID-WIDTH !
    DUP _RTAPT-INSTRUMENT.ROOT-HEIGHT @ _RTAPT-ID-ROOT-H !
    DUP _RTAPT-INSTRUMENT.ROOT-WIDTH @ _RTAPT-ID-ROOT-W !
    DUP _RTAPT-INSTRUMENT.COLOR-A @ _RTAPT-ID-COLOR-A !
    DUP _RTAPT-INSTRUMENT.COLOR-B @ _RTAPT-ID-COLOR-B !
    DUP _RTAPT-INSTRUMENT.MODE @ _RTAPT-ID-MODE !
    DUP _RTAPT-INSTRUMENT.OPTIONS @ _RTAPT-ID-OPTIONS !
    DUP _RTAPT-INSTRUMENT.MINIMUM @ _RTAPT-ID-MINIMUM !
    DUP _RTAPT-INSTRUMENT.MAXIMUM @ _RTAPT-ID-MAXIMUM !
    DUP _RTAPT-INSTRUMENT.VALUE @ _RTAPT-ID-VALUE !
    DUP _RTAPT-INSTRUMENT.SCALE @ _RTAPT-ID-SCALE !
...
: _RTAPT-INSTRUMENT-UNIT-AUTHORITY?  ( -- flag )
    _RTAPT-ID-UNIT-U @ _RTAPT-U32? 0= IF 0 EXIT THEN
    _RTAPT-ID-UNIT-U @ 0= IF _RTAPT-ID-UNIT-A @ 0= EXIT THEN
    _RTAPT-ID-UNIT-A @ _RTAPT-ID-UNIT-U @ MSPAN-NONWRAPPING? 0= IF
        0 EXIT
    THEN
    _RTAPT-ID-UNIT-A @ _RTAPT-ID-UNIT-U @
        _RTAPT-HAF-OWNED-DISJOINT? 0= IF 0 EXIT THEN
    _RTAPT-ID-UNIT-A @ _RTAPT-ID-UNIT-U @ _RTAPT-ID-E @
        _RTAPT-BYTE-SPAN-DISJOINT? 0= IF 0 EXIT THEN
    _RTAPT-ID-UNIT-A @ _RTAPT-ID-UNIT-U @
        _RTAPT-ID-I @ RTAPT-INSTRUMENT-SIZE MSPAN-OVERLAP? 0= ;

: _RTAPT-INSTRUMENT-U8-CONT?  ( relative-index -- flag )
    _RTAPT-ID-U8-I @ + DUP _RTAPT-ID-UNIT-U @ U< 0= IF DROP 0 EXIT THEN
    _RTAPT-ID-UNIT-A @ + C@ 0xC0 AND 0x80 = ;

\ UNIT is scalar presentation text: valid UTF-8 with all C0 controls and DEL
\ excluded.  This scanner uses only scratch already covered by the authority
\ gate, so validating a caller span cannot overwrite itself.
: _RTAPT-INSTRUMENT-UNIT-TEXT?  ( -- flag )
    0 _RTAPT-ID-U8-I !
    BEGIN _RTAPT-ID-U8-I @ _RTAPT-ID-UNIT-U @ U< WHILE
        _RTAPT-ID-UNIT-A @ _RTAPT-ID-U8-I @ + C@ DUP _RTAPT-ID-U8-B0 !
        DUP 32 U< SWAP 127 = OR IF 0 EXIT THEN
        _RTAPT-ID-U8-B0 @ 0x80 U< IF
            1 _RTAPT-ID-U8-I +!
        ELSE
            _RTAPT-ID-U8-B0 @ 0xC2 >=
            _RTAPT-ID-U8-B0 @ 0xDF <= AND IF
                1 _RTAPT-INSTRUMENT-U8-CONT? 0= IF 0 EXIT THEN
                2 _RTAPT-ID-U8-I +!
            ELSE
                _RTAPT-ID-U8-B0 @ 0xE0 >=
                _RTAPT-ID-U8-B0 @ 0xEF <= AND IF
                    _RTAPT-ID-UNIT-U @ _RTAPT-ID-U8-I @ - 3 U< IF
                        0 EXIT
                    THEN
                    _RTAPT-ID-UNIT-A @ _RTAPT-ID-U8-I @ + 1+ C@
                        _RTAPT-ID-U8-B1 !
                    _RTAPT-ID-U8-B0 @ 0xE0 = IF
                        _RTAPT-ID-U8-B1 @ 0xA0 >=
                        _RTAPT-ID-U8-B1 @ 0xBF <= AND
                    ELSE
                        _RTAPT-ID-U8-B0 @ 0xED = IF
                            _RTAPT-ID-U8-B1 @ 0x80 >=
                            _RTAPT-ID-U8-B1 @ 0x9F <= AND
                        ELSE
                            _RTAPT-ID-U8-B1 @ 0xC0 AND 0x80 =
                        THEN
                    THEN
                    2 _RTAPT-INSTRUMENT-U8-CONT? AND 0= IF 0 EXIT THEN
                    3 _RTAPT-ID-U8-I +!
                ELSE
                    _RTAPT-ID-U8-B0 @ 0xF0 >=
                    _RTAPT-ID-U8-B0 @ 0xF4 <= AND IF
                        _RTAPT-ID-UNIT-U @ _RTAPT-ID-U8-I @ - 4 U< IF
                            0 EXIT
                        THEN
                        _RTAPT-ID-UNIT-A @ _RTAPT-ID-U8-I @ + 1+ C@
                            _RTAPT-ID-U8-B1 !
                        _RTAPT-ID-U8-B0 @ 0xF0 = IF
                            _RTAPT-ID-U8-B1 @ 0x90 >=
                            _RTAPT-ID-U8-B1 @ 0xBF <= AND
                        ELSE
                            _RTAPT-ID-U8-B0 @ 0xF4 = IF
                                _RTAPT-ID-U8-B1 @ 0x80 >=
                                _RTAPT-ID-U8-B1 @ 0x8F <= AND
                            ELSE
                                _RTAPT-ID-U8-B1 @ 0xC0 AND 0x80 =
                            THEN
                        THEN
                        2 _RTAPT-INSTRUMENT-U8-CONT? AND
                        3 _RTAPT-INSTRUMENT-U8-CONT? AND 0= IF 0 EXIT THEN
                        4 _RTAPT-ID-U8-I +!
                    ELSE
                        0 EXIT
                    THEN
...
: _RTAPT-INSTRUMENT-GEOMETRY?  ( -- flag )
    _RTAPT-ID-ROW @ _RTAPT-I32? 0=
    _RTAPT-ID-COL @ _RTAPT-I32? 0= OR IF 0 EXIT THEN
    _RTAPT-ID-HEIGHT @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-ID-WIDTH @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-ID-ROOT-H @ DUP 0= SWAP _RTAPT-U32? 0= OR
    _RTAPT-ID-ROOT-W @ DUP 0= SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-ID-ROW @ _RTAPT-ID-HEIGHT @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN DROP
    _RTAPT-ID-COL @ _RTAPT-ID-WIDTH @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN DROP
    -1 ;

-1 1 RSHIFT CONSTANT _RTAPT-IRF-SIGNED-MAX
0x8000000000000000 CONSTANT _RTAPT-IRF-SIGNED-MIN

: _RTAPT-IRF-MAGNITUDE/MOD  ( value positive-scale -- remainder quotient )
    _RTAPT-IRF-SCALE !
    DUP 0< IF
        DUP _RTAPT-IRF-SIGNED-MIN = IF
            DROP _RTAPT-IRF-SIGNED-MAX _RTAPT-IRF-SCALE @ /MOD
            _RTAPT-IRF-QUOT ! 1+ DUP _RTAPT-IRF-SCALE @ = IF
                DROP 0 _RTAPT-IRF-REM !
                _RTAPT-IRF-QUOT @ 1+ _RTAPT-IRF-QUOT !
            ELSE
                _RTAPT-IRF-REM !
            THEN
            _RTAPT-IRF-REM @ _RTAPT-IRF-QUOT @ EXIT
        THEN
        NEGATE
    THEN
    _RTAPT-IRF-SCALE @ /MOD ;

: _RTAPT-IRF-PRODUCT>=SCALE?  ( -- flag )
    _RTAPT-IRF-PROD-HI @ IF -1 EXIT THEN
    _RTAPT-IRF-PROD-LO @ _RTAPT-IRF-SCALE @ U< 0= ;

: _RTAPT-IRF-PRODUCT-SCALE-  ( -- )
    _RTAPT-IRF-PROD-LO @ _RTAPT-IRF-SCALE @ U< IF
        -1 _RTAPT-IRF-PROD-HI +!
    THEN
    _RTAPT-IRF-PROD-LO @ _RTAPT-IRF-SCALE @ - _RTAPT-IRF-PROD-LO ! ;

: _RTAPT-IRF-PERCENT-REMAINDER  ( -- remainder quotient-extra )
    _RTAPT-IRF-REM @ 100 UM*
    _RTAPT-IRF-PROD-HI ! _RTAPT-IRF-PROD-LO !
    0 _RTAPT-IRF-EXTRA !
    BEGIN _RTAPT-IRF-PRODUCT>=SCALE? WHILE
        _RTAPT-IRF-PRODUCT-SCALE-
        1 _RTAPT-IRF-EXTRA +!
    REPEAT
    _RTAPT-IRF-PROD-LO @ _RTAPT-IRF-EXTRA @ ;

: _RTAPT-IRF-Q+  ( u -- )
    _RTAPT-IRF-Q-LO @ OVER + DUP
    _RTAPT-IRF-Q-LO @ U< IF 1 _RTAPT-IRF-Q-HI +! THEN
    _RTAPT-IRF-Q-LO ! DROP ;

: _RTAPT-IRF-INTEGER-CARRY?  ( -- flag )
    _RTAPT-IRF-REM @ 0= IF 0 EXIT THEN
    _RTAPT-IRF-DECIMALS @ 19 U> IF 0 EXIT THEN
    1 _RTAPT-IRF-POW10 !
    _RTAPT-IRF-DECIMALS @ 0 ?DO
        _RTAPT-IRF-POW10 @ 10 * _RTAPT-IRF-POW10 !
    LOOP
    _RTAPT-IRF-SCALE @ _RTAPT-IRF-REM @ -
        _RTAPT-IRF-POW10 @ UM*
    DUP IF 2DROP 0 EXIT THEN DROP
    _RTAPT-IRF-SCALE @ 2/ U> 0= ;

: _RTAPT-IRF-DOUBLE>=THRESHOLD?  ( -- flag )
    _RTAPT-IRF-Q-HI @ _RTAPT-IRF-T-HI @ U< IF 0 EXIT THEN
    _RTAPT-IRF-Q-HI @ _RTAPT-IRF-T-HI @ U> IF -1 EXIT THEN
    _RTAPT-IRF-Q-LO @ _RTAPT-IRF-T-LO @ U< 0= ;

: _RTAPT-IRF-THRESHOLD*10  ( -- )
    _RTAPT-IRF-T-LO @ 10 UM*
    _RTAPT-IRF-PROD-HI ! _RTAPT-IRF-T-LO !
    _RTAPT-IRF-T-HI @ 10 * _RTAPT-IRF-PROD-HI @ +
        _RTAPT-IRF-T-HI ! ;

: _RTAPT-IRF-INTEGER-DIGITS  ( -- digits )
    1 _RTAPT-IRF-DIGITS !
    10 _RTAPT-IRF-T-LO ! 0 _RTAPT-IRF-T-HI !
    BEGIN _RTAPT-IRF-DOUBLE>=THRESHOLD? WHILE
        1 _RTAPT-IRF-DIGITS +!
        _RTAPT-IRF-THRESHOLD*10
    REPEAT
    _RTAPT-IRF-DIGITS @ ;

: _RTAPT-IRF-BASE-RATIONAL  ( -- )
    _RTAPT-IRF-VALUE @ _RTAPT-IRF-SCALE @ _RTAPT-IRF-MAGNITUDE/MOD
    _RTAPT-IRF-QUOT ! _RTAPT-IRF-REM !
    _RTAPT-IRF-FORMAT @ RTAPT-READOUT-PERCENT = IF
        _RTAPT-IRF-QUOT @ 100 UM*
        _RTAPT-IRF-Q-HI ! _RTAPT-IRF-Q-LO !
        _RTAPT-IRF-PERCENT-REMAINDER
        _RTAPT-IRF-EXTRA ! _RTAPT-IRF-REM !
        _RTAPT-IRF-EXTRA @ _RTAPT-IRF-Q+
    ELSE
        _RTAPT-IRF-QUOT @ _RTAPT-IRF-Q-LO !
        0 _RTAPT-IRF-Q-HI !
    THEN
    _RTAPT-IRF-INTEGER-CARRY? IF 1 _RTAPT-IRF-Q+ THEN ;

: _RTAPT-IRF-ADD?  ( u -- flag )
    _RTAPT-IRF-LENGTH @ SWAP _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    DUP _RTAPT-U32? 0= IF DROP 0 EXIT THEN
    _RTAPT-IRF-LENGTH ! -1 ;

: _RTAPT-READOUT-FORMATTED-BYTES?
    ( format decimals value scale unit-bytes -- bytes flag )
    _RTAPT-IRF-UNIT-U ! _RTAPT-IRF-SCALE ! _RTAPT-IRF-VALUE !
    _RTAPT-IRF-DECIMALS ! _RTAPT-IRF-FORMAT !
    _RTAPT-IRF-FORMAT @ DUP RTAPT-READOUT-INTEGER U<
        SWAP RTAPT-READOUT-PERCENT U> OR IF 0 0 EXIT THEN
    _RTAPT-IRF-DECIMALS @ _RTAPT-U32? 0= IF 0 0 EXIT THEN
    _RTAPT-IRF-UNIT-U @ _RTAPT-U32? 0= IF 0 0 EXIT THEN
    _RTAPT-IRF-FORMAT @ RTAPT-READOUT-INTEGER = IF
        _RTAPT-IRF-DECIMALS @ IF 0 0 EXIT THEN
        _RTAPT-IRF-SCALE @ 1 <> IF 0 0 EXIT THEN
    ELSE
        _RTAPT-IRF-SCALE @ 0> 0= IF 0 0 EXIT THEN
    THEN
    _RTAPT-IRF-BASE-RATIONAL
    _RTAPT-IRF-INTEGER-DIGITS _RTAPT-IRF-LENGTH !
    _RTAPT-IRF-VALUE @ 0< IF
        1 _RTAPT-IRF-ADD? 0= IF 0 0 EXIT THEN
    THEN
    _RTAPT-IRF-DECIMALS @ IF
        1 _RTAPT-IRF-ADD? 0= IF 0 0 EXIT THEN
        _RTAPT-IRF-DECIMALS @ _RTAPT-IRF-ADD? 0= IF 0 0 EXIT THEN
    THEN
    _RTAPT-IRF-FORMAT @ RTAPT-READOUT-PERCENT = IF
        1 _RTAPT-IRF-ADD? 0= IF 0 0 EXIT THEN
    THEN
    _RTAPT-IRF-UNIT-U @ _RTAPT-IRF-ADD? 0= IF 0 0 EXIT THEN
    _RTAPT-IRF-LENGTH @ -1 ;

: _RTAPT-INSTRUMENT-FORMAT-SCRUB  ( -- )
    0 _RTAPT-IRF-SCALE ! 0 _RTAPT-IRF-REM ! 0 _RTAPT-IRF-QUOT !
    0 _RTAPT-IRF-FORMAT ! 0 _RTAPT-IRF-DECIMALS !
    0 _RTAPT-IRF-VALUE ! 0 _RTAPT-IRF-UNIT-U !
    0 _RTAPT-IRF-PROD-LO ! 0 _RTAPT-IRF-PROD-HI !
    0 _RTAPT-IRF-EXTRA ! 0 _RTAPT-IRF-Q-LO ! 0 _RTAPT-IRF-Q-HI !
    0 _RTAPT-IRF-POW10 ! 0 _RTAPT-IRF-T-LO ! 0 _RTAPT-IRF-T-HI !
...
: _RTAPT-INSTRUMENT-KIND?  ( -- flag )
    _RTAPT-ID-KIND @ RTAPT-INSTRUMENT-READOUT = IF
        ...
        _RTAPT-ID-SCALE @ _RTAPT-ID-UNIT-U @
            _RTAPT-READOUT-FORMATTED-BYTES? 0= IF DROP 0 EXIT THEN
        _RTAPT-ID-FORMATTED-U @ <> IF 0 EXIT THEN
        _RTAPT-ID-UNIT-U @ 104 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
            _RTAPT-ID-PAYLOAD-U !
        _RTAPT-ID-UNIT-U @ _RTAPT-READOUT-FRAME-FIXED
            _RTAPT-UADD? 0= IF DROP 0 EXIT THEN _RTAPT-ID-FRAME-U !
        -1 EXIT
    THEN
    _RTAPT-ID-KIND @ RTAPT-INSTRUMENT-METER = IF
        _RTAPT-ID-MODE @ DUP RTAPT-METER-HORIZONTAL =
        SWAP RTAPT-METER-VERTICAL = OR 0= IF 0 EXIT THEN
        _RTAPT-ID-OPTIONS @ RTAPT-METER-SHOW-VALUE INVERT AND IF
            0 EXIT
        THEN
        ...
        _RTAPT-ID-SCALE @ _RTAPT-ID-UNIT-A @ OR
        _RTAPT-ID-UNIT-U @ OR _RTAPT-ID-FORMATTED-U @ OR IF 0 EXIT THEN
        112 _RTAPT-ID-PAYLOAD-U !
        _RTAPT-METER-FRAME-BYTES _RTAPT-ID-FRAME-U ! -1 EXIT
    THEN
    _RTAPT-ID-KIND @ RTAPT-INSTRUMENT-STATUS <> IF 0 EXIT THEN
    _RTAPT-ID-MODE @ DUP RTAPT-STATUS-CIRCLE U<
    SWAP RTAPT-STATUS-DIAMOND U> OR IF 0 EXIT THEN
    _RTAPT-ID-OPTIONS @ _RTAPT-ID-MINIMUM @ OR
    _RTAPT-ID-MAXIMUM @ OR _RTAPT-ID-SCALE @ OR
    _RTAPT-ID-UNIT-A @ OR _RTAPT-ID-UNIT-U @ OR
    _RTAPT-ID-FORMATTED-U @ OR IF 0 EXIT THEN
    96 _RTAPT-ID-PAYLOAD-U !
    _RTAPT-STATUS-FRAME-BYTES _RTAPT-ID-FRAME-U ! -1 ;

: _RTAPT-INSTRUMENT-FIELDS?  ( -- flag )
    _RTAPT-ID-OWNER @ 0= _RTAPT-ID-GEN @ 0= OR
    _RTAPT-ID-OBJECT @ 0= OR _RTAPT-ID-REGION @ 0= OR IF 0 EXIT THEN
    _RTAPT-ID-PARENT @ _RTAPT-ID-OBJECT @ = IF 0 EXIT THEN
    _RTAPT-ID-VISIBLE @ _RTAPT-CANONICAL-FLAG? 0= IF 0 EXIT THEN
    _RTAPT-ID-Z @ _RTAPT-I32? 0= IF 0 EXIT THEN
    _RTAPT-ID-COLOR-A @ _RTAPT-U32? 0=
    _RTAPT-ID-COLOR-B @ _RTAPT-U32? 0= OR
    _RTAPT-ID-FORMATTED-U @ _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-ID-RESERVED @ IF 0 EXIT THEN
    _RTAPT-INSTRUMENT-GEOMETRY? 0= IF 0 EXIT THEN
    _RTAPT-INSTRUMENT-KIND? ;

: _RTAPT-INSTRUMENT-LIMITS  ( -- status )
    _RTAPT-ID-E @ _RTAPT-E.LIMITS DUP
        RTAPT-LIMITS-VALID? 0= IF DROP RTAPT-S-INVALID EXIT THEN
    ...
    _RTAPT-ID-E @ _RTAPT-E.OP-COUNT @ 1+
        OVER _RTAPT-L.OPS @ U> IF DROP RTAPT-S-CAPACITY EXIT THEN
    _RTAPT-ID-PAYLOAD-U @ OVER _RTAPT-L.OUTBOUND-PAYLOAD @ U> IF
        DROP RTAPT-S-CAPACITY EXIT
    THEN
    _RTAPT-ID-KIND @ RTAPT-INSTRUMENT-READOUT = IF
        _RTAPT-ID-FORMATTED-U @
            OVER _RTAPT-L.GLYPH-RUN-BYTES @ U> IF
            DROP RTAPT-S-CAPACITY EXIT
        THEN
    THEN
    _RTAPT-ID-NEXT-RET @ _RTAPT-UPDATE-ENVELOPE-FRAME-BYTES
        _RTAPT-UADD? 0= IF DROP DROP RTAPT-S-CAPACITY EXIT THEN
    SWAP _RTAPT-L.UPDATE-BYTES @ U> IF RTAPT-S-CAPACITY EXIT THEN
    RTAPT-S-OK ;

: _RTAPT-INSTRUMENT-REGION-OP  ( -- region-op+1|0 )
    _RTAPT-ID-E @ _RTAPT-E.OP-COUNT @ 0 ?DO
        I _RTAPT-ID-E @ _RTAPT-OP-NTH DUP _RTAPT-ID-SCAN-P !
        _RTAPT-P.KIND @ _RTAPT-OP-REGION-DEFINE = IF
            _RTAPT-ID-SCAN-P @ _RTAPT-P.COPY-U @
                _RTAPT-REGION-DEFINE-COPY-SIZE = IF
                _RTAPT-ID-SCAN-P @ _RTAPT-P.COPY-OFF @
                    DUP _RTAPT-ID-SCAN-OFF ! 7 AND 0= IF
                    _RTAPT-ID-SCAN-OFF @ _RTAPT-REGION-DEFINE-COPY-SIZE
                        _RTAPT-UADD? IF
                        DUP _RTAPT-ID-SCAN-NEXT !
                        _RTAPT-ID-E @ _RTAPT-E.COPY-USED @ U> 0= IF
                            _RTAPT-ID-E @ _RTAPT-E.COPY-A @
                                _RTAPT-ID-SCAN-OFF @ +
                            DUP _RTAPT-RD.OWNER @ _RTAPT-ID-OWNER @ =
                            OVER _RTAPT-RD.GENERATION @
                                _RTAPT-ID-GEN @ = AND
                            OVER _RTAPT-RD.REGION @
                                _RTAPT-ID-REGION @ = AND
                            SWAP DROP IF I 1+ UNLOOP EXIT THEN
                        THEN
                    THEN
                THEN
...
: _RTAPT-INSTRUMENT-PARENT?  ( -- flag )
    _RTAPT-ID-PARENT @ 0= IF -1 EXIT THEN
    _RTAPT-ID-PARENT @ _RTAPT-ID-OBJECT @ U< 0= IF 0 EXIT THEN
    _RTAPT-ID-O @ _RTAPT-O.OBJECT-HIGH @
    _RTAPT-ID-O @ _RTAPT-O.PENDING-OBJECT-HIGH @ MAX
    _RTAPT-ID-PARENT @ U< 0= ;

\ Select the wire mutation from retained-target identity, never from the
\ descriptor kind.  REPLACE_START always constructs an empty hidden target,
\ so every admitted instrument there is a new DEFINE.  In DELTA, LAYOUT, and
\ CONTINUE candidates, an ID at or below the committed high-water is an
\ attempted complete replacement; the aggregate engine proves a selected
\ target exists, while PT remains the exact sparse-ID and object-kind
\ authority.  A genuinely new monotonic ID remains a DEFINE.
: _RTAPT-INSTRUMENT-OPERATION?  ( -- flag )
    0 _RTAPT-ID-REGION-OP !
    _RTAPT-ID-E @ _RTAPT-E.RET-MODE @ PT-RET-REPLACE-START = IF
        _RTAPT-OP-INSTRUMENT-DEFINE _RTAPT-ID-OP-KIND ! -1 EXIT
    THEN
    _RTAPT-ID-OBJECT @ _RTAPT-ID-O @ _RTAPT-O.OBJECT-HIGH @ U> IF
        _RTAPT-OP-INSTRUMENT-DEFINE _RTAPT-ID-OP-KIND ! -1 EXIT
    THEN
    _RTAPT-ID-OBJECT @ _RTAPT-ID-REGION @
        _RTAPT-ID-O @ _RTAPT-ID-E @ _RTAPT-GLYPH-RUN-TARGET? 0= IF
        0 EXIT
    THEN
    _RTAPT-OP-INSTRUMENT-REPLACE _RTAPT-ID-OP-KIND ! -1 ;

: _RTAPT-INSTRUMENT-QUOTAS?  ( -- flag )
    _RTAPT-ID-O @ _RTAPT-O.PENDING-OBJECTS @ 1 _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN _RTAPT-ID-NEXT-OBJECTS !
    _RTAPT-ID-O @ _RTAPT-ID-E @ _RTAPT-SHARED-OBJECT-BASE? 0= IF
        DROP 0 EXIT
    THEN
    _RTAPT-ID-O @ _RTAPT-O.PENDING-OBJECTS @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN
    _RTAPT-ID-O @ _RTAPT-O.PENDING-CONTROLS @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN
    _RTAPT-ID-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @
        _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    1 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-ID-O @ _RTAPT-O.OBJECTS @ U> IF 0 EXIT THEN

    \ FORMATTED-U is the complete READOUT representation, including UNIT.
    \ UNIT occupies retry/wire storage but is not charged a second time.
    _RTAPT-ID-FORMATTED-U @ _RTAPT-ID-QUOTA-UTF8 !
    _RTAPT-ID-O @ _RTAPT-ID-E @ _RTAPT-UTF8-BASE
    _RTAPT-ID-O @ _RTAPT-O.PENDING-UTF8 @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN
    _RTAPT-ID-QUOTA-UTF8 @ _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    DUP _RTAPT-ID-NEXT-UTF8 !
    _RTAPT-ID-O @ _RTAPT-O.UTF8-BYTES @ U> 0= ;

: _RTAPT-INSTRUMENT-CAPACITY?  ( -- flag )
    _RTAPT-ID-E @ _RTAPT-E.OP-COUNT @ 0xFFFFFFFF U< 0= IF 0 EXIT THEN
    _RTAPT-ID-E @ _RTAPT-E.OP-COUNT @
        _RTAPT-ID-E @ _RTAPT-E.OP-CAP @ U< 0= IF 0 EXIT THEN
    _RTAPT-ID-UNIT-U @ _RTAPT-INSTRUMENT-COPY-FIXED
        _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
    _RTAPT-ALIGN8? 0= IF DROP 0 EXIT THEN DUP _RTAPT-ID-COPY-U !
    _RTAPT-ID-E @ _RTAPT-E.COPY-U @
        _RTAPT-ID-E @ _RTAPT-E.COPY-USED @ - U> IF 0 EXIT THEN
    _RTAPT-ID-E @ _RTAPT-E.COPY-USED @ _RTAPT-ID-COPY-U @
        _RTAPT-UADD? 0= IF DROP 0 EXIT THEN _RTAPT-ID-NEXT-COPY !
    _RTAPT-ID-E @ _RTAPT-E.RET-BYTES @ _RTAPT-ID-FRAME-U @
        _RTAPT-UADD? 0= IF DROP 0 EXIT THEN _RTAPT-ID-NEXT-RET !
    -1 ;

: _RTAPT-INSTRUMENT-CAPTURE  ( -- status )
    _RTAPT-ID-E @ _RTAPT-E.OP-COUNT @ _RTAPT-ID-E @ _RTAPT-OP-NTH
        DUP _RTAPT-ID-P ! _RTAPT-ID-DIRTY-P !
    _RTAPT-ID-E @ _RTAPT-E.COPY-A @ _RTAPT-ID-E @ _RTAPT-E.COPY-USED @ +
        DUP _RTAPT-ID-COPY ! _RTAPT-ID-DIRTY-COPY !
    _RTAPT-ID-COPY-U @ _RTAPT-ID-DIRTY-COPY-U !
    _RTAPT-ID-P @ RTAPT-OP-SIZE 0 FILL
    _RTAPT-ID-COPY @ _RTAPT-ID-COPY-U @ 0 FILL
    _RTAPT-ID-OP-KIND @ _RTAPT-ID-P @ _RTAPT-P.KIND !
    _RTAPT-ID-E @ _RTAPT-E.COPY-USED @
        _RTAPT-ID-P @ _RTAPT-P.COPY-OFF !
    _RTAPT-ID-COPY-U @ _RTAPT-ID-P @ _RTAPT-P.COPY-U !
    _RTAPT-ID-O @ _RTAPT-ID-E @ _RTAPT-OWNER-SLOT
        _RTAPT-ID-P @ _RTAPT-P.OWNER-SLOT !
    _RTAPT-ID-REGION-OP @ _RTAPT-ID-P @ _RTAPT-P.REGION-OP !
    _RTAPT-ID-OWNER @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.OWNER !
    ...
    _RTAPT-ID-REGION @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.REGION !
    _RTAPT-ID-PARENT @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.PARENT !
    _RTAPT-ID-ROW @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.ROW !
    _RTAPT-ID-COL @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.COL !
    _RTAPT-ID-HEIGHT @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.HEIGHT !
    _RTAPT-ID-WIDTH @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.WIDTH !
    _RTAPT-ID-COLOR-A @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.COLOR-A !
    _RTAPT-ID-COLOR-B @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.COLOR-B !
    _RTAPT-ID-MODE @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.MODE !
    _RTAPT-ID-OPTIONS @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.OPTIONS !
    _RTAPT-ID-MINIMUM @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.MINIMUM !
    _RTAPT-ID-MAXIMUM @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.MAXIMUM !
    _RTAPT-ID-VALUE @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.VALUE !
    _RTAPT-ID-SCALE @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.SCALE !
    _RTAPT-ID-UNIT-U @ _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.UNIT-U !
    _RTAPT-ID-FORMATTED-U @
        _RTAPT-ID-COPY @ _RTAPT-INSTRUMENT.FORMATTED-U !
    _RTAPT-ID-UNIT-U @ IF
        _RTAPT-ID-UNIT-A @ _RTAPT-ID-COPY @ _RTAPT-IDC.UNIT
            _RTAPT-ID-UNIT-U @ MOVE
    THEN
    _RTAPT-ID-OP-KIND @ _RTAPT-OP-INSTRUMENT-DEFINE = IF
        _RTAPT-ID-NEXT-OBJECTS @
            _RTAPT-ID-O @ _RTAPT-O.PENDING-OBJECTS !
        _RTAPT-ID-OBJECT @ _RTAPT-ID-O @ _RTAPT-O.PENDING-OBJECT-HIGH !
        _RTAPT-ID-NEXT-UTF8 @ _RTAPT-ID-O @ _RTAPT-O.PENDING-UTF8 !
    THEN
    _RTAPT-ID-NEXT-COPY @ _RTAPT-ID-E @ _RTAPT-E.COPY-USED !
    _RTAPT-ID-NEXT-RET @ _RTAPT-ID-E @ _RTAPT-E.RET-BYTES !
    1 _RTAPT-ID-E @ _RTAPT-E.OP-COUNT +!
    0 _RTAPT-ID-DIRTY-P ! 0 _RTAPT-ID-DIRTY-COPY !
...
: _RTAPT-INSTRUMENT-DEFINE-BODY  ( -- status )
    ...
    _RTAPT-INSTRUMENT-UNIT-AUTHORITY? 0= IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-ID-E @ _RTAPT-READY-STATUS DUP RTAPT-S-OK <> IF EXIT THEN DROP
    _RTAPT-ID-E @ _RTAPT-E.UPDATE-STATE @ RTAPT-UPDATE-CAPTURING <>
        IF RTAPT-S-BUSY EXIT THEN
    _RTAPT-ID-E @ _RTAPT-CAPTURE-READY? 0= IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-INSTRUMENT-CAPACITY? 0= IF RTAPT-S-CAPACITY EXIT THEN
    _RTAPT-INSTRUMENT-LIMITS DUP RTAPT-S-OK <> IF EXIT THEN DROP
    _RTAPT-INSTRUMENT-UNIT-TEXT? 0= IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-ID-OWNER @ _RTAPT-ID-GEN @ _RTAPT-ID-E @
        _RTAPT-OWNER-FIND DUP 0= IF DROP RTAPT-S-INVALID EXIT THEN
    DUP _RTAPT-ID-O ! _RTAPT-O.STATE @ RTAPT-OWNER-ST-OPEN <>
        IF RTAPT-S-BUSY EXIT THEN
    _RTAPT-INSTRUMENT-OPERATION? 0= IF RTAPT-S-INVALID EXIT THEN
    _RTAPT-ID-OP-KIND @ _RTAPT-OP-INSTRUMENT-DEFINE = IF
        _RTAPT-INSTRUMENT-REGION-OP DUP 0= IF
            DROP RTAPT-S-INVALID EXIT
        THEN _RTAPT-ID-REGION-OP !
        _RTAPT-ID-OBJECT @ _RTAPT-ID-O @ _RTAPT-O.OBJECT-HIGH @ U> 0= IF
            RTAPT-S-INVALID EXIT
        THEN
        _RTAPT-ID-OBJECT @
            _RTAPT-ID-O @ _RTAPT-O.PENDING-OBJECT-HIGH @ U> 0= IF
            RTAPT-S-INVALID EXIT
        THEN
    THEN
    ...
    THEN
    _RTAPT-INSTRUMENT-CAPTURE ;

: _RTAPT-INSTRUMENT-SCRUB  ( status -- status )
    _RTAPT-ID-DIRTY-P @ ?DUP IF RTAPT-OP-SIZE 0 FILL THEN
    _RTAPT-ID-DIRTY-COPY @ ?DUP IF
        _RTAPT-ID-DIRTY-COPY-U @ 0 FILL
    THEN
    0 _RTAPT-ID-I ! 0 _RTAPT-ID-E ! 0 _RTAPT-ID-O !
    0 _RTAPT-ID-P ! 0 _RTAPT-ID-COPY !
    0 _RTAPT-ID-DIRTY-P ! 0 _RTAPT-ID-DIRTY-COPY !
    0 _RTAPT-ID-DIRTY-COPY-U !
    0 _RTAPT-ID-OWNER ! 0 _RTAPT-ID-GEN ! 0 _RTAPT-ID-OBJECT !
    0 _RTAPT-ID-KIND ! 0 _RTAPT-ID-VISIBLE ! 0 _RTAPT-ID-Z !
    0 _RTAPT-ID-REGION ! 0 _RTAPT-ID-PARENT !
    0 _RTAPT-ID-ROW ! 0 _RTAPT-ID-COL !
    0 _RTAPT-ID-HEIGHT ! 0 _RTAPT-ID-WIDTH !
    0 _RTAPT-ID-ROOT-H ! 0 _RTAPT-ID-ROOT-W !
    0 _RTAPT-ID-COLOR-A ! 0 _RTAPT-ID-COLOR-B !
    0 _RTAPT-ID-MODE ! 0 _RTAPT-ID-OPTIONS !
    ...
    0 _RTAPT-ID-NEXT-UTF8 ! 0 _RTAPT-ID-QUOTA-UTF8 !
    0 _RTAPT-ID-REGION-OP ! 0 _RTAPT-ID-FRAME-U !
    0 _RTAPT-ID-PAYLOAD-U ! 0 _RTAPT-ID-SCAN-P !
    0 _RTAPT-ID-SCAN-OFF ! 0 _RTAPT-ID-SCAN-NEXT !
    0 _RTAPT-ID-U8-I ! 0 _RTAPT-ID-U8-B0 ! 0 _RTAPT-ID-U8-B1 !
    _RTAPT-INSTRUMENT-FORMAT-SCRUB
    0 _RTAPT-BSD-A ! 0 _RTAPT-BSD-U ! 0 _RTAPT-BSD-E !
    0 _RTAPT-LPF-SA ! 0 _RTAPT-LPF-SB ! 0 _RTAPT-LPF-SS ! ;

: RTAPT-INSTRUMENT-DEFINE  ( instrument engine -- status )
    2DUP _RTAPT-INSTRUMENT-AUTHORITY? 0= IF
        2DROP RTAPT-S-INVALID EXIT
    THEN
    _RTAPT-ID-E ! _RTAPT-ID-I !
    _RTAPT-INSTRUMENT-LOAD
    ['] _RTAPT-INSTRUMENT-DEFINE-BODY CATCH ?DUP IF
        DROP RTAPT-S-INVALID
    THEN
...
VARIABLE _RTAPT-PF-CONTENT-ITEMS
VARIABLE _RTAPT-PF-CPHASE
VARIABLE _RTAPT-PF-CBAR-COUNT
VARIABLE _RTAPT-PF-CROOT-ID
...
VARIABLE _RTAPT-PF-CSELECTED-ROOT-CHILD
...
VARIABLE _RTAPT-PRR-SOURCE
VARIABLE _RTAPT-PRR-OWNER
VARIABLE _RTAPT-PRR-GENERATION
VARIABLE _RTAPT-PRR-REGION-ID

: _RTAPT-REGION-BACKLINK-FINISH  ( flag -- flag )
    0 _RTAPT-PRR-I ! 0 _RTAPT-PRR-E ! 0 _RTAPT-PRR-P !
    0 _RTAPT-PRR-REGION ! 0 _RTAPT-PRR-SOURCE !
    0 _RTAPT-PRR-OWNER ! 0 _RTAPT-PRR-GENERATION !
    0 _RTAPT-PRR-REGION-ID ! ;
...
: _RTAPT-REGION-BACKLINK-VALUES?
  ( index owner generation region op-record engine -- flag )
    _RTAPT-PRR-E ! _RTAPT-PRR-P !
    _RTAPT-PRR-REGION-ID ! _RTAPT-PRR-GENERATION !
    _RTAPT-PRR-OWNER ! _RTAPT-PRR-I !
    ...
    _RTAPT-PRR-REGION @ _RTAPT-RD.GENERATION @
        _RTAPT-PRR-GENERATION @ = AND
    _RTAPT-PRR-REGION @ _RTAPT-RD.REGION @
        _RTAPT-PRR-REGION-ID @ = AND
...
: _RTAPT-REGION-BACKLINK?  ( index glyph-copy op-record engine -- flag )
    ...
    _RTAPT-PRR-I @
    _RTAPT-PRR-SOURCE @ _RTAPT-LD.OWNER @
    _RTAPT-PRR-SOURCE @ _RTAPT-LD.GENERATION @
    _RTAPT-PRR-SOURCE @ _RTAPT-LD.REGION @
    _RTAPT-PRR-P @ _RTAPT-PRR-E @ _RTAPT-REGION-BACKLINK-VALUES? ;

: _RTAPT-INSTRUMENT-REGION-BACKLINK?
  ( index instrument-copy op-record engine -- flag )
    _RTAPT-PRR-E ! _RTAPT-PRR-P ! _RTAPT-PRR-SOURCE ! _RTAPT-PRR-I !
    _RTAPT-PRR-I @
    _RTAPT-PRR-SOURCE @ _RTAPT-INSTRUMENT.OWNER @
    _RTAPT-PRR-SOURCE @ _RTAPT-INSTRUMENT.GENERATION @
...
: _RTAPT-REGION-COPY-SHAPE?  ( copy cols rows -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-RD.COLS @
    _RTAPT-PF-COPY @ _RTAPT-RD.ROWS @
    _RTAPT-PF-COPY @ _RTAPT-RD.CLIP-X @
    _RTAPT-PF-COPY @ _RTAPT-RD.CLIP-Y @
    _RTAPT-PF-COPY @ _RTAPT-RD.CLIP-COLS @
    _RTAPT-PF-COPY @ _RTAPT-RD.CLIP-ROWS @
    _RTAPT-PF-COPY @ _RTAPT-RD.FLAGS @
    _RTAPT-PF-COLS @ _RTAPT-PF-ROWS @ _RTAPT-REGION-GEOMETRY? ;
...
: _RTAPT-GLYPH-RUN-COPY-SHAPE?  ( copy copy-u -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-LD.X @ _RTAPT-I32? 0=
    _RTAPT-PF-COPY @ _RTAPT-LD.Y @ _RTAPT-I32? 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-LD.COLS @ DUP 0=
        SWAP _RTAPT-U32? 0= OR
    _RTAPT-PF-COPY @ _RTAPT-LD.ROWS @ DUP 0=
        SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-LD.X @
    _RTAPT-PF-COPY @ _RTAPT-LD.COLS @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN DROP
    _RTAPT-PF-COPY @ _RTAPT-LD.Y @
    _RTAPT-PF-COPY @ _RTAPT-LD.ROWS @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN DROP
...
: _RTAPT-INSTRUMENT-COPY-SHAPE?  ( copy copy-u -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.UNIT-U @ _RTAPT-U32? 0=
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.FORMATTED-U @
        _RTAPT-U32? 0= OR IF 0 EXIT THEN
    ...
    _RTAPT-PF-COPY-U @ _RTAPT-BV-RAW-U @ -
        _RTAPT-ZERO-SPAN? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.UNIT-A @
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ROOT-HEIGHT @ OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ROOT-WIDTH @ OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.RESERVED @ OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.OWNER @ 0=
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.GENERATION @ 0= OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ID @ 0= OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.REGION @ 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.PARENT @
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ID @ = IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.VISIBLE @
        _RTAPT-WIRE-BOOL? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.Z @ _RTAPT-I32? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ROW @ _RTAPT-I32? 0=
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.COL @ _RTAPT-I32? 0= OR IF
        0 EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.HEIGHT @ DUP 0=
    SWAP _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.WIDTH @ DUP 0=
    SWAP _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ROW @
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.HEIGHT @
        _RTAPT-LPF-SADD? 0= IF DROP 0 EXIT THEN DROP
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.COL @
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.WIDTH @
        _RTAPT-LPF-SADD? 0= IF DROP 0 EXIT THEN DROP
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.COLOR-A @ _RTAPT-U32? 0=
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.COLOR-B @
        _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-IDC.UNIT
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.UNIT-U @
    ...
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.KIND @
        ...
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MAXIMUM @ OR IF 0 EXIT THEN
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MODE @
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.OPTIONS @
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.VALUE @
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.SCALE @
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.UNIT-U @
            _RTAPT-READOUT-FORMATTED-BYTES? 0= IF DROP 0 EXIT THEN
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.FORMATTED-U @ <> IF
            0 EXIT
        THEN
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.UNIT-U @
            _RTAPT-READOUT-FRAME-FIXED _RTAPT-UADD? 0= IF
    ...
    THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.KIND @
        RTAPT-INSTRUMENT-METER = IF
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MODE @ DUP
            RTAPT-METER-HORIZONTAL =
        SWAP RTAPT-METER-VERTICAL = OR 0= IF 0 EXIT THEN
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.OPTIONS @
            RTAPT-METER-SHOW-VALUE INVERT AND IF 0 EXIT THEN
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MINIMUM @
        ...
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.FORMATTED-U @ OR IF
            0 EXIT
        THEN
        _RTAPT-METER-FRAME-BYTES _RTAPT-BV-FRAME ! -1 EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.KIND @
        RTAPT-INSTRUMENT-STATUS <> IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MODE @ DUP
        RTAPT-STATUS-CIRCLE U<
    SWAP RTAPT-STATUS-DIAMOND U> OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.OPTIONS @
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MINIMUM @ OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.MAXIMUM @ OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.SCALE @ OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.UNIT-U @ OR
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.FORMATTED-U @ OR IF 0 EXIT THEN
    _RTAPT-STATUS-FRAME-BYTES _RTAPT-BV-FRAME ! -1 ;

: _RTAPT-CONTROL-COPY-ROOT-BOUNDS?  ( -- flag )
    _RTAPT-PF-COPY @ _RTAPT-CD.X @ _RTAPT-I32? 0=
    _RTAPT-PF-COPY @ _RTAPT-CD.Y @ _RTAPT-I32? 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.COLS @ DUP 0=
        SWAP _RTAPT-U32? 0= OR
    _RTAPT-PF-COPY @ _RTAPT-CD.ROWS @ DUP 0=
        SWAP _RTAPT-U32? 0= OR OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.X @
    _RTAPT-PF-COPY @ _RTAPT-CD.COLS @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN DROP
    _RTAPT-PF-COPY @ _RTAPT-CD.Y @
    _RTAPT-PF-COPY @ _RTAPT-CD.ROWS @ _RTAPT-LPF-SADD? 0= IF
        DROP 0 EXIT
    THEN DROP -1 ;

: _RTAPT-CONTROL-COPY-DESCENDANT?  ( -- flag )
    _RTAPT-PF-COPY @ _RTAPT-CD.PARENT @ 0<>
    _RTAPT-PF-COPY @ _RTAPT-CD.Z @ 0= AND
    _RTAPT-PF-COPY @ _RTAPT-CD.X @
    _RTAPT-PF-COPY @ _RTAPT-CD.Y @ OR
    _RTAPT-PF-COPY @ _RTAPT-CD.COLS @ OR
    _RTAPT-PF-COPY @ _RTAPT-CD.ROWS @ OR 0= AND ;

: _RTAPT-CONTROL-COPY-KIND-SHAPE?  ( -- flag )
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @
        _RTAPT-CONTROL-TEXT-COLLECTION-KIND? IF
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-MENUBAR = IF
        ...
        _RTAPT-CONTROL-COPY-ROOT-BOUNDS? EXIT
    THEN
    _RTAPT-CONTROL-COPY-DESCENDANT? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-MENU = IF
        ...
        _RTAPT-PF-COPY @ _RTAPT-CD.STATE @ 0x0F INVERT AND 0= EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-ITEM = IF
        _RTAPT-PF-COPY @ _RTAPT-CD.LABEL-U @ 0= IF 0 EXIT THEN
        _RTAPT-PF-COPY @ _RTAPT-CD.STATE @ 0x1B INVERT AND 0= EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-TAB = IF
        _RTAPT-PF-COPY @ _RTAPT-CD.LABEL-U @ 0= IF 0 EXIT THEN
        _RTAPT-PF-COPY @ _RTAPT-CD.STATE @ 0x0B INVERT AND 0= EXIT
    THEN
...
: _RTAPT-CONTROL-COPY-SHAPE?  ( copy copy-u -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.SHORTCUT-U @ _RTAPT-U32? 0= OR IF
        0 EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-U @ _RTAPT-U32? 0=
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-ITEMS @ _RTAPT-U32? 0= OR
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-UTF8 @ _RTAPT-U32? 0= OR IF
        0 EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CONTROL-CONTENT-META? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.LABEL-U @
    _RTAPT-PF-COPY @ _RTAPT-CD.SHORTCUT-U @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-U @ _RTAPT-UADD? 0= IF
        DROP 0 EXIT
    ...
    _RTAPT-PF-COPY-U @ _RTAPT-BV-RAW-U @ -
        _RTAPT-ZERO-SPAN? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CONTROL-COPY-CONTENT-HEADER? 0= IF
        0 EXIT
    THEN
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.X @ _RTAPT-I32? 0=
    _RTAPT-PF-COPY @ _RTAPT-CD.Y @ _RTAPT-I32? 0= OR
    _RTAPT-PF-COPY @ _RTAPT-CD.COLS @ _RTAPT-U32? 0= OR
    _RTAPT-PF-COPY @ _RTAPT-CD.ROWS @ _RTAPT-U32? 0= OR IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.STATE @
        RTAPT-CONTROL-F-OPEN RTAPT-CONTROL-F-SELECTED OR AND IF
        _RTAPT-PF-COPY @ _RTAPT-CD.STATE @
            RTAPT-CONTROL-F-VISIBLE RTAPT-CONTROL-F-ENABLED OR AND
...
: _RTAPT-PF-CONTROL-MENU?  ( -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.PARENT @ _RTAPT-PF-CROOT-ID @ <>
        IF 0 EXIT THEN
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.STATE @ RTAPT-CONTROL-F-SELECTED AND IF
        _RTAPT-PF-CSELECTED-ROOT-CHILD @ IF 0 EXIT THEN
        -1 _RTAPT-PF-CSELECTED-ROOT-CHILD !
    THEN
...
: _RTAPT-PF-CONTROL-ROOT-START  ( phase -- flag )
    _RTAPT-PF-CPHASE !
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTROL @ _RTAPT-PF-CROOT-ID !
    0 _RTAPT-PF-CMENU-FIRST ! 0 _RTAPT-PF-CMENU-LAST !
    0 _RTAPT-PF-CPARENT ! 0 _RTAPT-PF-CORDER !
    0 _RTAPT-PF-COPEN-MENU !
    0 _RTAPT-PF-CSELECTED-ROOT-CHILD !
    0 _RTAPT-PF-CSELECTED-ITEM-PARENT !
    -1 ;

: _RTAPT-PF-CONTROL-TAB?  ( -- flag )
    _RTAPT-PF-CPHASE @ DUP _RTAPT-PF-CONTROL-PHASE-TABSET =
    SWAP _RTAPT-PF-CONTROL-PHASE-TAB = OR 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.PARENT @ _RTAPT-PF-CROOT-ID @ <>
        IF 0 EXIT THEN
    _RTAPT-PF-CPHASE @ _RTAPT-PF-CONTROL-PHASE-TAB = IF
        _RTAPT-PF-COPY @ _RTAPT-CD.ORDER @ _RTAPT-PF-CORDER @ U> 0=
            IF 0 EXIT THEN
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.STATE @ RTAPT-CONTROL-F-SELECTED AND IF
    ...
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.ORDER @ _RTAPT-PF-CORDER !
    _RTAPT-PF-CONTROL-PHASE-TAB _RTAPT-PF-CPHASE ! -1 ;
...
: _RTAPT-PF-CONTROL-DEFINE-GRAPH?  ( -- flag )
    ...
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @
        ...
        \ but closes its parent interval.  Only a later MENUBAR may reopen a
        \ menu phase; no MENU or ITEM can attach across this root barrier.
        _RTAPT-PF-CONTROL-PHASE-COLLECTION
            _RTAPT-PF-CONTROL-ROOT-START EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-TABSET = IF
        _RTAPT-PF-CONTROL-PHASE-TABSET
            _RTAPT-PF-CONTROL-ROOT-START EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-TAB = IF
        _RTAPT-PF-CONTROL-TAB? EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-MENUBAR = IF
        _RTAPT-PF-CBAR-COUNT @ 1 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
            _RTAPT-PF-CBAR-COUNT !
        _RTAPT-PF-CONTROL-PHASE-BAR
            _RTAPT-PF-CONTROL-ROOT-START EXIT
    THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ RTAPT-CONTROL-MENU = IF
...
VARIABLE _RTAPT-PA-LEDGER
VARIABLE _RTAPT-PA-PRIOR-P
VARIABLE _RTAPT-PA-PRIOR-COPY
VARIABLE _RTAPT-PA-NEW-UTF8
...
: _RTAPT-PUBLICATION-OWNER-LOAD  ( owner-record -- )
    ...
    DUP _RTAPT-O.A-CONTENT-ITEMS @ _RTAPT-PF-CONTENT-ITEMS !
    DUP _RTAPT-O.A-CPHASE @ _RTAPT-PF-CPHASE !
    DUP _RTAPT-O.A-CBAR-COUNT @ _RTAPT-PF-CBAR-COUNT !
    DUP _RTAPT-O.A-CROOT-ID @ _RTAPT-PF-CROOT-ID !
    ...
    DUP _RTAPT-O.A-CSELECTED-ROOT-CHILD @
...
: _RTAPT-PUBLICATION-OWNER-SAVE  ( -- flag )
    ...
    _RTAPT-PF-CONTENT-ITEMS @
        _RTAPT-PF-O @ _RTAPT-O.A-CONTENT-ITEMS !
    _RTAPT-PF-CPHASE @ _RTAPT-PF-O @ _RTAPT-O.A-CPHASE !
    _RTAPT-PF-CBAR-COUNT @ _RTAPT-PF-O @ _RTAPT-O.A-CBAR-COUNT !
    _RTAPT-PF-CROOT-ID @ _RTAPT-PF-O @ _RTAPT-O.A-CROOT-ID !
    ...
    _RTAPT-PF-CSELECTED-ROOT-CHILD @
        _RTAPT-PF-O @ _RTAPT-O.A-CSELECTED-ROOT-CHILD !
    _RTAPT-PF-CSELECTED-ITEM-PARENT @
...
: _RTAPT-PUBLICATION-AUDIT-FINISH  ( flag -- flag )
    ...
    0 _RTAPT-PA-LEDGER ! 0 _RTAPT-PA-PRIOR-P !
    0 _RTAPT-PA-PRIOR-COPY ! 0 _RTAPT-PA-NEW-UTF8 !
...
: _RTAPT-PUBLICATION-OP-SHAPE?  ( -- flag )
    ...
    _RTAPT-PF-P @ _RTAPT-PA-I @ _RTAPT-PA-E @
        _RTAPT-DEFINITION-REGION-OP? 0= IF 0 EXIT THEN
    ...
    _RTAPT-PF-P @ _RTAPT-P.KIND @ _RTAPT-CONTROL-WRITE-OP? IF
        ...
        THEN
        _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-U @ _RTAPT-U32? 0=
        _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-ITEMS @ _RTAPT-U32? 0= OR
        _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-UTF8 @ _RTAPT-U32? 0= OR IF
            0 EXIT
        THEN
        _RTAPT-BV-COPY @ _RTAPT-CONTROL-CONTENT-META? 0= IF 0 EXIT THEN
        _RTAPT-BV-COPY @ _RTAPT-CD.LABEL-U @
        _RTAPT-BV-COPY @ _RTAPT-CD.SHORTCUT-U @ _RTAPT-UADD? 0= IF
            DROP 0 EXIT
        THEN
        _RTAPT-BV-COPY @ _RTAPT-CD.CONTENT-U @ _RTAPT-UADD? 0= IF
            DROP 0 EXIT
        THEN DUP _RTAPT-BV-TEXT-U !
        _RTAPT-CONTROL-COPY-FIXED _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
        DUP _RTAPT-BV-RAW-U ! _RTAPT-ALIGN8? 0= IF DROP 0 EXIT THEN
        ...
        _RTAPT-BV-COPY-U @ _RTAPT-BV-RAW-U @ -
            _RTAPT-ZERO-SPAN? 0= IF 0 EXIT THEN
        _RTAPT-BV-COPY @ _RTAPT-CONTROL-COPY-CONTENT-HEADER? 0= IF
            0 EXIT
        THEN
...
: _RTAPT-PUBLICATION-GLYPH?  ( -- flag )
    ...
    _RTAPT-PF-P @ _RTAPT-P.KIND @ _RTAPT-OP-GLYPH-RUN-DEFINE = IF
        _RTAPT-PF-P @ _RTAPT-P.REGION-OP @ IF
            _RTAPT-PA-I @ _RTAPT-PF-COPY @ _RTAPT-PF-P @ _RTAPT-PA-E @
                _RTAPT-REGION-BACKLINK? 0= IF 0 EXIT THEN
        ELSE
            _RTAPT-PA-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA <> IF
                0 EXIT
            THEN
            _RTAPT-PF-COPY @ _RTAPT-LD.REGION @ _RTAPT-PF-O @
                _RTAPT-GLYPH-RUN-ACTIVE-REGION? 0= IF 0 EXIT THEN
        THEN
...
: _RTAPT-PUBLICATION-INSTRUMENT-PARENT?  ( -- flag )
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.PARENT @ 0= IF -1 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.PARENT @
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ID @ U< 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.PARENT @
        _RTAPT-PF-OHIGH @ U> 0= ;
...
: _RTAPT-PUBLICATION-INSTRUMENT?  ( -- flag )
    ...
    _RTAPT-PF-P @ _RTAPT-P.KIND @ _RTAPT-OP-INSTRUMENT-DEFINE = IF
        _RTAPT-PA-I @ _RTAPT-PF-COPY @ _RTAPT-PF-P @ _RTAPT-PA-E @
            _RTAPT-INSTRUMENT-REGION-BACKLINK? 0= IF 0 EXIT THEN
        ...
        _RTAPT-PF-OCOUNT @ 1 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
            _RTAPT-PF-OCOUNT !
        _RTAPT-PF-COPY @ _RTAPT-INSTRUMENT.ID @ _RTAPT-PF-OHIGH !
        -1 EXIT
    THEN
...
: _RTAPT-PUBLICATION-CONTROL-REPLACE-PRIOR?  ( -- flag )
    _RTAPT-PA-I @ 0 ?DO
        I _RTAPT-PA-E @ _RTAPT-OP-NTH DUP _RTAPT-PA-PRIOR-P !
            _RTAPT-P.KIND @ _RTAPT-OP-CONTROL-REPLACE = IF
            _RTAPT-PA-PRIOR-P @ _RTAPT-P.OWNER-SLOT @
                _RTAPT-PF-P @ _RTAPT-P.OWNER-SLOT @ = IF
                _RTAPT-PA-E @ _RTAPT-E.COPY-A @
                _RTAPT-PA-PRIOR-P @ _RTAPT-P.COPY-OFF @ +
                    DUP _RTAPT-PA-PRIOR-COPY ! _RTAPT-CD.CONTROL @
                _RTAPT-PF-COPY @ _RTAPT-CD.CONTROL @ = IF
                    -1 UNLOOP EXIT
                THEN
            THEN
        THEN
...
: _RTAPT-PUBLICATION-CONTROL-REPLACE?  ( -- flag )
    _RTAPT-PA-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA <> IF 0 EXIT THEN
    _RTAPT-PF-O @ _RTAPT-O.ACTIVE-CONTROLS @ 0= IF 0 EXIT THEN
    _RTAPT-PF-O @ _RTAPT-O.ACTIVE-REGIONS @ 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.REGION @
        _RTAPT-PF-O @ _RTAPT-O.REGION-HIGH @ U> IF 0 EXIT THEN
    _RTAPT-PF-O @
    _RTAPT-PF-COPY @ _RTAPT-CD.GENERATION @
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTROL @ _RTAPT-PA-E @
        _RTAPT-CONTROL-LEDGER-FIND DUP 0= IF DROP 0 EXIT THEN
        DUP _RTAPT-PA-LEDGER ! _RTAPT-CL.META @
    DUP _RTAPT-CL-ACTIVE AND 0= IF DROP 0 EXIT THEN
    _RTAPT-CL-KIND-MASK AND
        _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ <> IF 0 EXIT THEN
    _RTAPT-PUBLICATION-CONTROL-REPLACE-PRIOR? IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.LABEL-U @
    _RTAPT-PF-COPY @ _RTAPT-CD.SHORTCUT-U @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-UTF8 @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN _RTAPT-PA-NEW-UTF8 !
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @
        _RTAPT-MUTABLE-CONTROL-KIND? 0= IF
        _RTAPT-PA-LEDGER @ _RTAPT-CL.ACTIVE-ITEMS @
            _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-ITEMS @ <>
        _RTAPT-PA-LEDGER @ _RTAPT-CL.ACTIVE-UTF8 @
            _RTAPT-PA-NEW-UTF8 @ <> OR IF 0 EXIT THEN
    THEN
    _RTAPT-PA-LEDGER @ _RTAPT-CL.ACTIVE-ITEMS @
        _RTAPT-PF-CONTENT-ITEMS @ U> IF 0 EXIT THEN
    _RTAPT-PF-CONTENT-ITEMS @
        _RTAPT-PA-LEDGER @ _RTAPT-CL.ACTIVE-ITEMS @ -
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTENT-ITEMS @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN _RTAPT-PF-CONTENT-ITEMS !
    _RTAPT-PA-LEDGER @ _RTAPT-CL.ACTIVE-UTF8 @
        _RTAPT-PF-UTF8 @ U> IF 0 EXIT THEN
    _RTAPT-PF-UTF8 @ _RTAPT-PA-LEDGER @ _RTAPT-CL.ACTIVE-UTF8 @ -
    _RTAPT-PA-NEW-UTF8 @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN _RTAPT-PF-UTF8 !
    _RTAPT-PF-CBAR-COUNT @ 1 _RTAPT-UADD? 0= IF DROP 0 EXIT THEN
        _RTAPT-PF-CBAR-COUNT !
    _RTAPT-PUBLICATION-NONDEFINITION+? ;

VARIABLE _RTAPT-PA-PARENT
VARIABLE _RTAPT-PA-PARENT-KIND
VARIABLE _RTAPT-PA-PARENT-MATCHES

: _RTAPT-PUBLICATION-CONTROL-PARENT-KIND?
  ( child-kind parent-kind -- flag )
    _RTAPT-PA-PARENT-KIND !
    DUP RTAPT-CONTROL-MENU = IF
        DROP _RTAPT-PA-PARENT-KIND @ RTAPT-CONTROL-MENUBAR = EXIT
    THEN
    DUP RTAPT-CONTROL-ITEM = OVER RTAPT-CONTROL-SEPARATOR = OR IF
        DROP _RTAPT-PA-PARENT-KIND @ RTAPT-CONTROL-MENU = EXIT
    THEN
    RTAPT-CONTROL-TAB = IF
        _RTAPT-PA-PARENT-KIND @ RTAPT-CONTROL-TABSET = EXIT
    THEN
    0 ;

: _RTAPT-PUBLICATION-CONTROL-DELTA-PARENT-PRIOR?  ( -- flag )
    0 _RTAPT-PA-PARENT-MATCHES ! 0 _RTAPT-PA-PARENT-KIND !
    _RTAPT-PA-I @ 0 ?DO
        I _RTAPT-PA-E @ _RTAPT-OP-NTH DUP _RTAPT-PA-PRIOR-P !
        DUP _RTAPT-P.KIND @ _RTAPT-OP-CONTROL-DEFINE =
        SWAP _RTAPT-P.OWNER-SLOT @
            _RTAPT-PF-P @ _RTAPT-P.OWNER-SLOT @ = AND IF
            _RTAPT-PA-E @ _RTAPT-E.COPY-A @
            _RTAPT-PA-PRIOR-P @ _RTAPT-P.COPY-OFF @ +
                DUP _RTAPT-PA-PRIOR-COPY ! _RTAPT-CD.CONTROL @
            _RTAPT-PA-PARENT @ = IF
                _RTAPT-PA-PRIOR-COPY @ _RTAPT-CD.KIND @
                    _RTAPT-PA-PARENT-KIND !
                1 _RTAPT-PA-PARENT-MATCHES +!
            THEN
        THEN
    LOOP
    _RTAPT-PA-PARENT-MATCHES @ 1 <> IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ _RTAPT-PA-PARENT-KIND @
        _RTAPT-PUBLICATION-CONTROL-PARENT-KIND? ;

: _RTAPT-PUBLICATION-CONTROL-DELTA-PARENT?  ( -- flag )
    _RTAPT-PF-COPY @ _RTAPT-CD.PARENT @ DUP 0= IF
        DROP _RTAPT-PF-COPY @ _RTAPT-CD.KIND @
            _RTAPT-CONTROL-ROOT-KIND? EXIT
    THEN DUP _RTAPT-PA-PARENT !
    DUP _RTAPT-PF-COPY @ _RTAPT-CD.CONTROL @ U< 0= IF
        DROP 0 EXIT
    THEN
    DUP _RTAPT-PF-CHIGH @ U> IF DROP 0 EXIT THEN
    _RTAPT-PF-O @ _RTAPT-O.CONTROL-HIGH @ U> IF
        _RTAPT-PUBLICATION-CONTROL-DELTA-PARENT-PRIOR? EXIT
    THEN
    _RTAPT-PF-O @
    _RTAPT-PF-COPY @ _RTAPT-CD.GENERATION @
    _RTAPT-PA-PARENT @ _RTAPT-PA-E @
        _RTAPT-CONTROL-LEDGER-FIND DUP 0= IF DROP 0 EXIT THEN
    DUP _RTAPT-PA-LEDGER ! _RTAPT-CL.META @
        DUP _RTAPT-CL-ACTIVE AND 0= IF DROP 0 EXIT THEN
        _RTAPT-CL-KIND-MASK AND _RTAPT-PA-PARENT-KIND !
    _RTAPT-PF-COPY @ _RTAPT-CD.KIND @ _RTAPT-PA-PARENT-KIND @
        _RTAPT-PUBLICATION-CONTROL-PARENT-KIND? ;

\ A DELTA definition extends the acknowledged control graph rather than
\ rebuilding it.  Its parent may therefore be an already-active control or
\ an earlier definition in this same capture.  The transport is the exact
\ sparse-graph authority; this aggregate audit proves the monotonic identity,
\ active-region backlink, and quota ledger without pretending that the delta
\ contains a second complete graph description.
: _RTAPT-PUBLICATION-CONTROL-DELTA-DEFINE?  ( -- flag )
    _RTAPT-PA-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA <> IF 0 EXIT THEN
    _RTAPT-PF-O @ _RTAPT-O.ACTIVE-REGIONS @ 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.REGION @
        _RTAPT-PF-O @ _RTAPT-O.REGION-HIGH @ U> IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTROL @
        _RTAPT-PF-CHIGH @ U> 0= IF 0 EXIT THEN
    _RTAPT-PUBLICATION-CONTROL-DELTA-PARENT? 0= IF 0 EXIT THEN
    _RTAPT-PF-COPY @ _RTAPT-CD.CONTROL @ _RTAPT-PF-CHIGH !
...
: _RTAPT-PUBLICATION-CONTROL?  ( -- flag )
    ...
    _RTAPT-PF-P @ _RTAPT-P.KIND @ _RTAPT-OP-CONTROL-DEFINE = IF
        _RTAPT-PA-E @ _RTAPT-E.RET-MODE @ PT-RET-DELTA = IF
            _RTAPT-PUBLICATION-CONTROL-DELTA-DEFINE? EXIT
        THEN
...
: _RTAPT-PUBLICATION-AUDIT-BODY  ( -- flag )
    _RTAPT-PA-E @ _RTAPT-CONTROL-LEDGER-VALID? 0= IF 0 EXIT THEN
    _RTAPT-PUBLICATION-OWNERS-INIT
...
VARIABLE _RTAPT-CS-MODE
VARIABLE _RTAPT-CS-OPTIONS
VARIABLE _RTAPT-CS-RGBA
...
: _RTAPT-SEND-REGION  ( -- status )
    ...
    _RTAPT-CS-COPY @ _RTAPT-RD.CLIP-X @
    _RTAPT-CS-COPY @ _RTAPT-RD.CLIP-Y @
    _RTAPT-CS-COPY @ _RTAPT-RD.CLIP-COLS @
    _RTAPT-CS-COPY @ _RTAPT-RD.CLIP-ROWS @
...
: _RTAPT-SEND-GLYPH-RUN  ( replace? -- status )
    ...
    _RTAPT-CS-COPY @ _RTAPT-LD.X @
    _RTAPT-CS-COPY @ _RTAPT-LD.Y @
    _RTAPT-CS-COPY @ _RTAPT-LD.COLS @
    _RTAPT-CS-COPY @ _RTAPT-LD.ROWS @
...
: _RTAPT-READOUT-MODE>PT  ( provider-mode -- pt-mode flag )
    DUP RTAPT-READOUT-INTEGER = IF
        DROP PT-READOUT-INTEGER -1 EXIT
    THEN
    DUP RTAPT-READOUT-FIXED = IF DROP PT-READOUT-FIXED -1 EXIT THEN
    RTAPT-READOUT-PERCENT = IF PT-READOUT-PERCENT -1 EXIT THEN
    0 0 ;

: _RTAPT-METER-MODE>PT  ( provider-mode -- pt-mode flag )
    DUP RTAPT-METER-HORIZONTAL = IF
        DROP PT-METER-HORIZONTAL -1 EXIT
    THEN
    RTAPT-METER-VERTICAL = IF PT-METER-VERTICAL -1 EXIT THEN
    0 0 ;

: _RTAPT-METER-OPTIONS>PT  ( provider-options -- pt-options flag )
    DUP RTAPT-METER-SHOW-VALUE INVERT AND IF DROP 0 0 EXIT THEN
    0 SWAP RTAPT-METER-SHOW-VALUE AND IF
        PT-METER-SHOW-VALUE OR
    THEN -1 ;

: _RTAPT-STATUS-MODE>PT  ( provider-mode -- pt-mode flag )
    DUP RTAPT-STATUS-CIRCLE = IF DROP PT-STATUS-CIRCLE -1 EXIT THEN
    DUP RTAPT-STATUS-SQUARE = IF DROP PT-STATUS-SQUARE -1 EXIT THEN
    RTAPT-STATUS-DIAMOND = IF PT-STATUS-DIAMOND -1 EXIT THEN
    0 0 ;

: _RTAPT-PUSH-RGBA  ( rgba -- red green blue alpha )
    _RTAPT-CS-RGBA !
    _RTAPT-CS-RGBA @ 24 RSHIFT 0xFF AND
    _RTAPT-CS-RGBA @ 16 RSHIFT 0xFF AND
    _RTAPT-CS-RGBA @ 8 RSHIFT 0xFF AND
    _RTAPT-CS-RGBA @ 0xFF AND ;

: _RTAPT-PUSH-INSTRUMENT-COMMON  ( -- common-prefix )
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.OWNER @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.GENERATION @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.ID @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.REGION @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.PARENT @
    \ This is the single low-level geometry seam: map the neutral row/column
    \ tuple to PT's signed x/y plus unsigned cols/rows common prefix.  REGION
    \ owns the independent physical clip; no provider-side conversion or
    \ containment policy is applied here.
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.COL @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.ROW @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.WIDTH @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.HEIGHT @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.Z @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.VISIBLE @ ;

: _RTAPT-SEND-READOUT  ( -- status )
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.MODE @
        _RTAPT-READOUT-MODE>PT 0= IF
        DROP RTAPT-S-INVALID EXIT
    THEN _RTAPT-CS-MODE !
    ...
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.SCALE @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.UNIT-U @ IF
        _RTAPT-CS-COPY @ _RTAPT-IDC.UNIT
        _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.UNIT-U @
    ELSE 0 0 THEN
    _RTAPT-CS-E @ _RTAPT-E.SESSION @
    _RTAPT-CS-REPLACE @ IF
        PT-READOUT-REPLACE
...
: _RTAPT-SEND-METER  ( -- status )
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.MODE @
        _RTAPT-METER-MODE>PT 0= IF
        DROP RTAPT-S-INVALID EXIT
    THEN _RTAPT-CS-MODE !
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.OPTIONS @
        _RTAPT-METER-OPTIONS>PT 0= IF
        DROP 0 _RTAPT-CS-MODE ! RTAPT-S-INVALID EXIT
    THEN _RTAPT-CS-OPTIONS !
    _RTAPT-PUSH-INSTRUMENT-COMMON
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.COLOR-A @ _RTAPT-PUSH-RGBA
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.COLOR-B @ _RTAPT-PUSH-RGBA
    _RTAPT-CS-MODE @ _RTAPT-CS-OPTIONS @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.MINIMUM @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.MAXIMUM @
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.VALUE @
    _RTAPT-CS-E @ _RTAPT-E.SESSION @
    _RTAPT-CS-REPLACE @ IF PT-METER-REPLACE ELSE PT-METER-DEFINE THEN
        _RTAPT-PT>STATUS
    0 _RTAPT-CS-MODE ! 0 _RTAPT-CS-OPTIONS ! ;

: _RTAPT-SEND-STATUS  ( -- status )
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.MODE @
        _RTAPT-STATUS-MODE>PT 0= IF
        DROP RTAPT-S-INVALID EXIT
    THEN _RTAPT-CS-MODE !
    _RTAPT-PUSH-INSTRUMENT-COMMON
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.COLOR-A @ _RTAPT-PUSH-RGBA
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.COLOR-B @ _RTAPT-PUSH-RGBA
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.VALUE @ _RTAPT-CS-MODE @
    _RTAPT-CS-E @ _RTAPT-E.SESSION @
    _RTAPT-CS-REPLACE @ IF PT-STATUS-REPLACE ELSE PT-STATUS-DEFINE THEN
        _RTAPT-PT>STATUS
    0 _RTAPT-CS-MODE ! ;
...
: _RTAPT-SEND-INSTRUMENT  ( replace? -- status )
    ...
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.KIND @
        RTAPT-INSTRUMENT-METER = IF
        _RTAPT-SEND-METER _RTAPT-SEND-INSTRUMENT-FINISH EXIT
    THEN
    _RTAPT-CS-COPY @ _RTAPT-INSTRUMENT.KIND @
        RTAPT-INSTRUMENT-STATUS = IF
        _RTAPT-SEND-STATUS _RTAPT-SEND-INSTRUMENT-FINISH EXIT
    THEN
...
: _RTAPT-CONTROL-KIND>PT  ( provider-kind -- pt-kind flag )
    ...
    DUP RTAPT-CONTROL-SEPARATOR = IF
        DROP PT-CONTROL-MENU-SEPARATOR -1 EXIT
    THEN
    DUP RTAPT-CONTROL-TEXT-AREA = IF
        DROP PT-CONTROL-TEXT-AREA -1 EXIT
    THEN
    DUP RTAPT-CONTROL-TEXT-GRID = IF
        DROP PT-CONTROL-TEXT-GRID -1 EXIT
    THEN
    DUP RTAPT-CONTROL-TABSET = IF
        DROP PT-CONTROL-TABSET -1 EXIT
    THEN
    RTAPT-CONTROL-TAB = IF
        PT-CONTROL-TAB -1 EXIT
    THEN
    0 0 ;
...
: _RTAPT-SEND-CONTROL  ( replace? -- status )
    ...
    _RTAPT-CS-COPY @ _RTAPT-CD.X @
    _RTAPT-CS-COPY @ _RTAPT-CD.Y @
    _RTAPT-CS-COPY @ _RTAPT-CD.COLS @
    _RTAPT-CS-COPY @ _RTAPT-CD.ROWS @
    ...
    ELSE 0 0 THEN
    _RTAPT-CS-COPY @ _RTAPT-CD.CONTENT-U @ IF
        _RTAPT-CS-COPY @ _RTAPT-CD.TEXT
        _RTAPT-CS-COPY @ _RTAPT-CD.LABEL-U @ +
        _RTAPT-CS-COPY @ _RTAPT-CD.SHORTCUT-U @ +
        _RTAPT-CS-COPY @ _RTAPT-CD.CONTENT-U @
    ELSE 0 0 THEN
    _RTAPT-CS-E @ _RTAPT-E.SESSION @
...
: _RTAPT-SEND-CAPTURED  ( op-record engine -- status )
    ...
    THEN
    _RTAPT-CS-P @ _RTAPT-P.KIND @ _RTAPT-OP-INSTRUMENT-REPLACE = IF
        -1 _RTAPT-SEND-INSTRUMENT EXIT
    THEN
    RTAPT-S-INVALID ;
...
: RTAPT-CELL-COMMIT  ( engine -- status )
    ...
    _RTAPT-CM-E @ _RTAPT-E.UPDATE-STATE @ RTAPT-UPDATE-CELL-OPEN <>
        IF RTAPT-S-BUSY EXIT THEN
    _RTPROF-PH-COMMIT-PRECHECK _RTPROF-MARK
    _RTAPT-CM-E @ _RTAPT-COMMIT-READY?
    _RTPROF-PH-OTHER _RTPROF-MARK
    0= IF
        RTAPT-S-INVALID _RTAPT-CM-E @ _RTAPT-COMMIT-FAILED EXIT
    THEN
    _RTPROF-PH-RTAPT-AUDIT _RTPROF-MARK
    ...
    0= IF
        RTAPT-S-INVALID _RTAPT-CM-E @ _RTAPT-COMMIT-FAILED EXIT
    THEN
    _RTAPT-CM-E @ _RTAPT-E.RET-MODE @ PT-RET-NONE <> IF
        _RTPROF-PH-WIRE-ENCODE _RTPROF-MARK
    THEN
    BEGIN
...
VARIABLE _RTAPT-CLA-E
VARIABLE _RTAPT-CLA-ENTRY
VARIABLE _RTAPT-CLA-META
VARIABLE _RTAPT-CLA-OLD-USED
VARIABLE _RTAPT-CLA-WRITE

: _RTAPT-CONTROL-LEDGER-CLEAR-HIDDEN  ( engine -- )
    DUP _RTAPT-CLA-E ! _RTAPT-E.CONTROL-LEDGER-USED @
        DUP _RTAPT-CLA-OLD-USED !
    0 _RTAPT-CLA-WRITE !
    0 ?DO
        I _RTAPT-CLA-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY !
        DUP _RTAPT-CL.META @ _RTAPT-CL-HIDDEN INVERT AND
            DUP _RTAPT-CLA-META ! SWAP _RTAPT-CL.META !
        0 _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS !
        0 _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 !
        _RTAPT-CLA-META @ _RTAPT-CL-ACTIVE AND IF
            _RTAPT-CLA-WRITE @ _RTAPT-CLA-E @
                _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY @ <> IF
                _RTAPT-CLA-ENTRY @ SWAP
                    RTAPT-CONTROL-LEDGER-SIZE MOVE
            ELSE DROP THEN
            1 _RTAPT-CLA-WRITE +!
        THEN
    LOOP
    _RTAPT-CLA-WRITE @ _RTAPT-CLA-OLD-USED @ U< IF
        _RTAPT-CLA-WRITE @ _RTAPT-CLA-E @
            _RTAPT-CONTROL-LEDGER-NTH
        _RTAPT-CLA-OLD-USED @ _RTAPT-CLA-WRITE @ -
            RTAPT-CONTROL-LEDGER-SIZE * 0 FILL
    THEN
    _RTAPT-CLA-WRITE @ _RTAPT-CLA-E @
        _RTAPT-E.CONTROL-LEDGER-USED ! ;

: _RTAPT-CONTROL-LEDGER-CLONE-ACTIVE  ( engine -- )
    DUP _RTAPT-CONTROL-LEDGER-CLEAR-HIDDEN
    DUP _RTAPT-CLA-E ! _RTAPT-E.CONTROL-LEDGER-USED @ 0 ?DO
        I _RTAPT-CLA-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY !
        DUP _RTAPT-CL.ACTIVE-ITEMS @
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS !
        DUP _RTAPT-CL.ACTIVE-UTF8 @
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 !
        _RTAPT-CL.META DUP @ _RTAPT-CL-HIDDEN OR SWAP !
    LOOP ;

: _RTAPT-CONTROL-LEDGER-PROMOTE-HIDDEN  ( engine -- )
    DUP _RTAPT-CLA-E ! _RTAPT-E.CONTROL-LEDGER-USED @
        DUP _RTAPT-CLA-OLD-USED !
    0 _RTAPT-CLA-WRITE !
    0 ?DO
        I _RTAPT-CLA-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY !
        DUP _RTAPT-CL.META @ _RTAPT-CL-HIDDEN AND IF
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS @
                _RTAPT-CLA-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS !
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 @
                _RTAPT-CLA-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 !
            0 _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS !
            0 _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 !
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.META @
                _RTAPT-CL-KIND-MASK AND _RTAPT-CL-ACTIVE OR
                _RTAPT-CLA-ENTRY @ _RTAPT-CL.META !
            _RTAPT-CLA-WRITE @ _RTAPT-CLA-E @
                _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY @ <> IF
...
VARIABLE _RTAPT-CLI-E
VARIABLE _RTAPT-CLI-P
VARIABLE _RTAPT-CLI-COPY
VARIABLE _RTAPT-CLI-O
VARIABLE _RTAPT-CLI-CONTROL
VARIABLE _RTAPT-CLI-KIND
VARIABLE _RTAPT-CLI-UTF8
VARIABLE _RTAPT-CLI-POS
VARIABLE _RTAPT-CLI-USED
VARIABLE _RTAPT-CLI-ENTRY
VARIABLE _RTAPT-CLI-ACTIVE

: _RTAPT-CONTROL-LEDGER-INSERT?  ( op copy active? engine -- flag )
    _RTAPT-CLI-E ! _RTAPT-CLI-ACTIVE !
    _RTAPT-CLI-COPY ! _RTAPT-CLI-P !
    _RTAPT-CLI-P @ _RTAPT-P.OWNER-SLOT @
        _RTAPT-CLI-E @ _RTAPT-OWNER-NTH _RTAPT-CLI-O !
    _RTAPT-CLI-COPY @ _RTAPT-CD.CONTROL @ DUP 0= IF DROP 0 EXIT THEN
        _RTAPT-CLI-CONTROL !
    _RTAPT-CLI-COPY @ _RTAPT-CD.KIND @ DUP
        _RTAPT-CONTROL-KIND-SCALAR? 0= IF DROP 0 EXIT THEN
        _RTAPT-CLI-KIND !
    _RTAPT-CLI-COPY @ _RTAPT-CD.LABEL-U @
    _RTAPT-CLI-COPY @ _RTAPT-CD.SHORTCUT-U @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CLI-COPY @ _RTAPT-CD.CONTENT-UTF8 @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN DUP _RTAPT-U32? 0= IF DROP 0 EXIT THEN
        _RTAPT-CLI-UTF8 !
    _RTAPT-CLI-E @ _RTAPT-E.CONTROL-LEDGER-USED @
        DUP _RTAPT-CLI-USED !
    _RTAPT-CLI-E @ _RTAPT-E.CONTROL-LEDGER-CAP @ U< 0= IF 0 EXIT THEN
    _RTAPT-CLI-USED @ _RTAPT-CLI-POS !
    _RTAPT-CLI-USED @ 0 ?DO
        I _RTAPT-CLI-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLI-ENTRY ! _RTAPT-CL.OWNER-SLOT @
        DUP _RTAPT-CLI-O @ U> IF DROP I _RTAPT-CLI-POS ! LEAVE THEN
        _RTAPT-CLI-O @ = IF
            _RTAPT-CLI-ENTRY @ _RTAPT-CL.CONTROL @
            DUP _RTAPT-CLI-CONTROL @ = IF DROP 0 UNLOOP EXIT THEN
            _RTAPT-CLI-CONTROL @ U> IF I _RTAPT-CLI-POS ! LEAVE THEN
        THEN
    LOOP
    _RTAPT-CLI-POS @ _RTAPT-CLI-E @ _RTAPT-CONTROL-LEDGER-NTH
        _RTAPT-CLI-ENTRY !
    _RTAPT-CLI-POS @ _RTAPT-CLI-USED @ U< IF
        _RTAPT-CLI-ENTRY @ DUP RTAPT-CONTROL-LEDGER-SIZE +
        _RTAPT-CLI-USED @ _RTAPT-CLI-POS @ -
            RTAPT-CONTROL-LEDGER-SIZE * MOVE
    THEN
    _RTAPT-CLI-ENTRY @ RTAPT-CONTROL-LEDGER-SIZE 0 FILL
    _RTAPT-CLI-O @ _RTAPT-CLI-ENTRY @ _RTAPT-CL.OWNER-SLOT !
    _RTAPT-CLI-COPY @ _RTAPT-CD.GENERATION @
        _RTAPT-CLI-ENTRY @ _RTAPT-CL.GENERATION !
    _RTAPT-CLI-CONTROL @ _RTAPT-CLI-ENTRY @ _RTAPT-CL.CONTROL !
    _RTAPT-CLI-ACTIVE @ IF
        _RTAPT-CLI-KIND @ _RTAPT-CL-ACTIVE OR
            _RTAPT-CLI-ENTRY @ _RTAPT-CL.META !
        _RTAPT-CLI-COPY @ _RTAPT-CD.CONTENT-ITEMS @
            _RTAPT-CLI-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS !
        _RTAPT-CLI-UTF8 @ _RTAPT-CLI-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 !
    ELSE
        _RTAPT-CLI-KIND @ _RTAPT-CL-HIDDEN OR
            _RTAPT-CLI-ENTRY @ _RTAPT-CL.META !
        _RTAPT-CLI-COPY @ _RTAPT-CD.CONTENT-ITEMS @
            _RTAPT-CLI-ENTRY @ _RTAPT-CL.HIDDEN-ITEMS !
        _RTAPT-CLI-UTF8 @ _RTAPT-CLI-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 !
    THEN
    _RTAPT-CLI-USED @ 1+ _RTAPT-CLI-E @
        _RTAPT-E.CONTROL-LEDGER-USED ! -1 ;

: _RTAPT-CONTROL-LEDGER-INSERT-HIDDEN?  ( op copy engine -- flag )
    0 SWAP _RTAPT-CONTROL-LEDGER-INSERT? ;

: _RTAPT-CONTROL-LEDGER-INSERT-ACTIVE?  ( op copy engine -- flag )
    -1 SWAP _RTAPT-CONTROL-LEDGER-INSERT? ;

: _RTAPT-CONTROL-LEDGER-REPLACE-ACTIVE?  ( op copy engine -- flag )
    ...
    _RTAPT-CLI-COPY @ _RTAPT-CD.CONTROL @ _RTAPT-CLI-E @
        _RTAPT-CONTROL-LEDGER-FIND DUP 0= IF DROP 0 EXIT THEN
        DUP _RTAPT-CLI-ENTRY ! _RTAPT-CL.META @
        DUP _RTAPT-CL-ACTIVE AND 0= IF DROP 0 EXIT THEN
        _RTAPT-CL-KIND-MASK AND
        _RTAPT-CLI-COPY @ _RTAPT-CD.KIND @ <> IF 0 EXIT THEN
    _RTAPT-CLI-COPY @ _RTAPT-CD.LABEL-U @
    _RTAPT-CLI-COPY @ _RTAPT-CD.SHORTCUT-U @ _RTAPT-UADD?
        0= IF DROP 0 EXIT THEN
    _RTAPT-CLI-COPY @ _RTAPT-CD.CONTENT-UTF8 @ _RTAPT-UADD?
    ...
    _RTAPT-CLI-COPY @ _RTAPT-CD.CONTENT-ITEMS @
        _RTAPT-CLI-ENTRY @ _RTAPT-CL.ACTIVE-ITEMS !
    _RTAPT-CLI-UTF8 @ _RTAPT-CLI-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 ! -1 ;

: _RTAPT-CONTROL-LEDGER-REFRESH-UTF8?  ( engine -- flag )
    _RTAPT-CLA-E !
    _RTAPT-CLA-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        I _RTAPT-CLA-E @ _RTAPT-OWNER-NTH
        DUP _RTAPT-O.ACTIVE-CONTROL-UTF8 OFF
        _RTAPT-O.HIDDEN-CONTROL-UTF8 OFF
    LOOP
    _RTAPT-CLA-E @ _RTAPT-E.CONTROL-LEDGER-USED @ 0 ?DO
        I _RTAPT-CLA-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY ! _RTAPT-CL.OWNER-SLOT @
        _RTAPT-CLA-ENTRY @ _RTAPT-CL.META @ _RTAPT-CL-ACTIVE AND IF
            DUP _RTAPT-O.ACTIVE-CONTROL-UTF8 @
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.ACTIVE-UTF8 @ _RTAPT-UADD?
                0= IF 2DROP 0 UNLOOP EXIT THEN
            OVER _RTAPT-O.ACTIVE-CONTROL-UTF8 !
        THEN
        _RTAPT-CLA-ENTRY @ _RTAPT-CL.META @ _RTAPT-CL-HIDDEN AND IF
            DUP _RTAPT-O.HIDDEN-CONTROL-UTF8 @
            _RTAPT-CLA-ENTRY @ _RTAPT-CL.HIDDEN-UTF8 @ _RTAPT-UADD?
                0= IF 2DROP 0 UNLOOP EXIT THEN
            OVER _RTAPT-O.HIDDEN-CONTROL-UTF8 !
        THEN DROP
    LOOP -1 ;

VARIABLE _RTAPT-CLAP-E
VARIABLE _RTAPT-CLAP-MODE
VARIABLE _RTAPT-CLAP-P
VARIABLE _RTAPT-CLAP-COPY

: _RTAPT-CONTROL-LEDGER-APPLY?  ( engine -- flag )
    DUP _RTAPT-CLAP-E ! _RTAPT-E.RET-MODE @ _RTAPT-CLAP-MODE !
    _RTAPT-CLAP-MODE @ PT-RET-REPLACE-START = IF
        _RTAPT-CLAP-E @ _RTAPT-CONTROL-LEDGER-CLEAR-HIDDEN
    THEN
    _RTAPT-CLAP-MODE @ PT-RET-LAYOUT-START = IF
        _RTAPT-CLAP-E @ _RTAPT-CONTROL-LEDGER-CLONE-ACTIVE
    THEN
    _RTAPT-CLAP-E @ _RTAPT-E.OP-COUNT @ 0 ?DO
        I _RTAPT-CLAP-E @ _RTAPT-OP-NTH DUP _RTAPT-CLAP-P !
        _RTAPT-P.COPY-OFF @ _RTAPT-CLAP-E @ _RTAPT-E.COPY-A @ +
            _RTAPT-CLAP-COPY !
        _RTAPT-CLAP-MODE @ PT-RET-REPLACE-START =
        _RTAPT-CLAP-P @ _RTAPT-P.KIND @
            _RTAPT-OP-CONTROL-DEFINE = AND IF
            _RTAPT-CLAP-P @ _RTAPT-CLAP-COPY @ _RTAPT-CLAP-E @
                _RTAPT-CONTROL-LEDGER-INSERT-HIDDEN? 0= IF
                0 UNLOOP EXIT
            THEN
        THEN
        _RTAPT-CLAP-MODE @ PT-RET-DELTA =
        _RTAPT-CLAP-P @ _RTAPT-P.KIND @
            _RTAPT-OP-CONTROL-DEFINE = AND IF
            _RTAPT-CLAP-P @ _RTAPT-CLAP-COPY @ _RTAPT-CLAP-E @
                _RTAPT-CONTROL-LEDGER-INSERT-ACTIVE? 0= IF
                0 UNLOOP EXIT
            THEN
        THEN
        _RTAPT-CLAP-MODE @ PT-RET-DELTA =
        _RTAPT-CLAP-P @ _RTAPT-P.KIND @
            _RTAPT-OP-CONTROL-REPLACE = AND IF
            _RTAPT-CLAP-P @ _RTAPT-CLAP-COPY @ _RTAPT-CLAP-E @
                _RTAPT-CONTROL-LEDGER-REPLACE-ACTIVE? 0= IF
                0 UNLOOP EXIT
            THEN
        THEN
    LOOP
    _RTAPT-CLAP-E @ _RTAPT-E.DISPOSITION @ PT-COMMIT-AND-REVEAL = IF
        _RTAPT-CLAP-E @ _RTAPT-CONTROL-LEDGER-PROMOTE-HIDDEN
    THEN
    _RTAPT-CLAP-E @ _RTAPT-CONTROL-LEDGER-REFRESH-UTF8? ;

VARIABLE _RTAPT-CLR-E
VARIABLE _RTAPT-CLR-O

: _RTAPT-CONTROL-LEDGER-REMOVE-OWNER  ( owner-record engine -- )
    _RTAPT-CLR-E ! _RTAPT-CLR-O !
    _RTAPT-CLR-E @ _RTAPT-E.CONTROL-LEDGER-USED @
        DUP _RTAPT-CLA-OLD-USED ! 0 _RTAPT-CLA-WRITE !
    0 ?DO
        I _RTAPT-CLR-E @ _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY ! _RTAPT-CL.OWNER-SLOT @
            _RTAPT-CLR-O @ <> IF
            _RTAPT-CLA-WRITE @ _RTAPT-CLR-E @
                _RTAPT-CONTROL-LEDGER-NTH
            DUP _RTAPT-CLA-ENTRY @ <> IF
                _RTAPT-CLA-ENTRY @ SWAP
                    RTAPT-CONTROL-LEDGER-SIZE MOVE
...
: _RTAPT-OWNER-CLEAR  ( owner-record engine -- )
    2DUP _RTAPT-CONTROL-LEDGER-REMOVE-OWNER
...
: _RTAPT-RECONCILE-DROP  ( engine -- status )
    ...
    _RTAPT-ST-PT @ PT-TX-RESULT-OK = IF
        _RTAPT-ST-O @ _RTAPT-ST-E @ _RTAPT-CONTROL-LEDGER-REMOVE-OWNER
...
: _RTAPT-APPLY-OUTPUT  ( engine -- )
    ...
    _RTAPT-PR-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        ...
        DUP _RTAPT-PR-O ! _RTAPT-LIVE-OWNER? IF
            ...
            0 _RTAPT-PR-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS !
            ...
            _RTAPT-PR-MODE @ PT-RET-LAYOUT-START = IF
                ...
                _RTAPT-PR-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS @
                    _RTAPT-PR-O @ _RTAPT-O.HIDDEN-CONTENT-ITEMS !
    ...
    _RTAPT-PR-E @ _RTAPT-E.OWNER-CAP @ 0 ?DO
        ...
        DUP _RTAPT-PR-O ! _RTAPT-LIVE-OWNER? IF
            ...
            THEN
            _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ IF
                _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTENT-TARGET @
                _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @ +
                    _RTAPT-PR-O @ _RTAPT-O.ACTIVE-CONTENT-ITEMS !
            ELSE
                _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTENT-ITEMS @
                    DUP _RTAPT-PR-PENDING ! IF
            ...
            _RTAPT-PR-MODE @ PT-RET-DELTA = IF
                _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS @ IF
                    _RTAPT-PR-O @ _RTAPT-O.PENDING-UTF8-TARGET @
            ...
            0 _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTENT-ITEMS !
            0 _RTAPT-PR-O @ _RTAPT-O.PENDING-UTF8 !
            0 _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTROL-REPLACEMENTS !
            0 _RTAPT-PR-O @ _RTAPT-O.PENDING-CONTENT-TARGET !
            0 _RTAPT-PR-O @ _RTAPT-O.PENDING-UTF8-TARGET !
        THEN
    LOOP
...
: _RTAPT-RECONCILE-OUTPUT  ( engine -- status )
    ...
    _RTAPT-ST-PT @ PT-TX-RESULT-OK = IF
        _RTAPT-ST-E @ _RTAPT-ACTIVE-CLEAR
        _RTAPT-ST-E @ _RTAPT-CONTROL-LEDGER-APPLY? 0= IF
            RTAPT-S-INVALID _RTAPT-ST-E @ _RTAPT-QUARANTINE-ALL EXIT
        THEN
