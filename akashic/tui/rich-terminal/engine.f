...
: _RTE-CPV-HEADER?  ( -- flag )
    _RTE-CPV-PLAN @ RTE-CONTROL-PLAN-SIZE _RTE-SPAN? 0= IF 0 EXIT THEN
    _RTE-CPV-FACADE @ IF
    ...
    _RTE-CPV-ITEMS-A @ _RTE-CPV-ITEMS-U @ _RTE-SPAN? 0= IF 0 EXIT THEN
