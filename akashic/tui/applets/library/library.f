...
: LIBRARY-APPLET-INIT-CB  ( instance -- )
    ...
    ELSE
        ...
        _LAPP-CAPABILITY-WORK LIBRARY-CAPABILITY-WORK-INIT IF
            LIBRARY-SERVICE-S-CAPACITY _LAPP-LAST-STATUS !
            _LAPP-RUNTIME@ DUP _LAPP-RUNTIME-SIZE 0 FILL
...
: LIBRARY-APPLET-SHUTDOWN-CB  ( instance -- )
    ...
    _LAPP-RUNTIME@ ?DUP IF
        _LAPP-CAPABILITY-WORK LIBRARY-CAPABILITY-WORK-VALID? IF
            _LAPP-CAPABILITY-WORK LIBRARY-CAPABILITY-WORK-FINI DROP
        THEN
...
: LIBRARY-APPLET-COMP-DESC  ( -- desc )
    _LIBRARY-APPLET-COMP-DESC-RAW 7 + -8 AND ;
...
: _LIBRARY-APPLET-COMP-SETUP  ( -- )
    ...
    LIBRARY-APPLET-CAPABILITIES
        LIBRARY-APPLET-COMP-DESC COMP.CAPS-A !
    LIBRARY-APPLET-CAPABILITY-COUNT
        LIBRARY-APPLET-COMP-DESC COMP.CAPS-N ! ;
