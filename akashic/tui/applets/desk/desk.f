...
\    DESK-SANDBOX-OWNER! ( owner|0 -- status ) Borrow sealed modules before run
...
_DESK-CURRENT-STATE DESK-SBOX-JOB-SERVICE-SIZE
    CMP-FIELD: _DESK-SANDBOX
...
: _DESK-SBOX-READY?  ( -- flag )
    _DESK-SANDBOX DESK-SBOX-JOB-SERVICE-STATE@
...
: _DESK-SBOX-FINI  ( -- status )
    _DESK-SANDBOX DESK-SBOX-JOB-SERVICE-RELEASE
    DUP IF
        DROP
        _DESK-SANDBOX DESK-SBOX-JOB-SERVICE-RELEASE
    THEN ;
...
: DESK-SANDBOX-OWNER!  ( owner|0 -- status )
    _DESK-CURRENT-STATE @ IF
        DROP DESK-SBOX-S-STATE EXIT
    THEN
    DUP IF
        DUP SBOX-MODULE-OWNER-SEALED? 0= IF
            DROP DESK-SBOX-S-OWNER EXIT
        THEN
    THEN
    _DESK-PENDING-SBOX-OWNER !
    DESK-SBOX-S-OK ;
...
' DESK-SANDBOX-OWNER! CONSTANT _desk-sandbox-owner-xt
...
: DESK-SANDBOX-OWNER!
    _desk-sandbox-owner-xt _desk-guard WITH-GUARD ;
