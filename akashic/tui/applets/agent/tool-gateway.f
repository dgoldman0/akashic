...
CBR-ARGS-CANONICAL-MAX CONSTANT ATOOLG-ARGS-CANONICAL-MAX
ATOOLG-ARGS-CANONICAL-MAX CONSTANT ATOOLG-ARGS-REVIEW-MAX
...
: _ATOOLG-DISCLOSURE-GATE  ( request gateway -- status )
    _ATGD-G ! _ATGD-REQ !
    _ATGD-REQ @ CBR.STATUS @ CBUS-RESULT-BEARING? 0= IF
        \ Approval is an intermediate dispatch result; keep its reservation
        \ across review and requeue.  Every terminal non-result refunds it.
