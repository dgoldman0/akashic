...
: _C4-STREAMS-INIT  ( instance -- )
    ...
    _C4-BURROW-ROWS _C4-ROW-CAPACITY
    _C4-BURROW-REPLAYS _C4-REPLAY-CAPACITY
    _C4-BURROW-PROVIDER SBSP-PROVIDER _C4-STREAMS-STATE @
...
: _C4-FINISH-OPERATOR  ( -- ior )
    _C4-MANDATE-RUN @ AMRUN.TOOLS-USED @ 8 = _C4-ASSERT
    _C4-FACET-BITS @ 15 = _C4-ASSERT
    AEV-TEXT-DELTA 0 0
