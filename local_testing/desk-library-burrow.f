...
\ IS parses its deferred-word name from the current input stream and is
\ therefore only safe at interpretation time.  Installers execute later,
\ after their defining input line is gone, so capture both XTs while compiling
\ and update the deferred word's body explicitly at runtime.
: _C4-DEFER!  ( action-xt defer-xt -- )  >BODY ! ;

: _C4-INSTALL-DEFAULT-COMPOSITION  ( -- )
    ['] _C4-DEFAULT-GRAPH-CONFIGURE
        ['] _C4-GRAPH-CONFIGURE _C4-DEFER!
    ['] _C4-DEFAULT-GRAPH-COMPOSE
        ['] _C4-GRAPH-COMPOSE _C4-DEFER!
    ['] _C4-DEFAULT-GRAPH-STATE@
        ['] _C4-GRAPH-STATE@ _C4-DEFER!
    ['] _C4-DEFAULT-GRAPH-ZERO-CHECK
        ['] _C4-GRAPH-SHUTDOWN-CHECK _C4-DEFER!
    ['] _C4-DEFAULT-GRAPH-ZERO-CHECK
        ['] _C4-GRAPH-POST-CHECK _C4-DEFER!
    ['] _C4-DEFAULT-GRAPH-LEASE?
        ['] _C4-GRAPH-LEASE? _C4-DEFER!
    ['] _C4-DEFAULT-PROGRESS-READY?
        ['] _C4-PROGRESS-READY? _C4-DEFER!
    ['] _C4-DEFAULT-RESULT-OBSERVE
        ['] _C4-RESULT-OBSERVE _C4-DEFER!
    ['] _C4-DEFAULT-RESULT-OVERRIDE
        ['] _C4-RESULT-OVERRIDE _C4-DEFER!
    ['] _C4-DEFAULT-EXPECTED-TOOLS
