...
VARIABLE _otst-lease
VARIABLE _otst-old-lease
...
: _otst-test-set-stage-and-alias  ( -- )
    ...
    _otst-tokens O2TOK-PRESENT? _otst-assert
    ...
    _otst-tokens O2TOK.REFRESH-U @ 11 = _otst-assert
    ...
    _otst-tokens O2TOK.REFRESH _otst-refresh 11
        _otst-bytes= _otst-assert
    _otst-tokens _O2TOK.STAGE-ACCESS
        O2TOK-ACCESS-CAPACITY _otst-zero? _otst-assert
...
: _otst-test-optional-refresh-and-id  ( -- )
    ...
    _otst-tokens O2TOK.REFRESH-U @ 0= _otst-assert
    _otst-tokens O2TOK-REFRESH-BEGIN
...
: _otst-test-update-and-borrow  ( -- )
    0 0 _otst-new-access 3 0 0
    0 _otst-tokens O2TOK-UPDATE
        O2TOK-S-OK = _otst-assert
    _otst-tokens O2TOK.ACCESS-U @ 3 = _otst-assert
    _otst-tokens O2TOK.ACCESS _otst-new-access 3
        _otst-bytes= _otst-assert
    _otst-tokens O2TOK.ACCESS 3 +
        O2TOK-ACCESS-CAPACITY 3 - _otst-zero? _otst-assert
    _otst-tokens O2TOK.REFRESH-U @ 11 = _otst-assert
    _otst-tokens O2TOK.EXPIRES-MS @ 111 = _otst-assert

    ['] _otst-capture _otst-observed _otst-tokens
        O2TOK-WITH-ACCESS O2TOK-S-OK = _otst-assert
    _otst-observed-u @ 3 = _otst-assert
    _otst-observed _otst-new-access 3
        _otst-bytes= _otst-assert
...
: _otst-test-clear-invalidates-lease  ( -- )
    ...
    _otst-lease @ _otst-old-lease !
    _otst-tokens O2TOK-CLEAR? O2TOK-S-OK = _otst-assert
    _otst-tokens O2TOK-PRESENT? 0= _otst-assert
    _otst-tokens O2TOK.ACCESS O2TOK-ACCESS-CAPACITY
        _otst-zero? _otst-assert
    _otst-tokens O2TOK.REFRESH O2TOK-REFRESH-CAPACITY
        _otst-zero? _otst-assert
