...
HELPERS = [
    ...
    "_TF-WRITES @ 2 = IF 0 0 EXIT THEN _TFW-L @ 2 MIN _TFW-L ! THEN",
    ...
    "_TF-DELETE-FAIL @ 2 = IF _VFS-RAM-UNLINK DUP IF EXIT THEN "
    "DROP -224 THROW THEN _TF-DELETE-FAIL @ IF 2DROP -1 "
    "ELSE _VFS-RAM-UNLINK THEN ;",
    ": T-SYNC _vfs-guard GUARD-MINE? IF TRUE _TF-GUARDED ! THEN",
    "_TF-SYNC-FAIL-ONCE @ IF 0 _TF-SYNC-FAIL-ONCE ! DROP -1",
    "ELSE _TF-SYNC-AFTER @ IF _VFS-RAM-SYNCFS DUP IF EXIT THEN "
    "DROP -225 THROW ELSE _VFS-RAM-SYNCFS THEN THEN ;",
    ...
    "CREATE T-OPS VFS-OPS-SIZE ALLOT",
    "CREATE T-BINDING VFS-BINDING-DESC-SIZE ALLOT",
    "VFS-RAM-OPS T-OPS VFS-OPS-SIZE CMOVE",
    "VFS-RAM-BINDING T-BINDING VFS-BINDING-DESC-SIZE CMOVE",
    "T-OPS T-BINDING VB.OPS !",
    "' T-WRITE T-OPS VFS-OP-WRITE CELLS + !",
    "' T-DELETE T-OPS VFS-OP-UNLINK CELLS + !",
    "' T-SYNC T-OPS VFS-OP-SYNCFS CELLS + !",
    ": T-VFS-NEW 524288 A-XMEM ARENA-NEW IF -1 THROW THEN "
    "T-BINDING 0 VFS-NEW ?DUP IF THROW THEN ;",
