...
def _mounted_relation_program() -> list[str]:
    ...
    return [
        ...
        "VARIABLE _UM-SOURCE", "VARIABLE _UM-PANEL-RGN",
        ...
        'S" <uidl arrange=stack><region id=mount/></uidl>" _UM-DOC-RGN @ UTUI-LOAD _UM-ASSERT',
        ...
        "_UM-SOURCE @ _UTUI-MC-SOURCE _UTUI-MCS-GENERATION@ 0<> _UM-ASSERT",
        ...
        "_UTUI-MCR-GENERATION@ DUP _UM-G0 ! 0<> _UM-ASSERT",
        ...
        "_UTUI-MC-COUNT @ 2 = _UM-ASSERT",
        "_UM-A @ _UM-RELATION _UTUI-MCR-ROOT-KEY@ _UM-KA @ = _UM-ASSERT",
        "_UM-B @ _UM-RELATION _UTUI-MCR-ROOT-KEY@ _UM-KB @ = _UM-ASSERT _UM-STACK",
        ...
        "_UM-A-RGN @ RGN-FREE _UM-B-RGN @ RGN-FREE _UM-PANEL-RGN @ RGN-FREE",
